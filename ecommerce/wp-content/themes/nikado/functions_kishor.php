...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
   ...
   <?php
     ...
     /* function woocommerce_product_custom_fields()
      ...
      <?php $_SERVER['SERVER_NAME'] ="orendaventures.com" ?>
      ...
      <div class="container padd-0">
         <nav id="navigation" class="navbar navbar-default navbar-ex">
            ...
            <div class="navbar-header">
               ...
               <a class="navbar-brand" style="padding-left: 0;" href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/">
						...
						<ul class="nav navbar-nav navbar-nav-ex">
									...
									<div class="">
										<div class="col-sm-4 padd-0">
											<ul class="multi-column-dropdown">
												...
												<li class="divider"></li>
												<li><a href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/community/forum" target="_blank">User Communities</a></li>
												<li><a href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/groupbuying" target="_blank">Collective Buyers</a></li>
												<li><a href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/xpertconnect" target="_blank">Freelancer Groups</a></li>
												<li><a href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/events" target="_blank">Live Events</a></li>
											</ul>
										</div>
										<div class="col-sm-4 padd-0">
											<ul class="multi-column-dropdown">
												...
												<li class="divider"></li>
												<li><a href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/machine" target="_blank">Machines</a></li>
												<li><a href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/ecommerce/product-category/spare-parts" target="_blank">Spares</a></li>
												<li><a href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/ecommerce/product-category/toolings/" target="_blank">Toolings</a></li>
												<li><a href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/automation" target="_blank">Automation</a></li>
											</ul>
										</div>
										<div class="col-sm-4 padd-0">
											<ul class="multi-column-dropdown">
												...
												<li class="divider"></li>
												<li><a href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/consultant" target="_blank">Remote Service</a></li>
												<li><a target="_blank" href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/eacademy">Remote Training</a></li>
												<li><a href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/consultant/remoteapp_service" target="_blank">Remote Application</a></li>
												<li><a target="_blank" href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/remoteprogramming">Remote Programming</a></li>
											</ul>
										</div>
									</div>
								</ul>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li><a target="_blank" href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/research">Research</a></li>
									<li><a target="_blank" href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/analytics">Analytics</a></li>
									<li><a target="_blank" href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/consulting">Consulting</a></li>
									<li><a target="_blank" href="http://orendaventures.com/mediacenter/category/industry-news/">News</a></li>
	                                <li><a target="_blank" href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/mediacenter/category/customer-blog/">Blogs</a></li>
									<li><a target="_blank" href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/pages/commingsoon">Webinar</a></li>
								</ul>
							</li>	
							<li class="dropdown">
	                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">m-Academy </a>
	                        <!--<ul class="dropdown-menu">
	                           <li><a target="_blank" href="http://orendaventures.com/mediacenter/">In Focus</a></li>
	                           <li><a target="_blank" href="http://orendaventures.com/mediacenter/category/industry-news/">Industry News</a></li>
	                           <li><a target="_blank" href="http://orendaventures.com/mediacenter/category/experts/">Expert Blogs</a></li>
	                           <li><a target="_blank" href="http://orendaventures.com/mediacenter/category/customer-blog/">Customer Blogs</a></li>
	                           <li><a target="_blank" href="http://orendaventures.com/mediacenter/category/videos/">Videos</a></li>
	                           <li><a target="_blank" href="<?php echo site_url();?>pages/commingsoon">Passport</a></li>
	                        </ul>-->
	                    </li>
							</ul>
									...
									<div class="btn-group">
									  ...
									  <img src="<?php echo get_template_directory_uri(); ?>/images/user.png">
										...
										<ul class="dropdown-menu dropdown-menu-right ddl-user mob-ddl">
											<li><a href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/customer/profile">Dashboard</a></li>
											<li><a href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/pages/logout">Logout</a></li>
											<li><a href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/pages/signIn">Sign in</a></li>
											<li class="divider"></li>
											<li class="socialAcc">
												<div class="col-sm-12">
												<h5>Continue with:</h5>
									...
									<div class="btn-group">
										...
										<div class="btn-group">
											<span class="cart-quantity">
												<?php echo sprintf(_n('%d', '%d', $woocommerce->cart->cart_contents_count, 'nikado'), $woocommerce->cart->cart_contents_count);?>
											</span>
											<a href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/ecommerce/cart/" aria-haspopup="true" aria-expanded="false" title="My Cart">
											<img src="<?php echo get_template_directory_uri(); ?>/images/shoping.png"></a>
										</div>
									</div>
								</div>
