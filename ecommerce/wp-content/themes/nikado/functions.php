      ...
      <div class="container padd-0">
         <nav id="navigation" class="navbar navbar-default navbar-ex">
            ...
            <div class="navbar-header">
               ...
               <a class="navbar-brand" style="padding: 0;" href="<?php echo $_SERVER['SERVER_NAME'];?>/">
               <img src="<?php echo get_template_directory_uri(); ?>/images/logo-stelmac.jpg" class="img-responsive">
               </a>
            </div>
                              ...
                              <div class="">
                                 <div class="col-sm-3 padd-0">
                                    <ul class="multi-column-dropdown">
                                       ...
                                       <li><a href="<?php echo $_SERVER['SERVER_NAME'];?>" target="">Exchanges Groups</a></li>
                                    </ul>
                                 </div>
                                 <div class="col-sm-3 padd-0">
                                    <ul class="multi-column-dropdown">
                                       <h5>Source</h5>
                                       <li class="divider"></li>
                                       <li><a href="<?php echo $_SERVER['SERVER_NAME'];?>/machine" target="">Machines</a></li>
                                    ...
                                    <div class="">
                                       <li class="socialAcc">
                                          <div class="col-sm-12" style="">
                                             <div class="col-sm-3">
                                                <img src="<?php echo $_SERVER['SERVER_NAME'];?>/uploads/customer/<?php echo $current_user->u_avatar ?>" class="img-responsive" alt="user profile">
                                             </div>
                                             <div class="col-sm-9">
                                                <label><?php echo $current_user->display_name; ?></label>
                                                <p><?php echo $current_user->user_type; ?></p>
                                             </div>
                                             <div class="clearfix"></div><br/>
                                             <div class="col-sm-6 padd-8" style="padding-left: 0;">
                                                <a href="<?php echo $_SERVER['SERVER_NAME'];?>/customer/changePassword" class="full-width btn btn-sm btn-default" style="display: inline-block;padding: 5px;">Change Password</a>
                                             </div>
                                             <div class="col-sm-6 padd-8" style="padding-right: 0;">
                                                <a href="<?php echo $_SERVER['SERVER_NAME'];?>/pages/logout" class="full-width btn btn-sm btn-default" style="display: inline-block;padding: 5px; width: 100%;">Sign Out</a>
                                             </div>
                                          </div>
                                       </li>
                                    </div>
                                 ...
                                 ?> 
                                    ...
                                    <div style="display: none;">
                                       ...
                                       <li class="socialAcc">
                                          <div class="col-sm-12" style="">
                                             <div class="col-sm-3">
                                                <img src="" class="img-responsive" alt="user profile">
                                             </div>
                                             <div class="col-sm-9">
                                                <label></label>
                                                <p>Designation</p>
