...
<div class="main-container">
	...
	<?php if (is_product_category(array('spare-parts','used-spare-parts'))) { ?>
		<img src="<?php echo get_template_directory_uri(); ?>/images/spare-parts.jpg" class="img-responsive ecom-banner" />
	<?php } ?>
	<?php if (is_product_category(array('toolings','used-toolings'))) { ?>
	<img src="<?php echo get_template_directory_uri(); ?>/images/tooling.jpg" class="img-responsive ecom-banner" />
	<?php } ?>
	<?php if (is_product_category('raw-material')) { ?>
	<img src="<?php echo get_template_directory_uri(); ?>/images/software.jpg" class="img-responsive ecom-banner" />
	<?php } ?>
	</div>
								...
								<div class="category_header"> 
										<?php if ( apply_filters( 'woocommerce_show_page_title', true ) ) : ?>
											<header class="entry-header"> 
												...
												<?php /*if(is_product_category(array('spare-parts','used-spare-parts'))){?>
												<a href="https://gotteswork.com/ecommerce/product-category/spare-parts/"><h1 class="entry-title">Spare Parts </h1></a>
												<a href="https://gotteswork.com/ecommerce/product-category/used-spare-parts/"><h1 style="margin-left: 73px;" class="entry-title">Used Parts </h1></a>
												<?php } elseif(is_product_category(array('toolings','used-toolings')))  { ?>
												<a href="https://gotteswork.com/ecommerce/product-category/toolings"><h1 class="entry-title">Toolings</h1></a>
												<a href="https://gotteswork.com/ecommerce/product-category/used-toolings"><h1 style="margin-left: 73px;" class="entry-title">Used Toolings </h1></a><?php }*/ ?>
