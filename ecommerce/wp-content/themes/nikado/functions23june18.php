                     ...
                     <ul class="nav navbar-nav navbar-nav-ex">
                           ...
                           <ul class="dropdown-menu multi-column columns-3 dropdown-menu-right">
                              <div class="">
                                 ...
                                 <ul class="multi-column-dropdown">
                                    ...
                                    <li class="divider"></li>
                                    <li><a href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/community/forum" target="_blank">User Groups</a></li>
                                    <li><a href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/groupbuying" target="_blank">Buyer Groups</a></li>
                                    <li><a href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/xpertconnect" target="_blank">Freelancer Groups</a></li>
                                    <li><a href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/pages/commingsoon" target="_blank">Infobins</a></li>
                                 </ul>
                              </div>
                              <div class="col-sm-4 padd-0">
                                 <ul class="multi-column-dropdown">
                                    ...
                                    <li><a href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/pages/commingsoon" target="_blank">Software</a></li>
                                 </ul>
                              </div>
                              <div class="col-sm-4 padd-0">
                                 <ul class="multi-column-dropdown">
                                    ...
                                    <li><a target="_blank" href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/stelmac/contact_manufacturing">Remote Fabrications</a></li>
                                 </ul>
                              </div>
                        ...
                        <li class="dropdown">
                           ...
                           <ul class="dropdown-menu">
                              ...
                              <li><a target="_blank" href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/mediacenter/">Media</a></li>
                           <li><a target="_blank" href="<?php echo "https://" . $_SERVER['SERVER_NAME'];?>/events">Events</a></li>
                           </ul>
                        </li>
						<li>
                       ...
                       <li class="agreement"> 
                        <div class="form-group">
                           ...
                           <div class="btn-group">
                              ...
                              <ul class="dropdown-menu dropdown-menu-right ddl-user" style="margin-left:-130px; min-width:160px;">
