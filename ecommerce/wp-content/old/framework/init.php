...
//			$this->constant[ 'MM_WARE_IMG_URL' ] = $this->constant[ 'MM_WARE_SRC_URL' ] . '/img';
		...
		public function load_textdomain ( $args ) {
			$lang_dir = dirname( $this->mm_config[ 'MM_WARE_INIT_FILE' ] ) . DIRECTORY_SEPARATOR .  'locale' . DIRECTORY_SEPARATOR;
//			do_action( 'mm_plugins_loaded' );
			load_plugin_textdomain( 'mega_main_menu', false, $lang_dir );
//			echo 'vvvvvv' . $lang_dir;
		}
