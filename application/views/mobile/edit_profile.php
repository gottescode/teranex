                            ...
                            <div class="col-md-12 pad-1" id="basic-information">
                                ...
                                <div class="be-change-ava">
                                    <a class="be-ava-user style-2" href="javascript:void(0)">
                                        <img id="editProfileImage" src="<?php echo base_url('assets/img/download.png') ?>" alt="">
                                    </a>
                                ...
                                <form role="form" id="profileUpdate">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="userMobile">Last Name</label>
                                        <input id="lastName" type="text" name="lastName" class="form-control">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="userAddress">Email</label>
                            ...
                            <div class="col-md-12 pad-1" id="edit-password">
                                ...
                                <form role="form" id="passwordForm">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input id="userPassword" type="password" name="userPassword" class="form-control" disabled>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="newPassword">New Password</label>
                                        <input id="newPassword" type="password" name="newPassword" class="form-control" disabled>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="RePassword">Repeat Password</label>
                                        <input id="RePassword" type="password" name="RePassword" class="form-control" disabled>
                                    </div>
                                    <input type="submit" value="Save" class="btn btn-small btn-skin-blue btn-round btn-right" disabled>
                                </form>
                            </div>
                                ...
                                <ul class="ol-side-navigation skin-blue">
                                    <li class="menu-item-has-children current-menu-parent active"><a href="#">Options</a>
                                        ...
                                        <ul class="sub-menu" style="display: block;">
                                            ...
                                            <li><a class="" href="<?php echo base_url('userview/im')?>"> Back Home</a></li>
                                        </ul>
                                        <!-- #####End sub-menu-->
                                    </li>
                                </ul>
