...
<div class="row">
    ...
    <div class="col-md-5 col-sm-5">
        <div id="sample_1_filter" class="dataTables_filter">
            <label>
                Search: <input id="emailSearch" type="search" class="form-control input-sm input-medium input-inline" placeholder="Email or name" aria-controls="sample_1"> <button type="button" id="searchEmailBtn" class="btn btn-sm btn-info my-btn-color"> Search </button> <button id="clearBtn" type="button" class="btn btn-sm default"> All </button>
            </label>
        </div>
        ...
        <div class="portlet light portlet-fit bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark bold uppercase">Admin List</span>
                </div>
                <div class="actions">
                    <div class="btn-group">
                        <button id="newAdminModal" type="button" class="btn green mt-ladda-btn  ladda-button btn-outline">
                ...
                <div class="table-scrollable">
                    ...
                    <?php for ($i=0,$j=1;$i<count($userList); $i++,$j++){ ?>
                        <tr>
                            ...
                            <td>
                                <button type="button"  data-type="<?php echo (int)$userList[$i]["adminType"] ?>" data-user="<?php echo $userList[$i]["userId"]?>" class="btn btn-xs btn-info AdminInfo">Update info</button>
                                <?php if((int)$userList[$i]["adminType"]!=2){ ?>
                                <button type="button" data-name="<?php echo $userList[$i]["firstName"]?>" data-user="<?php echo $userList[$i]["userId"]?>" class="btn  btn-xs btn-danger deleteAdmin">Delete admin</button>
                                <?php } ?>
                            </td>
                        </tr>
                        <?php }?>
        ...
        <div class="modal-content">
                            ...
                            <div class="col-md-12">
                                <form id="newAdminForm" role="form" autocomplete="off">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <span class="help-block">Enter admin name.</span>
                                    </div>
                                    <div class="form-group form-md-line-input">
            ...
            <div class="modal-footer">
                <div class="form-actions noborder">
                    <button id="newAdminSubmit" type="button" class="btn blue my-btn-color">Submit</button>
...
<div id="updateAdmin" class="modal fade" tabindex="-1" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
                            ...
                            <div class="col-md-12">
                                <form id="updateAdminForm" role="form" autocomplete="off">
                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <label for="updateUserEmail">Admin email</label>
                                    </div>
                                    <div class="form-group form-md-line-input">
                                        <input type="password" class="form-control " id="updateUserPass" name="userPass" >
                                        <label for="updateUserPass">Password</label>
                                        <span class="help-block">Enter password</span>
                                    </div>
            ...
            <div class="modal-footer">
                <div class="form-actions noborder">
                    <button id="updateAdminSubmit" type="button" class="btn blue my-btn-color">Save</button>
                    <button type="button" data-dismiss="modal" class="btn default">Cancel</button>
                </div>
            </div>
        </div>
...
<div id="deleteAdmin" class="modal fade" tabindex="-1" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="form-actions noborder">
                    <button id="deleteAdminSubmit" type="button" class="btn red">Delete</button>
                    <button type="button" data-dismiss="modal" class="btn default">Cancel</button>
                </div>
            </div>
        </div>
