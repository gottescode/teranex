...
<h1 class="page-title"> All user
    <small>All user information</small>
</h1>
<div class="row">
                ...
                <div class="table-scrollable table-scrollable-borderless">
                    ...
                    <?php foreach ($userList as $user){ ?>
                        <tr id="user_<?php echo $user['userId']?>">
                            ...
                            <?php } ?>
                            <td>
                                <button id="userInfoBTN_<?php echo $user['userId']?>" type="button" data-status="<?php echo $user['userStatus'];?>" data-varification="<?php echo $user['userVerification']?>" data-user="<?php echo $user['userId']?>" class="btn btn-info userInfo">View info</button>
                            </td>
        ...
        $('.userInfo').on('click',function () {
            ...
            if(userId==4|| userId==5 || userId==6) {
                if (userStatus == 1 && verification == 1) {
                    strVar += "                <button data-id=" + userId + " type=\"button\" class=\"btn red blockUserBtn\" disabled>Deactivate User<\/button>";
                } else if (userStatus == 2 && verification == 0) {
                    strVar += "                <button data-id=" + userId + " type=\"button\" class=\"btn blue verifyUserBtn\">Verify user<\/button>";
                } else if (userStatus == 0 && verification == 0) {
                    strVar += "                <button data-id=" + userId + " type=\"button\" class=\"btn green unblockUserBtn\" disabled>Activate User<\/button>";
                } else {
                    strVar += "                <button type=\"button\" data-dismiss=\"modal\" class=\"btn dark\">Close<\/button>";
                }
            }else{
                if (userStatus == 1 && verification == 1) {
                    strVar += "                <button data-id=" + userId + " type=\"button\" class=\"btn red blockUserBtn\" >Deactivate User<\/button>";
                } else if (userStatus == 2 && verification == 0) {
                    strVar += "                <button data-id=" + userId + " type=\"button\" class=\"btn blue verifyUserBtn\">Verify user<\/button>";
                } else if (userStatus == 0 && verification == 0) {
                    strVar += "                <button data-id=" + userId + " type=\"button\" class=\"btn green unblockUserBtn\" >Activate User<\/button>";
                } else {
                    strVar += "                <button type=\"button\" data-dismiss=\"modal\" class=\"btn dark\">Close<\/button>";
                }
            }
