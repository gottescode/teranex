<!-- HEADER -->
    ...
    <a href="<?php echo site_url()."dashboard";?>" class="logo">
      ...
      <span class="logo-lg"><b>Teranex</b> </span>
    </a> 
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav"> 
          ...
          <li class="dropdown user user-menu">
			...
			<?	}else {?>
			<img src="<?=site_url().'uploads/prof_image/'?>default.png" class="user-image" alt="User" style="float: left; width: 39px; height: 39px; border-radius: 66px;margin-right: 6px; margin-top: -9px;">
			<?php
				}
			?>	
			...
			<?	}else {?> 
				<img src="<?=site_url().'uploads/prof_image/'?>default.png" class="img-circle" alt="User Image">
			<?php
				}
			?>	 <p>
				  <?=$adminUserdata['uname']?>
