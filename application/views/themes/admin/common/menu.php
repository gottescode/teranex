	...
	$result = apiCall($url,"GET");
		...
		?>
			...
			?>
				...
				<li><a href="<?=site_url()?>settings/machineondemandmanudata/frontEndData"><i class="fa fa-user"></i><span>Machine On-Demand Manu FrontEndData</span></a></li>
				<li><a href="<?=site_url()?>settings/programmertype/frontEndData"><i class="fa fa-user"></i><span></span>On Demand Programming Data</a></li>
