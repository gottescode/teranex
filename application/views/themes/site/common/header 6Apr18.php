                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <ul class="multi-column-dropdown">
                                                ...
                                                <li><a href="coming_soon.php">Remote Machine Service</a></li>
                                                <li><a href="coming_soon.php">Remote Application Service</a></li>
                                                <li><a href="coming_soon.php">Remote Monitoring & Control</a></li>
                                            </ul>
                                        </div>
                                        <div class="col-sm-4">
                                            <ul class="multi-column-dropdown">
                                                ...
                                                <li><a href="coming_soon.php">Collaboration Groups</a></li>
                                                <li><a href="coming_soon.php">eAcademy</a></li>
                ...
                <div class="col-md-4 col-xs-5 right-icon">
                    <div class="row"> 
						<form class="navbar-form ">
							...
							<button type="submit" class="btn btn-link ser-icon" style="    margin-left: 180px;"> <span class="glyphicon glyphicon-search" style="top: -25px;"></span></button>
						</form>
                        <div class="btn-group">
