                     ...
                     <form class="navbar-form menu-ico-mar">
                  	...
                  	<ul class="nav navbar-nav navbar-nav-ex">
	                           ...
	                           <div class="">
	                              <div class="col-sm-4 padd-0">
	                                 <ul class="multi-column-dropdown">
	                                    ...
	                                    <li><a href="<?php echo site_url();?>digitalmanufacturing/contact_manufacturing" target="_blank">Contract Manufacturing</a></li>
	                                 </ul>
	                              </div>
	                              <div class="col-sm-4 padd-0">
	                                 <ul class="multi-column-dropdown">
	                                    ...
	                                    <li class="divider"></li>
	                                    <li><a href="https://teranex.io/ecommerce/product-category/toolings/" target="_blank"> Toolings</a></li>
	                                    <li><a href="<?php echo site_url()?>machine" target="_blank">Machines</a></li>
	                                    <li><a href="https://teranex.io/ecommerce/product-category/spare-parts" target="_blank">Spares</a></li>
	                                    <li><a href="<?php echo site_url()?>pages/commingsoon" target="_blank">Automation</a></li>
	                                 </ul>
	                              </div>
	                              <div class="col-sm-4 padd-0">
	                                 <ul class="multi-column-dropdown">
	                    ...
	                    <li class="dropdown">
	                        ...
	                        <ul class="dropdown-menu">
	                           ...
	                           <li><a target="_blank" href="<?php echo site_url();?>snapshot">Snapshots</a></li>
	                           <li><a target="_blank" href="<?php echo site_url();?>consulting">Consulting</a></li>
	                           <li><a target="_blank" href="https://teranex.io/mediacenter/">Media</a></li>
				  	...
				  	<div class="btn-group-ico">
	                    <div class="btn-group dropdown">
	                       ...
	                       <img src="<?php echo $theme_url?>/images/user1.png" class="trans" style="height: 18px;width: 18px;display: none;">
	                    ...
	                    <div class="btn-group dropdown">
	                       ...
	                       <img src="<?php echo $theme_url?>/images/lins1.png" class="trans" style="height: 18px;width: 18px;display: none;">
	                       <img src="<?php echo $theme_url?>/images/lins.png" class="non-trans" style="height: 18px;width: 18px;">
