			...
			<div class="col-sm-12 padd-0">
				...
				<div class="col-sm-4">
				  <div class="text-center mob-center">
					<p>
						<span class="links"><a target="_blank" href="<?php echo site_url()."pages/feedback";?>">Feedback</a>  |  <a target="_blank" href="<?php echo site_url()."pages/disclaimer";?>">Disclaimer</a>  |  <a href="<?php echo site_url()."pages/teranex_faq";?>">FAQs</a>  
					</span>
					</p>
				  </div>
				</div>
