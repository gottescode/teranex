                  	...
                  	<ul class="nav navbar-nav navbar-nav-ex">
	                           ...
	                           <div class="">
	                              <div class="col-sm-4 padd-0">
	                                 <ul class="multi-column-dropdown">
	                                    ...
	                                    <li class="divider"></li>
	                                    <li><a href="<?php echo site_url()?>community/forum" target="_blank">User Communities</a></li>
	                                    ...
	                                    <li><a href="<?php echo site_url();?>snapshot" target="_blank">Market Intelligence</a></li>
	                              ...
	                              <div class="col-sm-4 padd-0">
	                                 <ul class="multi-column-dropdown">
	                                    ...
	                                    <li><a target="_blank" href="<?php echo site_url();?>events">Remote Events</a></li>
	                                 </ul>
	                              </div>
	                           </div>
	                        </ul>
	                    ...
	                    <li class="dropdown">
	                        ...
	                        <ul class="dropdown-menu">
	                           <li><a target="_blank" href="http://teranex.io/mediacenter/">In Focus</a></li>
	                           <li><a target="_blank" href="http://teranex.io/mediacenter/category/industry-news/">Industry News</a></li>
	                           <li><a target="_blank" href="http://teranex.io/mediacenter/category/experts/">Expert Blogs</a></li>
	                           <li><a target="_blank" href="http://teranex.io/mediacenter/category/customer-blog/">Customer Blogs</a></li>
	                           <li><a target="_blank" href="http://teranex.io/mediacenter/category/videos/">Videos</a></li>
