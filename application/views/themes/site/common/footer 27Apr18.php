			...
			<div class="col-sm-12 padd-0">
				...
				<div class="col-sm-4">
				  <div class="soc-media_footer mob-center">
					<span class="ui-footer-sociality-text">Follow us:</span><i class="fa fa-facebook" aria-hidden="true"></i><i class="fa fa-twitter" aria-hidden="true"></i><i class="fa fa-linkedin" aria-hidden="true"></i><i class="fa fa-youtube" aria-hidden="true"></i><i class="fa fa-rss" aria-hidden="true"></i>
				  </div>
				</div>
			</div>
        </div>
