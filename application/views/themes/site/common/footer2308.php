	<div class="container-fluid t-footer-bars">
		...
		<div class="container">
            ...
            <div class="footer-col link">
				...
				<a target="_blank" href="<?php echo site_url()."pages/contact";?>">Contact Us</a>
                <a target="_blank" href="<?php echo site_url()."pages/teranex_team";?>">Team</a>
                <a target="_blank" href="<?php echo site_url()."footer/helpCenter";?>">Help Center</a>
            </div>
			<div class="footer-col link">
			...
			<div class="col-sm-12 padd-0">
				...
				<div class="col-sm-4">
				  <div class="text-center mob-center">
					<p>
						<span class="links"><a target="_blank" href="<?php echo site_url()."pages/feedback";?>">Feedback</a>  |  <a target="_blank" href="<?php echo site_url()."pages/disclaimer";?>">Disclaimer</a>  |  <!-- <a href="<?php echo site_url()."pages/teranex_faq";?>">FAQs</a> --><a target="_blank" href="<?php echo site_url()."footer/siteMap";?>">Sitemap</a>
					</span>
					</p>
				  </div>
				</div>
