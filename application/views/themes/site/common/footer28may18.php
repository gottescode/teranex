	<div class="container-fluid t-footer-bars">
		...
		<div class="container">
            ...
            <div class="footer-col link">
                <h4>About Us</h4>
                <a target="_blank" href="<?php echo site_url()."pages/about";?>">About TERANEX.io</a>
            ...
            <div class="footer-col link">
                ...
                <a target="_blank" href="<?php echo site_url()."footer/supplierMembership";?>">Supplier Membership</a>
                <a target="_blank" href="<?php echo site_url()."footer/serviseProviderMembership";?>">Service Provider Membership</a>
			...
			<div class="footer-col link">
                ...
                <a target="_blank" href="<?php echo site_url()."footer/logisticsService";?>">Logistics Service</a>
