	<div class="container-fluid t-footer-bars">
        <div class="container"> 
			<p class="text-center">Trade Alert - Delivering the latest product trends and industry news straight to your inbox.</p>
		...
		<div class="container">
            ...
            <div class="footer-col link">
                <h4>About Us</h4>
                <a href="<?php echo site_url()."pages/about";?>">About Teranex.com</a>
                <a href="<?php echo site_url()."pages/team";?>">Team</a>
                <a href="<?php echo site_url()."footer/siteMap";?>">Sitemap</a>
            </div>
			<div class="footer-col link">
                <h4>Buy on Teranex.com</h4>
                <a href="<?php echo site_url()."footer/allCategories";?>">All Categories </a>
                <a href="<?php echo site_url()."footer/rfq";?>">Request for Quotation</a>
            </div>
            <div class="footer-col link">
                <h4>Sell on Teranex.com</h4>
                <a href="<?php echo site_url()."footer/supplierMembership";?>">Supplier Membership</a>
                <a href="#">Service Provider Membership</a>
                <a href="<?php echo site_url()."footer/learningCenter";?>">Learning Center</a>
            </div>
			<div class="footer-col link">
                <h4>Trade Services</h4>
                <a href="<?php echo site_url()."pages/suppliers";?>">Trade Assurance</a>
                <a href="<?php echo site_url()."pages/serviceproviders";?>">Business Identity</a>
                <a href="<?php echo site_url()."pages/market_place";?>">Logistics Service</a>
                <a href="<?php echo site_url()."pages/market_place";?>">Secure Payment</a>
                <a href="<?php echo site_url()."pages/market_place";?>">Inspection Service</a>
            </div>
			...
			<div class="col-sm-12 padd-0">
				...
				<div class="col-sm-4">
				  <div class="text-center mob-center">
					<span class="ui-footer-sociality-text">Download TradeManager:</span>
					<a target="_blank" title="" href="#" class="app-store">
					  <img src="<?php echo $theme_url?>/images/chat.png">
					</a>
				  </div>
				</div>
				<div class="col-sm-4">
					...
					<a href="https://twitter.com/TeranexRA" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i></a>
					<a href="https://www.linkedin.com/company/teranex-research-and-applications" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
					<a href="https://www.youtube.com/channel/UCNaXBz5Nz7bqYmNnIrUJVTw" target="_blank"><i class="fa fa-youtube" aria-hidden="true"></i></a>
        ...
        <div class="container">
			<p>
			    <span class="links"><a href="coming_soon.php">Feedback</a>  |  <a href="<?php echo site_url()."pages/disclaimer";?>">Disclaimer</a>  |  <a href="coming_soon.php">FAQs</a>  
			</span>
			</p>
		</div>
