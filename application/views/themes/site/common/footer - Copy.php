	<div class="container-fluid footer-bars">
        <div class="container">
            ...
            <div class="col-sm-10 padd-0">
            	<span class="links">
		      &copy; <a href="index.php">Teranex</a>  |  <a href="coming_soon.php">Sitemap</a> |  <a href="coming_soon.php">Feedback</a>  |  <a href="<?php echo site_url()."pages/disclaimer";?>">Disclaimer</a>  |  <a href="coming_soon.php">FAQs</a>  |  <a href="privacy-statement.php">Privacy</a>  |  <a href="<?php echo site_url()."pages/returnscancellations";?>">Returns & Cancellations </a>  |  <a href="<?php echo site_url()."pages/termsconditions";?>">T&C of Sales & Service</a>  |  <a href="<?php echo site_url()."pages/termsuse";?>">Terms of Use </a>
		      </span>
            </div>
            <div class="col-sm-2 padd-0 social_icon">
            	<a href="" class="youtube"><span><i class="fa fa-youtube"></i></span></a>
            	<a href="" class="linkedin"><span><i class="fa fa-linkedin"></i></span></a>
            	<a href="" class="twitter"><span><i class="fa fa-twitter"></i></span></a>
            	<a href="" class="facebook"><span><i class="fa fa-facebook-f"></i></span></a>
            </div>
