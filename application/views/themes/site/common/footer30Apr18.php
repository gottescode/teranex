        ...
        <div class="container" style="padding: 20px 0;">
			<div class="col-sm-12 padd-0">
				...
				<div class="col-sm-4">
					...
					<a href="https://twitter.com/TeranexRA" target="_blank"></a>
					</i>
					<i class="fa fa-linkedin" aria-hidden="true">
						<a href="https://www.linkedin.com/company/13716756/" target="_blank"></a>
					</i>
					<i class="fa fa-youtube" aria-hidden="true">
						<a href="https://www.youtube.com/channel/UCNaXBz5Nz7bqYmNnIrUJVTw" target="_blank"></a>
					</i>
