            ...
            <div class="ipad-menu ipro-menu">
               <div class="menu-center">
                  ...
                  <ul class="nav navbar-nav navbar-nav-ex">
                     ...
                     <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Research & Analytics<span class="caret"></span></a>
                        <ul class="dropdown-menu">
                     ...
                     <li> <a href="<?php echo site_url()?>#" target="_blank">eAcademy</a></li>
