	...
	<nav id="navigation" class="navbar navbar-dark bg-primary navbar-fixed-top">	
            ...
            <div class="navbar-header">
                <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
                  ...
                  <span class="icon-bar non-trans"></span>
                  <span class="icon-bar trans"></span>
                  <span class="icon-bar non-trans"></span>
                  <span class="icon-bar trans"></span>
                  <span class="icon-bar non-trans"></span>
                  </button>
                <a class="navbar-brand" href="<?php echo site_url()?>" style="padding:0px; margin-top:10px;">
					<img src="<?php echo $theme_url?>/images/logo1o11.png" class="img-responsive trans">
					<img src="<?php echo $theme_url?>/images/logo1o1.png" class="img-responsive logo-hide">
				</a>
            </div>
            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <div class="col-md-5 col-xs-5 right-icon">
                    <div class="row"> 
                        ...
                        <div class="btn-group">
							...
							<img src="<?php echo $theme_url?>/images/help.png" width="23" height="21" class="trans">
							<img src="<?php echo $theme_url?>/images/help1.png" width="23" height="21" class="non-trans"></a>
                        ...
                        <div class="btn-group">
                            <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Track order">
								<img src="<?php echo $theme_url?>/images/truck1.png" width="27" height="21" class="trans">
								<img src="<?php echo $theme_url?>/images/truck.png" width="27" height="21" class="non-trans"></a>
                            <ul class="dropdown-menu" style=" min-width:160px;">
                        ...
                        <div class="btn-group">
							...
							<img src="<?php echo $theme_url?>/images/shoping1.png" width="27" height="21" class="trans">
							<img src="<?php echo $theme_url?>/images/shoping.png" width="27" height="21" class="non-trans"></a>
                        ...
                        <div class="btn-group">
							...
							<img src="<?php echo $theme_url?>/images/user1.png" width="17" height="21" class="trans">
							<img src="<?php echo $theme_url?>/images/user.png" width="17" height="21" class="non-trans">
							</a>
                        ...
                        <div class="btn-group" style="padding-right: 19px;">
                            <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Links">
								<img src="<?php echo $theme_url?>/images/lins1.png" width="17" height="21" class="trans">
								<img src="<?php echo $theme_url?>/images/lins.png" width="17" height="21" class="non-trans">
							</a>
				...
				<ul class="nav navbar-nav navbar-nav-ex">
                    ...
                    <li><a href="<?php echo site_url()?>#forum-sec">Forum 4.0</a></li>
