                     ...
                     <form class="navbar-form menu-ico-mar">
                  	...
                  	<ul class="nav navbar-nav navbar-nav-ex">
	                           ...
	                           <div class="">
	                              ...
	                              <div class="col-sm-4 padd-0">
	                                 <ul class="multi-column-dropdown">
	                                    <h5>Services</h5>
	                                    <li class="divider"></li>
	                                    <li><a target="_blank" href="<?php echo site_url();?>consultant">Remote Machine Services</a></li>
	                                    <li><a href="<?php echo site_url()?>remoteapplication" target="_blank">Remote Application Support</a></li>
	                                    <li><a target="_blank" href="<?php echo site_url();?>remotetraining">Remote Training Services</a></li>
	                    ...
	                    <li class="dropdown">
	                    	...
	                    	<a class="dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Sign Out">
	                    	 <?php } else{ ?>
