   ...
   <div class="container padd-0">
      <nav id="navigation" class="navbar navbar-default navbar-ex">
         ...
         <div class="navbar-header">
            ...
            <img src="<?php echo $theme_url?>/images/logo20.png" class="img-responsive main_logo">
            <img src="<?php echo $theme_url?>/images/logo20_old.jpg" class="img-responsive logo-hide" style="display: none;">
            </a>
         </div>
            ...
            <div class="ipad-menu ipro-menu">
               <div class="menu-center">
                  ...
                  <ul class="nav navbar-nav navbar-nav-ex">
                     <li class="nav_search" style="display: none;">
                           <form class="navbar-form menu-ico-mar">
                              <div class="form-group" style="margin-bottom:0px;">
                           ...
                           <div class="">
                              <div class="col-sm-4 padd-0">
                                 <ul class="multi-column-dropdown">
                                    ...
                                    <li class="divider"></li>
                                    <li><a href="<?php echo site_url()?>community/forum" target="_blank">User Groups</a></li>
                                    <li><a href="<?php echo site_url()?>groupbuying" target="_blank">Buyer Groups</a></li>
                                    <li><a href="<?php echo site_url();?>xpertconnect" target="_blank">Freelancer Groups</a></li>
                                    <li><a href="<?php echo site_url();?>pages/commingsoon" target="_blank">Infobins</a></li>
                              ...
                              <div class="col-sm-4 padd-0">
                                 <ul class="multi-column-dropdown">
                                    ...
                                    <li><a href="<?php echo site_url()?>pages/commingsoon" target="_blank">Software</a></li>
                                 </ul>
                              </div>
                              <div class="col-sm-4 padd-0">
                                 <ul class="multi-column-dropdown">
                                    ...
                                    <li><a href="<?php echo site_url()?>consultant" target="_blank">Remote Service</a></li>
                                    <li><a href="<?php echo site_url()?>consultant/remoteapp_service" target="_blank">Remote Application</a></li>
                                    <li><a target="_blank" href="<?php echo site_url();?>stelmac/contact_manufacturing">Remote Fabrications</a></li>
                                 </ul>
                              </div>
                           </div>
                        </ul>
                     ...
                     <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                           ...
                           <li><a target="_blank" href="https://gotteswork.com/mediacenter/">Media</a></li>
                           <li><a target="_blank" href="<?php echo site_url();?>events">Events</a></li>
                           <!--<li><a target="_blank" href="<?php echo site_url();?>pages/commingsoon">Passport</a></li>-->
                        </ul>
                     </li>
                     <li><div class="btn-group-ico">
                        <div class="btn-group dropdown">
                           <a class="dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Sign in">
                           <img src="<?php echo $theme_url?>/images/user1.png" class="trans" style="height: 18px;width: 18px;">
                           <img src="<?php echo $theme_url?>/images/user.png" class="non-trans" style="height: 18px;width: 18px;display: none;">
                           </a>
                        ...
                        <div class="btn-group dropdown">
                           ...
                           <img src="<?php echo $theme_url?>/images/lins1.png" class="trans" style="height: 18px;width: 18px;">
                           <img src="<?php echo $theme_url?>/images/lins.png" class="non-trans" style="height: 18px;width: 18px;display: none;">
