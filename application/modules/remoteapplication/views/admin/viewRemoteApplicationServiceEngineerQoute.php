...
<section class="content-header">
  <span style="font-size: 24px;padding: 10px;">Remote Application RFQ By Service Engineer</span>
			...
			<div class="box">
				...
				<form class="form" name="qoutationAdd" id="traineeAdd" method="post" action="" enctype="multipart/form-data">
					...
					<input type="file" class="" id="quotation_uploaded" name="quotation_uploaded" placeholder=""  />
					 ...
					 <div class="clearfix"></div>
					<?php  if($singleList['applicationengineer_id'] == '0'){ ?>
					 <div class="form-group ">
					<input type="hidden" class="" id="racrp_id" name="racrp_id" value="<?php echo $result['racrp_id']?>" />
...
?>
					<!-- <div class="form-group col-sm-12 col-xs-6">
                       <?php if($singleList['applicationengineer_id'] == '0'){
?>
   <center> <a href="<?=site_url()."remoteapplication/admin/RemoteApplicationRFQAcceptByadmin/".$result['racrp_id']?>" class="btn btn-success">Accept</a> &nbsp; &nbsp;</center>
