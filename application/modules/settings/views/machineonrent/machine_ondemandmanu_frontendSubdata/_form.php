			...
			<form class="form-horizontal" role="form" action="" id="Machine_form" method="post" enctype="multipart/form-data">
				<fieldset>
				   	<div class="form-group">
						<label class="control-label col-sm-3" for="title">Main Title:<span class="star">*</span></label>
						<div class="col-sm-6">
							<input type="text"  name="sub_cat_main_title" id="sub_cat_main_title" class="form_bor_bot required" value="<?=$updateData['sub_cat_main_title']?>" >
						</div>
				  	</div>
					<div class="form-group">
						<label class="control-label col-sm-3" for="title">Block Title:<span class="star">*</span></label>
						<div class="col-sm-6">
							<input type="text"  name="block_title" id="block_title" class="form_bor_bot required" value="<?=$updateData['block_title']?>" >
						</div>
				  	</div>
					<div class="form-group">
						<label class="control-label col-sm-3" for="title">Description:<span class="star">*</span></label>
						<div class="col-sm-6">
						<textarea name="description" id="description" class="form-control required" ><?=strhtmldecode($type_data['description'])?> </textarea>
												</div>
				  	</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							...
							<?php if($updateData['image']){?>
								<img src="<?=site_url().'uploads/machine_on_rent_frontend_images/'.$updateData['image']?>" width="100px">
