...
<div class="box-body">
	...
	<?php	} ?>
		...
		<div class="col-xs-12 border_bot"> 
			<form class="form-horizontal" role="form" action="" id="applicationrequired_form" method="post" enctype="multipart/form-data">
				<fieldset>
				  ...
				  <div class="form-group"> 
					<div class="text-center">
					 ...
					 <input type="hidden" name="id" value="<?php echo $type_data['aid']?>"  > 
					</div>
				  </div>
				</fieldset>
			</form>
...
<script> 
$("#applicationrequired_form").validate({
		rules: {    
				type_name: "required",
			},
			messages: {  
