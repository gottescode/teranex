			...
			<form class="form-horizontal" role="form" action="" id="materialType_form" method="post" enctype="multipart/form-data">
				<fieldset>
				   ...
				   <div class="form-group">
					<label class="control-label col-sm-3" for="name">Category:<span class="star">*</span></label>
					<div class="col-sm-6">
					<input type="text" name="title" id="title" class="form_bor_bot required" value="<?=$type_data['title']?>">
					</div>
				  </div> 
