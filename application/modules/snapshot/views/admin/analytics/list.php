							...
							<form id="" name="" class="form-horizontal" enctype="multipart/form-data" method="post">
								...
								<table class="table table-bordered table-striped" id="community_table">
										...
										<?=strhtmldecode($rowData['case_study_description'])?></td>
													...
													<td><a href="<?=site_url()."analytics/admin/updateCaseStudy/".$rowData['case_study_id']?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp; &nbsp;
														<a onclick="return confirm('Are You Sure To Delete This Entry?')"  href="<?=site_url()."analytics/admin/deleteCaseStudy/$cid/".$rowData['case_study_id']?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
