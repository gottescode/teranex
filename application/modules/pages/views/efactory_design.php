			...
			<div class="col-sm-12" style="padding: 30px 0;">
				...
				<div>
					<ul class="tab-widget icon-tab tab-pd">
						<li>
							<a target="" href="javascript:void(0)" data-tb="#service-tab-1" class="flex-cc">
						...
						<li>
							<a target="" href="<?php echo site_url()."remoteprogramming";?>" data-tb="#service-tab-2" class="flex-cc">
						...
						<li>
							<a target="" href="javascript:void(0)" data-tb="#service-tab-5" class="flex-cc">
