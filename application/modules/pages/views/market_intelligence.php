	...
	<div class=" padd-0 paralax-section1 " style="background-image: url('<? echo $theme_url?>/images/onlinecourse-macademy-min.jpg');height: 100%;width: 100%;background-size: cover;">
		<div style="width: 100%;background-color: #0000007d">
			<div class="col-sm-12" style="padding: 30px 0;">
				<center>
					<h1 class="white-text"> Market Intelligence</h1>
				...
				<div>
					<ul class="tab-widget icon-tab tab-pd">
						<li>
							<a target="" href="<?php echo site_url()."research";?>"style="margin: 0 auto;" data-tb="#service-tab-1" class="flex-cc">
							<i class="fa fa-search" aria-hidden="true"></i></a>
							<h3 class="fs16 bold-2 mr-t-10">Research Insights</h3>
						</li>
						<li><i class="fa fa-plus fa-lg" aria-hidden="true"></i></li>
						<li>
							<a target="" href="<?php echo site_url()."analytics";?>"style="margin: 0 auto;" data-tb="#service-tab-2" class="flex-cc">
							<i class="fa fa-line-chart" aria-hidden="true"></i></a>
							<h3 class="fs16 bold-2 mr-t-10">Market Monitoring</h3>
						</li>
						<li><i class="fa fa-plus fa-lg" aria-hidden="true"></i></li>
						<!-- <li>
						...
						<li><i class="fa fa-plus fa-lg" aria-hidden="true"></i></li> -->
						<!-- <li>
							<a target="" href="<?php echo site_url()."events";?>" data-tb="#service-tab-5" class="flex-cc">
							<i class="fa fa-calendar" aria-hidden="true"></i></a>
							<h3 class="fs16 bold-2 mr-t-10">Events</h3>
						</li>
						<li><i class="fa fa-plus fa-lg" aria-hidden="true"></i></li> -->
						<li>
							<a target="" href="<?php echo site_url()."/mediacenter/category/media/";?>" style="margin: 0 auto;"data-tb="#service-tab-6" class="flex-cc">
