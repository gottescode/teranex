...
$MERCHANT_KEY = "WmAeigLn";//PAYU_key"";// "";

// Merchant Salt as provided by Payu
$SALT = "4YWkTvpBIu";//PAYU_salt"";// "";
...
?>
    ...
    <?php if($formError) { ?>
      ...
      <br/>
    <?php }
	if($this->session->flashdata('payuData')){
		$posted = $this->session->flashdata('payuData');
	} 
	?>
    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm" id="payuForm" style="display:none" >
      ...
      <table>
        ...
        <tr>
          <td>Amount: </td>
          <td><input name="amount" id="amount" value="<?php echo $posted['amount']?>" /></td>
          <td>First Name: </td>
