    ...
    <!-- Content Header (Page header) -->
		<section class="content-header">
		  ...
		  <ol class="breadcrumb">
			...
			<li class=""><a href="<?=site_url()."digitalmanufacturing/admin"?>">Manufacturing Process List</a></li>
	 ...
	 <!-- Main content -->
		<section class="content">
			<div class="row">
				<div class="col-xs-12">
					<div class="box">
						<div class="padd-15"><a href="<?=site_url()."digitalmanufacturing/admin/createAdditiveManufacturingProcesses/".$amid ?>" class="btn btn-info" role="button">Add Process List</a></div>
							...
							<form id="" name="" class="form-horizontal" enctype="multipart/form-data" method="post">
								...
								<table class="table table-bordered table-striped" id="community_table">
										...
										<?=strhtmldecode($rowData['additive_manufacturing_process_description'])?></td>
													...
													<td><a href="<?=site_url()."digitalmanufacturing/admin/updateAdditiveManufacturingProcesses/".$rowData['additive_manufacturing_process_id']?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp; &nbsp;
														<a onclick="return confirm('Are You Sure To Delete This Entry?')"  href="<?=site_url()."digitalmanufacturing/admin/deleteAdditiveManufacturingProcesses/$amid/".$rowData['additive_manufacturing_process_id']?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
