						...
						<div class="table-responsive">
							<table class="table table-bordered table-striped" id="product_table">
								...
								?>
									        ...
									        <td> <?php if($rowData['request_status'] == 'A'){ ?><a href="<?php echo site_url()."rapidprototyping/admin/viewRapidprototypingSupplierQoute/$rowData[drrs_id]"?>" class="btn btn-primary btn-xs">View Quotation</a><?php } ?></td>
											</tr>
									<?php }
