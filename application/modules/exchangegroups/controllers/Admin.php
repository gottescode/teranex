...
class Admin extends BACKEND_Controller {
	...
	public function exchangeGroupOfferList(){
		
		$url	= site_url()."customer/exchangegroupapi/offeredListAdmin";
		$rfqList = apiCall($url,"get"); 
	
		$arrayData=array("offeredData"=>$rfqList['result'] );	
			
		$this->template->load("admin/rfqListExchangeGroup",$arrayData);
	}
