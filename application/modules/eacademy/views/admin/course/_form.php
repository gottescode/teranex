			...
			<form class="form-horizontal" role="form" action="" id="course_form" method="post" enctype="multipart/form-data">
				<fieldset>
				   <div class="form-group">
					...
					<div class="col-sm-6">
					<input type="text" name="name" id="name" class="form_bor_bot required" value="<?=$course_data['name']?>">
					</div>
				  </div> 
				   <div class="form-group">
					<label class="control-label col-sm-3" for="sub_title">Sub Title: </label>
					<div class="col-sm-6">
					<input type="text" name="sub_title" id="sub_title" class="form_bor_bot " value="<?=$course_data['sub_title']?>">
					</div>
				  </div> 
				   <div class="form-group">
					<label class="control-label col-sm-3" for="description">Description:<span class="star">*</span></label>
					<div class="col-sm-8">
					<textarea   name="description" id="description" class="form_bor_bot required" ><?=$course_data['description']?></textarea>
					</div>
				  </div> 
				   <div class="form-group">
					<label class="control-label col-sm-3" for="key_features">Key Features:<span class="star">*</span></label>
					<div class="col-sm-8">
					<textarea   name="key_features" id="key_features" class="form_bor_bot required" ><?=$course_data['key_features']?></textarea>
					</div>
				  </div> 
				   <div class="form-group">
					<label class="control-label col-sm-3" for="video_link">Course  Level: </label>
					<div class="col-sm-6">
					...
					<div class="col-sm-6">
					<input type="file" name="videoLink" id="videoLink" class="form_bor_bot " >
					</div>
				  </div> 
				    <div class="form-group">
					<label class="control-label col-sm-3" for="course_image">Image : </label>
					<div class="col-sm-6">
					<input type="file" name="courseImage" id="course_image" class="form_bor_bot" value="" >
					 <?php if($course_data['course_image']){?>
					  <img src="<?=site_url().'/uploads/course/'.$course_data['course_image']?>" width="100px">
				...
				<!--  <div class="form-group">
 				  ...
 				  <div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
						<input type="text" name="course_amount" id="course_amount" class="form_bor_bot required" value="<?=$course_data['course_amount']?>">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-3" for="trainee_user_id">Trainee: </label>
						<div class="col-sm-6">
						<select class="form_bor_bot trainee_user_id" id="trainee_user_id" name="trainee_user_id" >
