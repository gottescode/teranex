			...
			<form class="form-horizontal" role="form" action="" id="content_course_form" method="post" enctype="multipart/form-data">
				<fieldset>
				   <div class="form-group">
					...
					<div class="col-sm-6">
					<input type="text" name="title" id="title" class="form-control required" value="<?=$content_data['title']?>">
					</div>
				  </div> 
				   ...
				   <div class="form-group">
					...
					<div class="col-sm-8">
					<textarea   name="description" id="description" class="form-control required" ><?=$content_data['description']?></textarea>
					</div>
				  </div> 
