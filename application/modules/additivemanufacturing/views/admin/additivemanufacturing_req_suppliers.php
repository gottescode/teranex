					...
					<form id="" name="" class="form-horizontal" enctype="multipart/form-data" method="post">
						<div class="table-responsive">
							<table class="table table-bordered table-striped" id="product_table">
							  ...
							  elseif($rowData['request_status'] == 'QG') { ?>Quotation Generated<?php } 
							  elseif($rowData['request_status'] == 'D') { ?>Processing  <?php } 
                                                          elseif($rowData['request_status'] == 'C') { ?>Completed </td>
										<?php  } else { ?>s
											<td>Allocated to other</td>

									    <?php	} ?> 
									    <td><?php if($rowData['request_status'] == 'QG'){ ?><a href="<?php echo site_url()."additivemanufacturing/admin/viewAdditiveManufacturingSupplierQoute/$rowData[drrs_id]"?>" class="btn btn-primary btn-xs">View Quotation</a></td><?php } ?></td>
											</tr>
									<?php }
