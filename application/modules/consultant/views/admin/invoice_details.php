						...
						<form class="form-horizontal" role="form" action="" id="course_form" method="post" enctype="multipart/form-data">
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<select class="form-control margin" name="margin" id="margin">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" name="total_amount_perc" id="total_amount_per" class="form-control required" value="<?=$result['total_amount']?>">
									</div>
								</div>
								<div class="form-group"> 
									<div class="col-sm-offset-4 col-sm-5">
										<input type="hidden" name="rmr_id" id="rmr_id"  value="<?=$result['rmr_id']?>">
