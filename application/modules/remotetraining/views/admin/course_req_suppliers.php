...
<section class="content-header">
  <span style="font-size: 24px;padding: 10px;">Course Suppliers List</span>
						...
						<div class="table-responsive">
							<table class="table table-bordered table-striped" id="product_table">
								...
								?>
									    ...
									    <?php	} ?> 
									    <td><a href="<?php echo site_url()."remotetraining/admin/viewCourseSupplierQoute/$rowData[csr_id]"?>" class="btn btn-primary btn-xs">View Quotation</a></td>
											</tr>
									<?php }
