  ...
  <div class="container">
    <div class="col-sm-12 padd-0">
     <!--  <ul>
      ...
      <h2 class=""><?php if($categoryCount){ echo $categoryCount['category_name']."(".$categoryCount['machineCount'].")"; } ?></h2>
    </div>
  </div>
  <!-- /.container --> 
</div>
			...
			<?php if($machineList){
				...
				<div class="col-sm-3 padd-8">
					<div class="bx-shadow" style="border:none;min-height: 472px;box-shadow: 0px 0px 10px #dfdcdc;">
						<img src="<?=base_url().'uploads/machine/'.$rowMachine['machine_image']?>" width="100%" style="min-height: 220px;">
