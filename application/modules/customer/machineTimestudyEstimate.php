                ...
                <?php } ?>
                    <form class="form" name="qoutationAdd" id="traineeAdd" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form_bor_bot  " id="cost" name="cost" required=""   placeholder="Cost" ><?php echo $result['cost']?></textarea> 
                            </div>
                        </div><div class="clearfix"></div><br/>
                         <div class="form-group ">
                            <label class="control-label col-sm-4" for="">Time Per Unit:</label>
                            <div class="col-sm-6">
                                <textarea class="form_bor_bot numbersOnly" id="cost" name="cost" required=""   placeholder="Time Per Unit" ><?php echo $result['time_per_unit']?></textarea> 
                            </div>
                        </div><div class="clearfix"></div><br/>
                        <div class="form-group ">
                            <label class="control-label col-sm-4" for="">Cost Details:</label>
                            <div class="col-sm-6">
                                <textarea class="form_bor_bot" id="cost_details" name="cost_details" required=""   placeholder="Cost Details" ><?php echo $result['cost_details']?></textarea> 
                            </div>
                        </div><div class="clearfix"></div><br/>
                        <div class="form-group">
