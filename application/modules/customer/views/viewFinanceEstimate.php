                    ...
                    <form class="form" name="qoutationAdd" id="traineeAdd" method="post" action="" enctype="multipart/form-data">
                       ...
                       <!--  <div class="form-group">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control rounded-0" id="finance_details" rows="6"readonly><?php echo $result['finance_details']?></textarea> 
                            </div>
                        </div><div class="clearfix"></div><br/>
                       ...
                       <!--  <div class="form-group">
                        ...
                        <?php if(  $result['request_status']=='R' || $result['request_status']=='C'  ){ if ($result['request_status']=='C' ) {
                          ...
                          <?php } else{ ?>
                           <center><a href="<?=site_url()."customer/FinanceRequestAcceptBycustomer/$result[mfr_id]"?>" class="btn btn-success">Accept</a>&nbsp;&nbsp;&nbsp;<a href="<?=site_url()."customer/FinanceRequestRejectBycustomer/$result[mfr_id]"?>" class="btn btn-success">Reject</a></center>
                        <?php } ?>
                        </div>
