						...
						<table class="table table-bordered table-striped" id="gallery">
							<thead>
								...
								<tr>
										...
										<td>
											<a onclick="return confirm('Are you sure delete this entry?')"  href="<?=site_url()."customer/delete_gallary/".$row['mp_id'].'/'.$row['md_id']?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a> 
										</td> 
