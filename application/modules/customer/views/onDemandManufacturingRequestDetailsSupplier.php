...
<?php   $this->load->view("cust_side_menu" ); ?>
	<div class="bg_white"> 
		...
		?>
			...
			<a href = "<?php echo site_url()."customer/sendQuoteToCustomer/".$rfqID?>" class="btn btn-sm btn-primary pull-left
			">Send Quote</a>
		<table id='' class="table table-striped table-hover">
			...
			<a href = "<?php echo site_url()."customer/sendQuoteToCustomer/".$rfqID?>" class="btn btn-sm btn-primary">Send Quote</a>
