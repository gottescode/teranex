                ...
                <table id='' class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        foreach ($rfqData['result'] as $row) {
                            ...
                            <tr>
                                <td><? echo $SNo;?></td>
                                <td><? echo $custData['Consumablename'];?></td> 
                                <td><? echo $custData['consumable_category'];?></td> 
                                <td><? echo $custData['consumable_type'];?></td> 
                                <td><? echo $custData['consumable_brand'];?></td> 
                                <td><? echo $row['cons_quantity'];?></td> 
                                ...
                                <td>
									...
									<a href="<?php echo site_url() ?>customer/groupbuying/sendQuoatationToAdmin/<?=$row['sup_id']; ?>" class= "btn btn-xs" >Send Quotation</a> 	
									<? } ?>&nbsp; &nbsp; 
