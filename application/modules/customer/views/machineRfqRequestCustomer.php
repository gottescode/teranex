									...
									$i=1;
										...
										<tr>
											...
											<td>
												...
												?>
												<?	if($row['status'] == 'QS'){ ?>
													<a href="<?php echo site_url()."customer/acceptMachineRfqSupplier/".$row['id']?>" class="btn btn-xs btn-primary" onclick="return confirm('Are You Sure To Accept This Quote?')"> Accept Quote</a>
													<a href="<?php echo site_url()."customer/rejectMachineRfqFromSupplier/".$row['id']?>" class="btn btn-xs btn-primary" onclick="return confirm('Are You Sure To Reject This Quote?')" > Reject Quote</a>
												<?	} ?>
											</td> 	
										</tr>
										<? } ?>
