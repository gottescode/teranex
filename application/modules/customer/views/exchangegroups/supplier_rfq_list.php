                    ...
                    <tbody>
						...
						<td>		<?php if($row['status']=='R'){
                                ...
                                <td>
									...
									<a href="<?php echo site_url() ?>customer/exchangegroup/acceptEnq/<?=$row['id']; ?>" class= "btn btn-xs btn-success" >Accept</a> 	
									
									<a href="<?php echo site_url() ?>customer/exchangegroup/viewDetailsSupplier/<?=$row['id']; ?>" class= "btn btn-xs" >View Details</a> 	
