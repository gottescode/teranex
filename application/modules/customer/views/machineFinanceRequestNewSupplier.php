						...
						if($FinanceReqList >0){ $i=1;
							foreach($FinanceReqList as $row){	?>
									...
									<?	}	?>
												...
												<td>
												<a href="<?php echo site_url()."customer/sendFinanceQuoteToCustomer/".$row['id']?>" class="btn btn-xs btn-primary" > Send Quote</a>
												</td>
											</tr>
