			...
			<div class="col-sm-12">
				<div class="company-details">
					<ul class="nav nav-tabs ">
					  	<li class="active"><a data-toggle="tab" href="#menu0">Company Details</a></li>
					  	<li><a data-toggle="tab" href="#menu1">Address</a></li>
					  	<li><a data-toggle="tab" href="#menu2">Company Documents</a></li>
					  	<li><a data-toggle="tab" href="#menu3">Other Documents</a></li>
					  	<li><a data-toggle="tab" href="#menu4">Bank Details</a></li>
					</ul>
						    ...
						    <div class="col-sm-12 border_bot">
							 	<form class="form" name="company" id="company" method="post" action="">
							 		<div class="form-group">
										<input type="text" class="form_bor_bot" id="user_name" name="u_name" placeholder="User Name" value="<? echo $customer_data['u_name'];?>"  /><span class="compulsary">*</span>
									</div><div class="clearfix"></div>
									<div class="form-group">
										<input type="email" class="form_bor_bot" id="user_email" name="u_email" placeholder="Email" value="<? echo $customer_data['u_email'];?>"  /><span class="compulsary">*</span>
									</div><div class="clearfix"></div>
									<div class="form-group">
										<input type="text" class="form_bor_bot numbersOnly" id="userphno" name="u_mobileno" placeholder="Phone Number" minlength="10" maxlength="10" value="<? echo $customer_data['u_mobileno'];?>"  /><span class="compulsary">*</span>
									</div><div class="clearfix"></div>
									<div class="form-group">
					  	...
					  	<div id="menu3" class="tab-pane fade">
						    <div class="col-sm-12 border_bot">
				        		<form class="form" name="upload_otherdoc_form" id="upload_otherdoc_form" method="post" action="" enctype="multipart/form-data">
									...
									<div class="form-group col-sm-12 col-xs-6">
									   <center><input type="submit" name="submitOtherdocument" id="submit" class="btn btn_orange" value="Add Files" /></center>
									</div>
								</form>
				        	</div>
