  ...
  <div class="container">
    ...
    <div class="col-sm-6 padd-0">
      ...
      <ul>
        ...
        <li class="myprofile">Machine Finance Request List</li>
			...
			<table id='' class="table table-striped table-hover">
				...
				<tbody>
						...
						if($FinanceReqList >0){ $i=1;
							...
							foreach($FinanceReqList  as $rowData){
							...
							<tr>
							  ...
							  elseif($rowData['request_status'] == 'C') { ?>Completed  <?php } 
                                 ...
                                 <td><?php if($rowData['request_status'] == 'QS'|| $rowData['request_status'] == 'C' || $rowData['request_status'] == 'R'){ ?>
									...
									<a href="<?=site_url()."customer/FinanceEstimate/".$rowData['mfr_id'];?>" class="btn btn-xs btn-primary"> View </a>

								<?php } else { ?>
							
								<a href="<?=site_url()."customer/FinanceEstimate/".$rowData['mfr_id'];?>" class="btn btn-xs btn-primary"> Finance Details </a>
								<?php } ?>
								</td> 
