											...
											<tr>
												...
												<td>
													<?php if($row['supplier_quote']){
														?>
													<a target="_blank" href="<?php echo site_url()."uploads/supplier_quote_on_demand_manufacturing/".$row['supplier_quote']?>" class="btn btn-xs btn-primary">View Quote </a>
													<?
														}
													?>
													
														<?	if($row['status'] == 'QS'){ ?>
													<a href="<?php echo site_url()."customer/acceptManufactringQuoteFromSupplier/".$row['id']?>" class="btn btn-xs btn-primary" onclick="return confirm('Are You Sure To Accept This Quote?')"> Accept Quote</a>
													<a href="<?php echo site_url()."customer/rejectManufactringQuoteFromSupplier/".$row['id']?>" class="btn btn-xs btn-primary" onclick="return confirm('Are You Sure To Reject This Quote?')" > Reject Quote</a>
												<?	} ?>
												</td>
