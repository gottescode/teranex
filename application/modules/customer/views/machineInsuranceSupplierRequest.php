  ...
  <div class="container">
    ...
    <div class="col-sm-6 padd-0">
      ...
      <ul>
        ...
        <li class="myprofile">Machine Insurnace Request List</li>
		...
		<div class="col-lg-10 col-md-9 col-sm-9 col-xs-12">  
			...
			<table id='' class="table table-striped table-hover">
				...
				<tbody>
						...
						if($InsuranceReqList >0){ $i=1;

							foreach($InsuranceReqList  as $rowData){
							...
							<tr>
							  ...
							  elseif($rowData['request_status'] == 'C') { ?>Completed  <?php } 
                                 ...
                                 <td><?php if($rowData['request_status'] == 'QS'|| $rowData['request_status'] == 'C' || $rowData['request_status'] == 'R'){ ?>

									<a href="<?=site_url()."customer/InsuranceEstimate/".$rowData['mir_id'];?>" class="btn btn-xs btn-primary"> View </a>

								<?php } else { ?>
							
								<a href="<?=site_url()."customer/InsuranceEstimate/".$rowData['mir_id'];?>" class="btn btn-xs btn-primary"> Insurnace Details </a>
								<?php } ?>
								</td> 
