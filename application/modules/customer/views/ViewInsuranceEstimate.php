                    ...
                    <form class="form" name="qoutationAdd" id="traineeAdd" method="post" action="" enctype="multipart/form-data">
                       ...
                       <!--  <div class="form-group">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control rounded-0" id="insurance_details" rows="6"readonly><?php echo $result['insurance_details']?></textarea> 
                            </div>
                        </div><div class="clearfix"></div><br/>
                       ...
                       <!--  <div class="form-group">
                        ...
                        <?php if(  $result['request_status']=='R' || $result['request_status']=='C'  ){ if ($result['request_status']=='C' ) {
                            echo '<center style="color:green;font-size:18px;border-style: ridge;width: 275px;text-align: center;margin-left: 31%;">'."Request Accepted".'</center>';
                        } else {echo '<center style="color:red;font-size:18px;border-style: ridge;width: 275px;text-align: center;margin-left: 31%;">'."Request Rejected".'</center>';}?>


                          <?php } else{ ?>
                           <center><a href="<?=site_url()."customer/InsuranceRequestAcceptBycustomer/$result[mir_id]"?>" class="btn btn-success">Accept</a>&nbsp;&nbsp;&nbsp;<a href="<?=site_url()."customer/InsuranceRequestRejectBycustomer/$result[mir_id]"?>" class="btn btn-success">Reject</a></center>
                        <?php } ?>
                        </div>
