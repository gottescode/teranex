				  ...
				  <div class="form-group"> 
					...
					<div class="text-center">
					 ...
					 <input type="submit" name="btnSubmit" value="Submit" class="btn btn-primary btn_orange">  
					  <input type="hidden" name="tech_req_id" value="<?php echo $id?>"  >  
					  <input type="hidden" name="created_by_user" value="<?php 
      echo  $userId = $this->session->userdata('uid');
?>"  >  
						<input type="hidden" name="customer_user_id" value="<?php echo $reqData['customer_user_id']?>"  >  

					  <input type="hidden" name="customer_user_name" value="<?php echo $reqData['customer_user_name']?>"  >  
		...
		?>
			...
			<table id='' class="table table-striped table-hover">
				...
				<tbody>
						...
						foreach($brainCertList['result']  as $rowData)

						{
							...
							<tr>
								...
								<td><a href="<?=site_url()."customer/tokboxLunchTechnicalService/".$rowData['id'];?>" target="_blank" class="btn btn-xs btn-primary"  >Launch</a></td>
