					...
					<tbody>
							...
							foreach($scheduleList  as $rowData)
							{
								...
								<tr>
									...
									<td>
										<a href="<?php echo $rowData['join_url'];?>" target="_blank" class="btn btn-xs btn-primary"  >Join</a>	
									</td>
									...
									?> 
										...
										<?php /* <a href="<?php echo site_url()."customer/tokboxLunch/".$rowData['id']?>" target="_blank" class="btn btn-xs btn-primary"  >Launch</a></td>} */
