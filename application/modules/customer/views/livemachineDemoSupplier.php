...
<div class="container-fluid myprofile-bg dahboard-bg">
  <div class="container">
    <div class="col-sm-4 padd-0">
      <ul>
        <li class="myprofile">Live Machine Demo Meeting List</li>
      </ul>
    </div>
    <div class="col-sm-8 padd-0">
  	<ul>
    	<li class="" style="float: right;margin: 6px 0;"><a href="<?php echo site_url()."customer/machineVideoEnquirySupplier";?>">Live Demo Request List </a></li>
  	</ul>
</div>
  </div>
  <!-- /.container --> 
