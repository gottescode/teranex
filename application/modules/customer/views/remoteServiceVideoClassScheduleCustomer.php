...
<div class="container-fluid myprofile-bg dahboard-bg">
  <div class="container">
    <div class="col-sm-4 padd-0">
      <ul>
        <li class="myprofile">Remote  Service  List</li>
      </ul>
    </div>
			...
			<?php }	?>
			 ...
			 <?php 
				...
				<table id='' class="table table-striped table-hover">
					<thead>
						<tr bgcolor="#CCCCCC"><td>S.No</td> <td>Start Date</td><td>Title</td><td>Start Time</td>  <td>End Time</td><td>Lunch</td></tr>
					</thead>
					<tbody>
							<?php
							$SNo = 1;
							foreach($scheduleList  as $rowData)
							{
								...
								<tr>
									...
									?> <a href="<?php echo site_url()."customer/tokboxLunchVideoRemoteService/".$rowData['id']?>" target="_blank"   >Lunch</a></td>
										<?php }?>
						</tr>
								<?
								$SNo ++;
