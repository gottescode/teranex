						...
						if($requestList >0){ $i=1;
							...
							<tr>
							  ...
							  elseif($rowData['request_status'] == 'C') { ?>Completed  <?php } 
								 ...
								 <td>
								 	<a href="<?=site_url()."customer/viewRapidRfqDetails/".$rowData['dmrID']?>" class="btn btn-xs btn-info" >RFQ Details</a>
                                   <?php
                                 $user_role=$this->session->userdata('user_role');
                                                                  
                                                                  if($rowData['RQ_Status'] == 'QS')
                                                                  {
                                                                 ?>
                                                              <a href="<?=site_url()."customer/viewSupplierRPQuotation/".$rowData['drrs_id']?>" class="btn btn-xs btn-info" >Requested Quotation</a> &nbsp; &nbsp;  
                                                              <?php } ?>
                                                             </td>
							</tr>
