...
<div class="container-fluid myprofile-bg dahboard-bg">
  <div class="container">
    ...
    <div class="col-sm-6 padd-0">
  	<ul>
    	<li class="" style="float: right;margin: 6px 0;"><a href="<?php echo site_url()."customer/training_request_supplier_onDemand"?>">Technical Service Request List </a></li>
  	</ul>
</div>
  </div>
  <!-- /.container --> 
							...
							if($consultReqList >0){ $i=1;
								...
								<tr>
									...
									<td>
										...
										<a href="<?=site_url()."customer/updateStatusTechnicalRequestEnggOnDemand/".$rowData['id'];?>" 	class="btn btn-xs btn-primary">Update Status</a>	
									</td>  
									<td>
									<a href="<?=site_url()."customer/scheduleListTechnicalRequestOnDemandEngg/".$rowData['id'];?>" class="btn btn-xs btn-primary">Schedule Meeting</a>	
