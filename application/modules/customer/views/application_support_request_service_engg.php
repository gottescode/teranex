...
<div class="container-fluid myprofile-bg dahboard-bg">
  <div class="container">
    <div class="col-sm-6 padd-0">
      <ul>
        <li class="myprofile">Application Support Request </li>
      </ul>
    </div>
    <div class="col-sm-6 padd-0">
  	<ul>
					...
					<tbody>
							...
							if($consultReqList >0){ $i=1;
							 ...
							 <p>Machine Model: <?=$rowData['model_name'];?></p></td>  
									...
									<a href="<?=site_url()."customer/updateStatusApplicationSupport/".$rowData['id'];?>" class="btn btn-xs btn-primary">Update Status</a>	
</td>									
									<td>   
									<a href="<?=site_url()."customer/scheduleListApplicationRequestEngg/".$rowData['id'];?>" class="btn btn-xs btn-primary">Schedule Meeting</a>
