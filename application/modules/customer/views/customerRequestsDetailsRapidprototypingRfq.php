  ...
  <div class="container">
    ...
    <div class="col-sm-6 padd-0">
      ...
      <ul>
        ...
        <li class="myprofile">Rapid Prototyping Supplier Details</li>
				...
				<h3>Part for RFQ:</h3>
					...
					<div class="form-group">
						...
						<?php   if( $result['supplier_id']!='0'){  }else{?>
							...
							<a class="btn btn-success" href="<?php echo site_url()."customer/customerRequestsRfqForRapidprototypingAccept/".$drrs_id; ?>" >Generate Quotation</a>

							<a class="btn btn-danger" href="<?php echo site_url()."customer/customerRequestsRfqForRapidprototypingReject/".$drrs_id; ?>" >Reject</a>
