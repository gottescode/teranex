			...
			<table id='' class="table table-striped table-hover">
				...
				<?php if($machineVideoRequestList){ 
						...
						foreach($machineVideoRequestList  as $rowData)
						{
							...
							<tr>
								<td><? echo $SNo;?></td>
								<td><p>Machine ID: <?=$rowData['machine_unique_id'];?></p>
								<p>Machine Category: <?=$rowData['category_name'];?></p>
								<p>Machine Brand: <?=$rowData['brand_name'];?></p>
								<p>Machine Model: <?=$rowData['model_name'];?></p></td>
								<td><? echo $rowData['UserName']; ?></td>
								<?php /* if($rowData['video_chat']=='V'){	echo " Video chat with a Teranex."; }
								...
								<td>
								<!-- 
										<a href="<?=site_url()."customer/MachineVideoClassSchedule/".$rowData['mvr_id'];?>" class="btn btn-xs btn-primary">Schedule Class</a>
								
								-->
										<a href="<?=site_url()."customer/MachineVideoClassScheduleMeeting/".$rowData['mvr_id'];?>" class="btn btn-xs btn-primary">Schedule Live Demo</a>
