...
// get chat list
    ...
    // get chat list
       ...
       public function findMultipleUsers_get() { 
     
            $response = [
                "result" => $this->customer_model->findMultipleUsers()
            ];
    ...
    /**
     * Additive Manufacturing RFQ Request Multiple
     * Deepak shinde 02-11-2018
     * @access public
     * @param  requestId
     * @return array of objects
     */
    public function ViewAdditiveRfqMultipleDetails_get($userId) {
        if (!(int) $userId) {
            $response = [
                "result" => false,
                "message" => "Insufficient information provided.",
            ...
            $response = [
                "result" => $this->customer_model->ViewAdditiveRfqMultipleDetails($userId),
            ];
        }
        $this->response($response, REST_Controller::HTTP_OK);
    }
     ...
     /**
     * Additive Manufacturing RFQ Details Sigle
     * Deepak Shinde 
     * @access public
     * @param  requestId
     * @return array of objects
     */
    public function viewAdditiveRfqDetails_get($dmrID) {
        if (!(int) $dmrID) {
            $response = [
                "result" => false,
                "message" => "Insufficient information provided.",
            ...
            $response = [
                "result" => $this->customer_model->viewAdditiveRfqDetails($dmrID),
            ];
        }
        $this->response($response, REST_Controller::HTTP_OK);
    }
    
      public function viewRemoteProgramRfqDetails_get($dmrID) {
        ...
        if (!(int) $dmrID) {
            ...
            $response = [
                "result" => $this->customer_model->viewRemoteProgramRfqDetails($dmrID),
            ];
        }
        $this->response($response, REST_Controller::HTTP_OK);
    }
    
    public function viewLaserPrcoessingRfqDetails_get($dmrID) {
        if (!(int) $dmrID) {
            $response = [
                "result" => false,
                "message" => "Insufficient information provided.",
            ...
            $response = [
                "result" => $this->customer_model->viewLaserPrcoessingRfqDetails($dmrID),
            ];
        }
        $this->response($response, REST_Controller::HTTP_OK);
    }
    ...
    public function customerRequestsRfqForLaserprocessingReject_get($drrs_id) {
     ...
     /**
     * Rapid RFQ Details Sigle
     * Deepak Shinde 
     * @access public
     * @param  requestId
     * @return array of objects
     */
    public function viewRapidRfqDetails_get($dmrID) {
        if (!(int) $dmrID) {
            $response = [
                "result" => false,
                "message" => "Insufficient information provided.",
            ...
            $response = [
                "result" => $this->customer_model->viewRapidRfqDetails($dmrID),
            ];
        }
        $this->response($response, REST_Controller::HTTP_OK);
    }
     ...
     * @return array of post data
     */
    public function machineServicesInsert_post() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $id = $this->customer_model->machineServicesInsert($data);
            if($id){
                $response = [ "result" => $id, "message" => "Machine Service has been inserted successfully..!!" ];
            } else {
                $response = [
                    "result" => false,
                    'message' => "Failed to insert record."
...
////////////////////// machine Brand ////////////////////
    ...
    public function findMultiplerfqlist_get($userId) { 
         ...
         if (!(int) $userId) {
            ...
            $response = [
                "result" => $this->customer_model->findMultiplerfqlist($userId),
            ];
        }
        $this->response($response, REST_Controller::HTTP_OK);
    }
    ...
    public function remoteapplication_rfq_delete_get($id) {
     ...
     /**
     * Remote application RFQ Details Single
     * Deepak Shinde 
     * @access public
     * @param  requestId
     * @return array of objects
     */
    public function viewRemoteApplicationRfqDetails_get($rprID) {
        if (!(int) $rprID) {
            $response = [
                "result" => false,
                "message" => "Insufficient information provided.",
            ...
            $response = [
                "result" => $this->customer_model->viewRemoteApplicationRfqDetails($rprID),
            ];
        }
        $this->response($response, REST_Controller::HTTP_OK);
    }
	...
	public function findMultipleUserList_get($id) {
			$strWhere=" user_type = 2";
			$response = [
                "result" => $this->customer_model->findMultiple($strWhere)
            ];
    ...
    public function MachinTimeStudyCustomerRequestList_get($id=0) { 
     
            $response = [
                "result" => $this->customer_model->MachinTimeStudyCustomerRequestList($id)
            ];
            
        $this->response($response, REST_Controller::HTTP_OK);
    }

     public function MachinTimeStudySupplierRequestList_get($id) { 
     

            if($id){
                $strWhere=" MTR.machine_id=MD.md_id And MD.created_by = $id ";
            }
            // get input data 
            $result = $this->customer_model->MachinTimeStudySupplierRequestList($strWhere);
            if($result){
                $response = [ "result" => $result  ];
            } else {
                $response = [
     ...
     * Time Study estimattion Insert
     * Deepak Shinde 12-11-2018
     * @access public
     * @return array of objects

     */
    public function TimeStudyEstimate_post() {

        $this->form_validation->set_rules('time', 'Time Required', 'trim|required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            // get input data
            $data = $this->post();
            $id = $this->customer_model->TimeStudyEstimate($data);
            if ($id) {
                $response = ["result" => $id, "message" => "Time study Estimation Submitted successfully."];
            } else {
                $response = [
                    "result" => false,
                    'message' => "Failed to Insert record."
     ...
     public function findSingle_machine_timestudy_estimate_details_get($mtr_id=0) { 
     
            $response = [
                "result" => $this->customer_model->findSingle_machine_timestudy_estimate_details($mtr_id)
            ];
    ...
    public function TimeStudyRequestAcceptBycustomer_get($mtr_id) {
        ...
        if( !(int)$mtr_id){
         ...
         $response = [
                "result" => $this->customer_model->TimeStudyRequestAcceptBycustomer($mtr_id),             
            ];
        }       
        $this->response($response, REST_Controller::HTTP_OK);   
    }
        // reject customer quotation
    public function TimeStudyRequestRejectBycustomer_get($mtr_id) {
        if( !(int)$mtr_id){
            $response = [
                "result" => false,
                "message" => "Insufficient information provided.",
            ...
            $response = [
                "result" => $this->customer_model->TimeStudyRequestRejectBycustomer($mtr_id),
            ];
        }       
        $this->response($response, REST_Controller::HTTP_OK);
    }

    /**** Finance Request Customer Dashboard*******/

       public function MachinFinanceCustomerRequestList_get($id=0) { 
     
            $response = [
                "result" => $this->customer_model->MachinFinanceCustomerRequestList($id)
            ];
            
        $this->response($response, REST_Controller::HTTP_OK);
    }
  
     public function MachinFinanceSupplierRequestList_get($id,$parentID) { 
     

            if($id){
                $strWhere=" MFR.machine_id=MD.md_id And MD.parent_id = $parentID ";
            }
            // get input data 
            $result = $this->customer_model->MachinFinanceSupplierRequestList($strWhere);
            if($result){
                $response = [ "result" => $result  ];
            } else {
                $response = [
     ...
     * Finance estimattion Insert
     * Deepak Shinde 14-11-2018
     * @access public
     * @return array of objects

     */
    public function FinanceEstimate_post() {

        $this->form_validation->set_rules('finance_details', 'Finance Details Required', 'trim|required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            // get input data
            $data = $this->post();
            $id = $this->customer_model->FinanceEstimate($data);
            if ($id) {
                $response = ["result" => $id, "message" => "Finance Estimation Submitted successfully."];
            } else {
                $response = [
                    "result" => false,
                    'message' => "Failed to Insert record."
     ...
     public function findSingle_machine_finance_estimate_details_get($mfr_id=0) { 
     
            $response = [
                "result" => $this->customer_model->findSingle_machine_finance_estimate_details($mfr_id)
            ];
            
        $this->response($response, REST_Controller::HTTP_OK);
    }

 public function findSingle_machine_details_get($mfr_id=0) { 
     
            $response = [
                "result" => $this->customer_model->findSingle_machine_details($mfr_id)
            ];
            
        $this->response($response, REST_Controller::HTTP_OK);
    }

    public function findSingle_machine_details_insurance_get($mir_id=0) { 
     
            $response = [
                "result" => $this->customer_model->findSingle_machine_details_insurance($mir_id)
            ];
     ...
     public function FinanceRequestAcceptBycustomer_get($mfr_id) {
        ...
        if( !(int)$mfr_id){
         ...
         $response = [
                "result" => $this->customer_model->FinanceRequestAcceptBycustomer($mfr_id),             
            ];
        }       
        $this->response($response, REST_Controller::HTTP_OK);   
    }
        // reject customer quotation
    public function FinanceRequestRejectBycustomer_get($mfr_id) {
        if( !(int)$mfr_id){
            $response = [
                "result" => false,
                "message" => "Insufficient information provided.",
            ...
            $response = [
                "result" => $this->customer_model->FinanceRequestRejectBycustomer($mfr_id),
            ];
        }       
        $this->response($response, REST_Controller::HTTP_OK);
    }
     ...
     /**** Insurance Request Customer Dashboard*******/

       public function MachinInsuranceCustomerRequestList_get($id=0) { 
     
            $response = [
                "result" => $this->customer_model->MachinInsuranceCustomerRequestList($id)
            ];
     ...
     public function MachinInsuranceSupplierRequestList_get($id,$parentID) { 
     

            if($id){
                $strWhere=" MIR.machine_id=MD.md_id And MD.parent_id = $parentID ";
            }
            // get input data 
            $result = $this->customer_model->MachinInsuranceSupplierRequestList($strWhere);
            if($result){
                $response = [ "result" => $result  ];
            } else {
                $response = [
     ...
     */
    public function InsuranceEstimate_post() {

        $this->form_validation->set_rules('insurance_details', 'Insurance Details Required', 'trim|required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            // get input data
            $data = $this->post();
            $id = $this->customer_model->InsuranceEstimate($data);
            if ($id) {
                $response = ["result" => $id, "message" => "Insurance Estimation Submitted successfully."];
            } else {
                $response = [
                    "result" => false,
                    'message' => "Failed to Insert record."
      ...
      public function findSingle_machine_insurance_estimate_details_get($mir_id=0) { 
     
            $response = [
                "result" => $this->customer_model->findSingle_machine_insurance_estimate_details($mir_id)
            ];
            
        $this->response($response, REST_Controller::HTTP_OK);
    }

      public function InsuranceRequestAcceptBycustomer_get($mir_id) {
        ...
        if( !(int)$mir_id){
         ...
         $response = [
                "result" => $this->customer_model->InsuranceRequestAcceptBycustomer($mir_id),             
            ];
        }       
        $this->response($response, REST_Controller::HTTP_OK);   
    }
        // reject customer quotation
    public function InsuranceRequestRejectBycustomer_get($mir_id) {
        if( !(int)$mir_id){
            $response = [
                "result" => false,
                "message" => "Insufficient information provided.",
            ...
            $response = [
                "result" => $this->customer_model->InsuranceRequestRejectBycustomer($mir_id),
            ];
        }       
        $this->response($response, REST_Controller::HTTP_OK);
    }
...
/* Supplier New machine */
	public function uploadQuote_post() {
        $this->form_validation->set_rules('id', ' Id Required', 'trim|required');
        if ($this->form_validation->run() == FALSE) {
            $response = [
                "result" => false,
            ...
            // get input data
            $data = $this->post();
            $page_id = $this->customer_model->uploadQuote($data);
            if ($page_id) {
                $response = ["result" => $page_id, "message" => "Quote Sent Successfully."];
            } else {
                $response = [
                    "result" => false,
                    'message' => "Failed to insert record."
	...
	public function uploadSoc_post() {
        $this->form_validation->set_rules('id', ' Id Required', 'trim|required');
        if ($this->form_validation->run() == FALSE) {
            $response = [
                "result" => false,
            ...
            // get input data
            $data = $this->post();
            $page_id = $this->customer_model->uploadSoc($data);
            if ($page_id) {
                $response = ["result" => $page_id, "message" => "Sales Order Confirmation Sent Successfully."];
            } else {
                $response = [
                    "result" => false,
                    'message' => "Failed to insert record."
	...
	public function uploadnda_post() {
        $this->form_validation->set_rules('id', ' Id Required', 'trim|required');
        if ($this->form_validation->run() == FALSE) {
            $response = [
                "result" => false,
            ...
            // get input data
            $data = $this->post();
            $page_id = $this->customer_model->uploadnda($data);
            if ($page_id) {
                $response = ["result" => $page_id, "message" => "Nda Uploaded Successfully."];
            } else {
                $response = [
                    "result" => false,
                    'message' => "Failed to insert record."
	...
	public function uploadpurchaseorder_post() {
        $this->form_validation->set_rules('id', ' Id Required', 'trim|required');
        if ($this->form_validation->run() == FALSE) {
            $response = [
                "result" => false,
            ...
            // get input data
            $data = $this->post();
            $page_id = $this->customer_model->uploadpurchaseorder($data);
            if ($page_id) {
                $response = ["result" => $page_id, "message" => "Purchase Order added Successfully..!!"];
            } else {
                $response = [
                    "result" => false,
                    'message' => "Failed to insert record."
	...
	public function warrentyDetails_post() {
        $this->form_validation->set_rules('id', ' Id Required', 'trim|required');
        if ($this->form_validation->run() == FALSE) {
            $response = [
                "result" => false,
            ...
            // get input data
            $data = $this->post();
            $page_id = $this->customer_model->warrentyDetails($data);
            if ($page_id) {
                $response = ["result" => $page_id, "message" => "Warrenty Details updated Successfully."];
            } else {
                $response = [
                    "result" => false,
                    'message' => "Failed to insert record."
	...
	public function uploadOffer_post() {
        $this->form_validation->set_rules('id', ' Id Required', 'trim|required');
        if ($this->form_validation->run() == FALSE) {
            $response = [
                "result" => false,
            ...
            // get input data
            $data = $this->post();
            $page_id = $this->customer_model->uploadOffer($data);
            if ($page_id) {
                $response = ["result" => $page_id, "message" => "Record inserted successfully."];
            } else {
                $response = [
	...
	public function supplierListOrder_get($id, $strWhere = 1) {
        if (!(int) $id) {
            ...
            $strWhere .= " AND mo.supplier_id = $id ";

            $response = [
                "result" => $this->customer_model->supplierListOrder($strWhere)
            ];
        }
		$this->response($response, REST_Controller::HTTP_OK);
    }
	
	public function customerListOrder_get($id, $strWhere = 1) {
        if (!(int) $id) {
            ...
            $strWhere .= " AND mo.customer_id = $id ";

            $response = [
                "result" => $this->customer_model->customerListOrder($strWhere)
            ];
        }
		$this->response($response, REST_Controller::HTTP_OK);
    }
	public function orderSingleDetails_get($id, $strWhere = 1) {
        if (!(int) $id) {
            ...
            $strWhere .= " AND mo.id = $id ";

            $response = [
                "result" => $this->customer_model->orderSingleDetails($strWhere)
            ];
        }
		$this->response($response, REST_Controller::HTTP_OK);
    }
	
	public function orderSingleOfferDetails_get($id, $strWhere = 1) {
        if (!(int) $id) {
            ...
            $strWhere .= " AND order_id = $id ";

            $response = [
                "result" => $this->customer_model->orderSingleOfferDetails($strWhere)
            ];
        }
		$this->response($response, REST_Controller::HTTP_OK);
    }
	...
	public function trainingRequestServices_get($id = 0) {
        ...
        if ($id != 0) {
            ...
            $strWhere .= " AND tsr.service_engg_id = '{$id}' "; 
            $strWhere .= " AND tsr.machine_status = 'S' ";
        }

        $response = [
            "result" => $this->customer_model->trainingRequestServices($strWhere)
        ];
	...
	public function trainingRequestWarrenty_get($id = 0) {
        ...
        if ($id != 0) {
            ...
            $strWhere .= " AND tsr.service_engg_id = '{$id}' ";
			   $strWhere .= " AND tsr.machine_status = 'W' ";
        }
	...
	public function trainingRequestOndemand_get($id = 0) {
        ...
        if ($id != 0) {
            ...
            $strWhere .= " AND tsr.service_engg_id = '{$id}' ";
			   $strWhere .= " AND tsr.machine_status = 'O' ";
        }
	...
	public function applicationRequestServices_get($id = 0) {
        ...
        if ($id != 0) {
            ...
            $strWhere .= " AND tsr.engg_id = '{$id}' ";
        }

        $response = [
            "result" => $this->customer_model->applicationRequestServices($strWhere)
        ];
	...
	public function applicationSupportclassScheduleListConsultant_get($app_req_id) {
        ...
        if (!(int) $app_req_id) {
            ...
            $response = [
                "result" => $this->customer_model->applicationSupportclassScheduleListConsultant($app_req_id),
            ];
        }

        $this->response($response, REST_Controller::HTTP_OK);
    }
	public function techncialSupportclassScheduleListConsultant_get($tech_req_id) {
        ...
        if (!(int) $tech_req_id) {
            ...
            $response = [
                "result" => $this->customer_model->techncialSupportclassScheduleListConsultant($tech_req_id),
            ];
        }

        $this->response($response, REST_Controller::HTTP_OK);
    }
	public function liveMachineDemoclassScheduleListConsultant_get($mvr_id) {
        ...
        if (!(int) $mvr_id) {
            ...
            $response = [
                "result" => $this->customer_model->liveMachineDemoclassScheduleListConsultant($mvr_id),
            ];
        }

        $this->response($response, REST_Controller::HTTP_OK);
    }
	public function zoomResponseInsertApplicationSupport_post() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $page_id = $this->customer_model->zoomResponseInsertApplicationSupport($data);
	...
	public function zoomResponseInsertTechSupport_post() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $page_id = $this->customer_model->zoomResponseInsertTechSupport($data);
	...
	public function zoomResponseInsertMachineLiveDemo_post() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $page_id = $this->customer_model->zoomResponseInsertMachineLiveDemo($data);
	...
	public function requestTrainingRequest_post() {



        $data = $this->post();

        $result = $this->customer_model->requestTrainingRequest($data);
    ...
    public function requestTrainingUpdate_post() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $result = $this->customer_model->requestTrainingUpdate($data);
	...
	public function technicalServicestokboxList_get($tech_req_id) {



        $response = [
            "result" => $this->customer_model->technicalServicestokboxList($tech_req_id)
        ];
	...
	public function technicalServiceClassScheduleFetchSingle_get($id) {
        ...
        if (!(int) $id) {
            ...
            $response = [
                "result" => $this->customer_model->technicalServiceClassScheduleFetchSingle($id),
            ];
        }
	...
	public function freelancerRequestServices_get($id = 0) {
        ...
        if ($id != 0) {
            ...
            $strWhere .= " AND tsr.freelancer_id = '{$id}' ";
        }

        $response = [
            "result" => $this->customer_model->freelancerRequestServices($strWhere)
        ];
	...
	public function freelancerSupportclassScheduleListConsultant_get($free_req_id) {
        ...
        if (!(int) $free_req_id) {
            ...
            $response = [
                "result" => $this->customer_model->freelancerSupportclassScheduleListConsultant($free_req_id),
            ];
        }
	...
	public function zoomResponseInsertFreelancer_post() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $page_id = $this->customer_model->zoomResponseInsertFreelancer($data);
	...
	public function freelancertokboxList_get($free_req_id) {



        $response = [
            "result" => $this->customer_model->freelancertokboxList($free_req_id)
        ];
	...
	public function requestFreelancerRequest_post() {



        $data = $this->post();

        $result = $this->customer_model->requestFreelancerRequest($data);
	...
	public function freelancerClassScheduleFetchSingle_get($id) {
        ...
        if (!(int) $id) {
            ...
            $response = [
                "result" => $this->customer_model->freelancerClassScheduleFetchSingle($id),
            ];
        }
    ...
    public function requestFreelanceUpdate_post() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $result = $this->customer_model->requestFreelanceUpdate($data);
...
/* MAchine Order Sale */
    public function saleMachineToCustomer_post() {



        $this->form_validation->set_rules('machine_id', 'Machine Id Required', 'trim|required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $page_id = $this->customer_model->saleMachineToCustomer($data);
	...
	/* NEW API's May19 */
	public function machinTimeStudyCList_get($id=0) { 
     
            $response = [
                "result" => $this->customer_model->machinTimeStudyCList($id)
            ];
            
        $this->response($response, REST_Controller::HTTP_OK);
    }
	public function machinTimeStudySList_get($id=0) { 
     
            $response = [
                "result" => $this->customer_model->machinTimeStudySList($id)
            ];
            
        $this->response($response, REST_Controller::HTTP_OK);
    }
	public function machinTimeStudyRequestDetails_get($id=0) { 
	...
	public function sendQuoteToCustomer_post() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = $this->post();
            $page_id = $this->customer_model->sendQuoteToCustomer($data);
            if ($page_id) {
	...
	public function acceptQuote_post() {
        $this->form_validation->set_rules('rfq_id', 'rfq_id Required', 'trim|required');
        if ($this->form_validation->run() == FALSE) {
            $response = [
                "result" => false,
            ...
            $data = $this->post();
            $page_id = $this->customer_model->acceptQuote($data);
            if ($page_id) {
	...
	public function machinFinanceCList_get($id=0) { 
     
            $response = [
                "result" => $this->customer_model->machinFinanceCList($id)
            ];
            
        $this->response($response, REST_Controller::HTTP_OK);
    }
	public function machineFinanceSList_get($id=0) { 
     
            $response = [
                "result" => $this->customer_model->machineFinanceSList($id)
            ];
            
        $this->response($response, REST_Controller::HTTP_OK);
    }
	public function machinFinanceRequestDetails_get($id=0) { 
	...
	public function sendFinanceQuoteToCustomer_post() {
        $this->form_validation->set_rules('rfq_id', 'rfq_id Required', 'trim|required');
        if ($this->form_validation->run() == FALSE) {
            $response = [
                "result" => false,
            ...
            $data = $this->post();
            $page_id = $this->customer_model->sendFinanceQuoteToCustomer($data);
            if ($page_id) {
	...
	public function acceptQuoteFinance_post() {
        $this->form_validation->set_rules('rfq_id', 'rfq_id Required', 'trim|required');
        if ($this->form_validation->run() == FALSE) {
            $response = [
                "result" => false,
            ...
            $data = $this->post();
            $page_id = $this->customer_model->acceptQuoteFinance($data);
            if ($page_id) {
