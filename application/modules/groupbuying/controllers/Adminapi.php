...
/* Offer Creation */
	public function createConsumableOffer_post() {
        ...
        $this->form_validation->set_rules('cons_type_id', 'Type Required', 'trim|required');
		 ...
		 if ($this->form_validation->run() == FALSE) {
			...
			$page_id = $this->groupbuying_model->createConsumableOffer($data);
			if($page_id){
				$response = [ "result" => $page_id, "message" => "Record inserted successfully." ];
			} else {
				$response = [
	...
	public function createServicePartOffer_post() {
        ...
        $this->form_validation->set_rules('service_type_id', 'servicepart_brand Required', 'trim|required');
		 ...
		 if ($this->form_validation->run() == FALSE) {
			...
			$page_id = $this->groupbuying_model->createServicePartOffer($data);
			if($page_id){
				$response = [ "result" => $page_id, "message" => "Record inserted successfully." ];
			} else {
				$response = [
	...
	public function createSheetMetalOffer_post() {
        ...
        $this->form_validation->set_rules('sheet_type_id', 'Sheet Type Required', 'trim|required');
		 ...
		 if ($this->form_validation->run() == FALSE) {
			...
			$page_id = $this->groupbuying_model->createSheetMetalOffer($data);
			if($page_id){
				$response = [ "result" => $page_id, "message" => "Record inserted successfully." ];
			} else {
				$response = [
