			...
			<div class="box">
				<div class="box-body"> 
					<div class="box-header">
					  ...
					  <a href="<?php echo site_url()."groupbuying/sheetmetal/"?>" class="pull-right btn btn-xs btn-warning">Back</a>
		            </div>
					<div class="border_bot"> 
						...
						<div>
							...
							<h3 class = "text-center">Total Quantity: <?php echo $sum;?></h3>
							 <form class="form-horizontal" name="" id="adminRfq" method="post" enctype="multipart/form-data" action="<?php echo site_url()."groupbuying/sheetmetal/assignSupplierForRequest"?>" >
								<div class="form-group">
									<input type="hidden" id="rfq_ids" name="rfq_ids" class="" placeholder="" value="<?php echo $rfq_ids; ?>">
									<input type="hidden" id="sheet_quantity" name="sheet_quantity" class="" placeholder="" value="<?php echo $sum;?>">
								</div>
								<div class="form-group">
									<label class="control-label col-sm-4" for="Sheet MetalName">RFQ Title: </label>
									<div class="col-sm-4">
										<input type="text" id="title" name="title" class="form-control" placeholder="" value="">
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-4" for="Sheet MetalName">Sheet Metal Name: </label>
									<div class="col-sm-4">
										<input type="text" id="Sheet Metal_name" name="sheet_metal_name" class="form-control" placeholder="" value="<?php echo $row['sheetmetal_name']; ?>">
									</div>
								</div>
								  <div class="clearfix"></div>
