					...
					<form id="" name="" action= "<?php echo site_url()."groupbuying/serviceparts/createAdminRfq"; ?>"class="form-horizontal" enctype="multipart/form-data" method="post">
						<div class="table-responsive">
							<table class="table table-bordered table-striped" id="product_table">
								...
								<tbody>
								<?php if($servicepartsCustrequestList){ $i=1;
									foreach($servicepartsCustrequestList as $row){
									...
									<tr>
										...
										?>
											<span class="pull-right-container">
											<a href="<?=site_url()."groupbuying/serviceparts/adminRfqList"?>"><small class="label pull-right bg-green">RFQ Generated</small></a>
										</span>
										<?
