	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box">
				...
				<div class="box-body"> 
					<form id="" name="" class="form-horizontal" enctype="multipart/form-data" method="post" action= "<?php echo site_url()."groupbuying/consumable/assignSupplierForRequest"?>">
						...
						<input type="hidden" name="cons_quantity" value="<?php echo $cons_quantity; ?>">
						<input type="hidden" name="consumable_name" value="<?php echo $consumable_name; ?>">
