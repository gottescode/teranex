...
<!-- Content Header (Page header) -->
	<section class="content-header">
	  ...
	  <ol class="breadcrumb">
		...
		<li class="active">Automation Comment List</li>
	  </ol>
	</section>
 	<!-- Main content -->
	<section class="content">
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					<div class="box-body">  
						 <?php if($automationCommentReplyList){
					foreach($automationCommentReplyList as $rowreply){
					
					$url = site_url()."automation/api/automationCommentReplyFileList/".$rowreply['arcid'];; 
							...
							<?php if($commentReplyFileList['result']){
								foreach($commentReplyFileList['result'] as $rowName){ 
									...
									if(in_array($extnFile[1],$imgArray)){
									  echo "<img src='".site_url()."uploads/automation_reply/".$rowName['file_name']."' width='100px'>";
									}else{
							...
							<?php }
								if($docFile>0){
									...
									for($i=0;$i< count($docFile);$i++){ 
										echo "<a href='".site_url()."uploads/automation_reply/".$docFile[$i]."'  target='_blank'>File Attachment</a> &nbsp; &nbsp;";
									}
								} 
							}?>
						</div>
					...
					<form class="form-horizontal" role="form" action="" id="automation_form" method="post" enctype="multipart/form-data">
						<fieldset> 
