...
<div class=" sec-marketplace padd_30" style="margin-top: 0;padding: 16px 0;">
	...
	<center class="pad-0-0-10" style="margin-bottom: 0px;">
		<h1 style="margin-top: 0px;margin-bottom: 10px;"> Machine Market</h1>
		<ul class="feature" style="margin-bottom: 0;"><li>Live Machine Sales</li><li>|</li><li>Live Machine Demo</li><li>|</li><li>Time Study</li><li>|</li><li>Software</li><li>|</li><li>Finance</li><li>|</li><li>Remote Services</li><li>|</li><li>Trade Services</li></ul>
	</center>
	<div class="container" style="margin-bottom: 20px;">
		<div class="col-sm-12" style="position: relative;" >
			<div class="col-sm-3 col-xs-12 padd-0" >
				...
				<center>
					<div class="row">
						<h2 style="font-size: 28px;margin-bottom: 23px;">Collaborate</h2>
					</div>
				</center>
			...
			<div class="col-sm-3 col-xs-12 padd-0" >
				<div class="ico-tiles">
					...
					<center>
					  <div class="row">
						  <h2 style="font-size: 28px;margin-bottom: 23px;">Source</h2>
						</div>
					</center>
					<div class="col-sm-12" style="border-right: 1px solid #e2e2e2;">
						<div class="col-sm-12 col-xs-12 padd-0">
			...
			<div class="col-sm-3 col-xs-12 padd-0" >
				<div class="ico-tiles">
					<center>
					  <div class="row">
					        <h2 style="font-size: 28px;margin-bottom: 23px;">Connect</h2>
					    </div>
					</center>
					<div class="col-sm-12" style="border-right: 1px solid #e2e2e2;">
					   	<div class="col-sm-12 col-xs-12 padd-0">
			...
			<div class="col-sm-3 col-xs-12 padd-0">
				<div class="ico-tiles">
					<center>
					  <div class="row">
					        <h2 style="font-size: 28px;margin-bottom: 23px;">Know</h2>
					    </div>
					</center>
					<div class="col-sm-12">
					   	<div class="col-sm-12 col-xs-12 padd-0">
	...
	<div data-sw-dms-panel-container class="sw-dms-panel-container sw--text-white sw-grid-flex sw-grid-flex__cell-3-4 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-3-4--mob-landscape sw-grid-flex--wrap--mob sw-grid-flex--wrap--tab sw-dms-flex--nowrap--mob-landscape sw--position-relative" style="width: 100%;">
		...
		<div data-sw-dms-panel="sell" class="sw-dms-panel sw-dms-panel--tab-xl sw-dms-panel--mob-tab sw-dms-panel--mob-xs sw-sell-panel sw-sell-panel--mob-tab sw-grid-flex__cell-1-3 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-1-3--mob-landscape sw--position-relative factory_sell" id="">
			...
			<div class="sw-dms-panel__inner-div sw-dms-panel__inner-div--tab sw-dms-panel__inner-div--mob sw--position-absolute sw--padding-hor-7">
				...
				<a data-creator-choice-button="/img/rrstatic/sell.img" class="sw--uppercase sw--hide-mobile sw--hide-tablet sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-bottom-5 btn btn_orange" href="<?php echo site_url();?>remotetraining/online_courses">Learn A Technology</a><div class="clearfix"></div>
				<p class="sw--margin-top-1 sw-dms-panel__inner-div__main-text sw-dms-panel__inner-div__main-text--tab sw-dms-panel__inner-div__main-text--mob-tab" style="color: #fff;">Learn how to build a machine and manufacture products.</p>
		...
		<div data-sw-dms-panel="design" class="sw-dms-panel sw-dms-panel--tab-xl sw-dms-panel--mob-tab sw-dms-panel--mob-xs sw-design-panel sw-design-panel--mob-tab sw-grid-flex__cell-1-3 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-1-3--mob-landscape sw--position-relative factory_design" id="">
			...
			<div class="sw-dms-panel__inner-div sw-dms-panel__inner-div--tab sw-dms-panel__inner-div--mob sw--position-absolute sw--padding-hor-7">
				...
				<a data-creator-choice-button="/img/rrstatic/sell.img" class="sw--uppercase sw--hide-mobile sw--hide-tablet sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-bottom-5 btn btn_orange" href="<?php echo site_url();?>remoteprogramming">Start A Project</a><div class="clearfix"></div>
				...
				<!-- <a data-creator-choice-button="/img/rrstatic/design.img" class="sw--uppercase sw--hide-mobile sw--hide-tablet sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-bottom-5 btn btn_orange" href="<?php echo site_url();?>pages/efactory_design">Start A Project</a><div class="clearfix"></div> --><!-- <?php echo site_url()."remotetraining/online_courses";?> -->
				<p class="sw--margin-top-1 sw-dms-panel__inner-div__main-text sw-dms-panel__inner-div__main-text--tab sw-dms-panel__inner-div__main-text--mob-tab" style="color: #fff;">
					Work with a skilled product designer to turn your ideas into real products. We can start from scratch or evolve a product for on-going fabrication.
				</p>
...
<!-- 
		<div data-sw-dms-panel="sell" class="sw-dms-panel sw-dms-panel--tab-xl sw-dms-panel--mob-tab sw-dms-panel--mob-xs sw-sell-panel sw-sell-panel--mob-tab sw-grid-flex__cell-1-3 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-1-3--mob-landscape sw--position-relative factory_sell" id="">
			<div class="sw-sell-panel__bg macademy_sw-sell-panel__bg sw-bg-panel sw-bg-panel--mob-tab"></div>
			<div class="sw-dms-panel__inner-div sw-dms-panel__inner-div--tab sw-dms-panel__inner-div--mob sw--position-absolute sw--padding-hor-7">
				<h2 class="sw--margin-bottom-1 sw-dms-panel-header sw-dms-panel-header--big sw-dms__text--responsive sw-dms__text--responsive-small sw-dms-panel-header--mob sw-dms-panel-headerâ-tab sw--font-family-sharp-grotesque" style="color: #fff;">Program</h2>
				<p class="sw--font-size-18 sw-dms-panel-sub-header sw-dms-panel-sub-headerâ-tab sw-dms-panel-sub-header--mob sw--margin-bottom-7" style="color: #fff;">Offload your programming<br>to our experts.</p>
				<a data-creator-choice-button="/img/rrstatic/sell.img" class="sw--uppercase sw--hide-mobile sw--hide-tablet sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-bottom-5 btn btn_orange" href="<?php echo site_url();?>remoteprogramming">Request A Program 	</a><div class="clearfix"></div>
				<p class="sw--margin-top-1 sw-dms-panel__inner-div__main-text sw-dms-panel__inner-div__main-text--tab sw-dms-panel__inner-div__main-text--mob-tab" style="color: #fff;">At Stelmac, we provide live online consulting for business development etc.</p>
		-->		<!-- <a data-creator-choice-button="/img/rrstatic/sell.img" class="sw--uppercase sw--hide-desktop sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-top-5 btn btn_orange" href="<?php echo site_url();?>remotetraining/online_courses">START A PROJECT</a> -->
	<!--		</div>
		</div>-->
		<div data-sw-dms-panel="make" class="sw-dms-panel sw-dms-panel--tab-xl sw-dms-panel--mob-tab sw-dms-panel--mob-xs sw-make-panel sw-make-panel--mob-tab sw-grid-flex__cell-1-3 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-1-3--mob-landscape sw--position-relative factory_make" id="">
			...
			<div class="sw-dms-panel__inner-div sw-dms-panel__inner-div--tab sw-dms-panel__inner-div--mob sw--position-absolute sw--padding-hor-7">
				...
				<p class="sw--font-size-18 sw-dms-panel-sub-header sw-dms-panel-sub-headerâ-tab sw-dms-panel-sub-header--mob sw--margin-bottom-7" style="color: #fff;">Industrial production scaled<br>for you from one to many.</p>
				<a data-creator-choice-button="/img/rrstatic/make.img" class="sw--uppercase sw--hide-mobile sw--hide-tablet sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-bottom-5 btn btn_orange" href="<?php echo site_url();?>digitalmanufacturing/" target="">Make A Product</a><div class="clearfix"></div>
...
<div class="clearfix"></div>
<style> .counter_mainrow{text-align:center; }
...
<div class="counter_mainrow" style="">
  	<center>
		<h1 style="text-transform: inherit; margin: 18px;">Our Presence</h1>
	</center>
