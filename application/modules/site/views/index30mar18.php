  ...
  <div class="container-fluid padd-0">
        <div class="col-sm-12 row-flex padd-0">
          ...
          <div class="col-sm-3 col-xs-12 padd-0 " style="min-height: 370px;">
            <img src="<?php echo $theme_url?>/images/eacademy.jpg" class="img-responsive "/>
            <div style="padding: 10px 30px;">
                <h2 style="text-transform: initial; font-size: 20px;">TeraneX eAcademy</h2>
          ...
          <div class="col-sm-3 col-xs-12 padd-0 " style=" background-color: #f9f9f9;min-height: 370px;">
            <img src="<?php echo $theme_url?>/images/Capture9.jpg" class="img-responsive"/>
            <div style="padding:10px 30px;">
                <h2 style="font-size: 20px;">Digital Manufacturing</h2>
...
<section>
  <div class="container-fluid padd-0">
    <div class="col-sm-6 padd-0">
      <div class="col-sm-6 padd-0 company">
        <img src="<?php echo $theme_url?>/images/Capture9.jpg" class="img-responsive"/>
          <div class="link1" style="padding: 10px 30px 0px 30px;">
      ...
      <div class="col-sm-6 padd-0 partners">
        <img src="<?php echo $theme_url?>/images/Capture92.jpg" class="img-responsive"/>
        <div class="link1" style="padding: 10px 30px 0px 30px;">
                    ...
                    <div class="item next left">
                      <div class="col-sm-12 row-flex padd-0">
                        <div class="col-sm-6" style="padding: 0 5%;">
                          <h2 style="padding-top: 20%;font-size: 20px;">Testimonials</h2>
                          <p style="font-size: 16px;"> Blechexpo exhibition will be held from 7th to 10th November 2017 in Stuttgart, Germany.
                          </p>
