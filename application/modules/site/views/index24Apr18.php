...
<div class="row">
  <div class="col-sm-6 col-xs-6">
    <a href="<?php echo site_url()."machine"?>">
	  <div>
  ...
  <div class="col-sm-6 col-xs-6">
    <a href="http://192.168.0.108/teranex/ecommerce/product-category/spare-parts/">
	  <div>
...
<div class="row">
  <div class="col-sm-6 col-xs-6">
    <a href="http://192.168.0.108/teranex/ecommerce/product-category/toolings/">
	  <div>
  ...
  <div class="col-sm-6 col-xs-6">
    <a href="http://192.168.0.108/teranex/ecommerce/product-category/software/">
	  <div>
...
<div class="row">
  <div class="col-sm-6 col-xs-6">
   <!-- <a href="<?php echo site_url()."consultant"?>" class="Toolings">
		...
		<a href="<?php echo site_url()."eacademy"?>" >
	  <div>
...
<section>
  <div class="container padd-0 mar-20-0">
           ...
           <h1 class="text-center mar-0-0-10">Community</h1>
		   <div class="row">
          <div class="col-sm-3 col-xs-12">
			<div class="gray-bg1">
             <img src="<?php echo $theme_url?>/images/1.jpg" class="img-responsive">
			 <h2 class="text-center h2-tag">User communities</h2>
			</div>
          </div>
          <div class="col-sm-3 col-xs-12">
			<div class="gray-bg1">
             <img src="<?php echo $theme_url?>/images/33.jpg" class="img-responsive">
			 <h2 class="text-center h2-tag">buyer groups</h2>
			</div>
          </div>
          <div class="col-sm-3 col-xs-12">
			<div class="gray-bg1">
             <img src="<?php echo $theme_url?>/images/4.jpg" class="img-responsive">
		  ...
		  <a href="<?php echo site_url()."mediacenter";?>" target="_blank">
			<div class="gray-bg1">
			 ...
			 <h2 class="text-center h2-tag">Industry news</h2>
			</div>
		  </a>
          </div>
        </div>
