	...
	<div class="col-sm-12" style="position: relative;" >
		<div class="col-sm-3 col-xs-12" style="border-right: 1px solid #ccc;">
			...
			<center>
				<div class="row">
					<h2> Collaboration</h2>
					<p class="marketPlace-heading" style="opacity: 1;font-size: 14px;">Connect with a vast network</p>
				</div>
			</center>
				<div class="">
		...
		<div class="col-sm-3 col-xs-12" style="border-right: 1px solid #ccc;">
			<div class="ico-tiles">
				...
				<center>
				  <div class="row">
					  <h2> Machines</h2>
						<p class="marketPlace-heading" style="opacity: 1;font-size: 14px;">Browse through an exhaustive range</p>
					</div>
				</center>
				<div class="">
					<div class="col-sm-12 col-xs-12">
			...
			<div class="ico-tiles">
				<center>
				  <div class="row">
				        ...
				        <p class="marketPlace-heading" style="opacity: 1;font-size: 14px;">Leverage our range of remote services</p>
				    </div>
				</center>
				<div class="">
				   	<div class="col-sm-12 col-xs-12">
