...
<div class="section container-fluid padd-0"  style="background-image: url('<?php echo $theme_url?>/images/consumables.jpg');background-repeat: no-repeat;background-size: 100% 100%;height: 450px;">
    <div class="slider" slide-interval="3000" style="height: 450px;">
	...
	<div data-sw-dms-panel-container class="sw-dms-panel-container sw--text-white sw-grid-flex sw-grid-flex__cell-3-4 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-3-4--mob-landscape sw-grid-flex--wrap--mob sw-grid-flex--wrap--tab sw-dms-flex--nowrap--mob-landscape sw--position-relative" style="width: 100%;">
		...
		<div data-sw-dms-panel="sell" class="sw-dms-panel sw-dms-panel--tab-xl sw-dms-panel--mob-tab sw-dms-panel--mob-xs sw-sell-panel sw-sell-panel--mob-tab sw-grid-flex__cell-1-3 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-1-3--mob-landscape sw--position-relative factory_sell" id="">
			...
			<div class="sw-dms-panel__inner-div sw-dms-panel__inner-div--tab sw-dms-panel__inner-div--mob sw--position-absolute sw--padding-hor-7">
				...
				<div class="col-sm-6">
					<a data-creator-choice-button="/img/rrstatic/sell.img" class="sw--uppercase sw--hide-mobile sw--hide-tablet sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-bottom-5 btn btn_orange" href="<?php echo site_url();?>remotetraining/online_courses">Learn A Technology <!-- <span><i class="fa fa-chevron-right" aria-hidden="true"></i></span> --></a>
				</div><div class="clearfix"></div>
		...
		<div data-sw-dms-panel="design" class="sw-dms-panel sw-dms-panel--tab-xl sw-dms-panel--mob-tab sw-dms-panel--mob-xs sw-design-panel sw-design-panel--mob-tab sw-grid-flex__cell-1-3 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-1-3--mob-landscape sw--position-relative factory_design" id="">
			...
			<div class="sw-dms-panel__inner-div sw-dms-panel__inner-div--tab sw-dms-panel__inner-div--mob sw--position-absolute sw--padding-hor-7">
				...
				<div class="col-sm-6">
					<a data-creator-choice-button="/img/rrstatic/design.img" class="sw--uppercase sw--hide-mobile sw--hide-tablet sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-bottom-5 btn btn_orange" href="<?php echo site_url();?>pages/efactory_design">Start A Project</a>
				</div><div class="clearfix"></div>
		...
		<div data-sw-dms-panel="make" class="sw-dms-panel sw-dms-panel--tab-xl sw-dms-panel--mob-tab sw-dms-panel--mob-xs sw-make-panel sw-make-panel--mob-tab sw-grid-flex__cell-1-3 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-1-3--mob-landscape sw--position-relative factory_make" id="">
			...
			<div class="sw-dms-panel__inner-div sw-dms-panel__inner-div--tab sw-dms-panel__inner-div--mob sw--position-absolute sw--padding-hor-7">
				...
				<div class="col-sm-6">
					<a data-creator-choice-button="/img/rrstatic/make.img" class="sw--uppercase sw--hide-mobile sw--hide-tablet sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-bottom-5 btn btn_orange" href="<?php echo site_url();?>digitalmanufacturing/" target="">Make A Product</a>
				</div><div class="clearfix"></div>
...
<div class=" sec-marketplace padd_30" style="margin-top: 0;padding: 20px 0;">
	...
	<center class="pad-0-0-10" style="margin-bottom: 15px;">
		<h1 style="margin-top: 0px;margin-bottom: 15px;">The Machine Market</h1>
		...
		<div class="col-sm-12" style="position: relative;" >
			...
			<div class="col-sm-3 col-xs-12 padd-0">
				<div class="ico-tiles">
					<center>
					  <div class="row">
					        <h2 style="font-size: 28px;">Trust</h2>
					    </div>
					</center>
					<div class="col-sm-12">
					   	<div class="col-sm-12 col-xs-12 padd-0">
					  	...
					  	<div class="col-sm-12 col-xs-12 padd-0">
							<a target="" href="<?php echo site_url();?>pages/tradeServices">
							  	<div>
									<img src="<?php echo $theme_url?>/images/icons/sell.png">
							  	</div>
								   	<h3> Trade Services</h3>
								   	<p>Stelmac focuses on creating a relationship of trust between the buyer & seller & strives to establish a safe & secure environment. <!-- to conduct business on a single integrated platform -->
								   	<br/><span style="">More >></span></p>
							</a>
					  	</div>
					  	<div class="col-sm-12 col-xs-12 padd-0" style="margin-bottom: 0;">
							<a target="" href="<?php echo site_url();?>pages/customerServices">
							  	<div>
									<img src="<?php echo $theme_url?>/images/icons/24-hours.png">
							  	</div>
								   	<h3> Customer Services</h3>
								   	<p>Avail our 24*7 customer service via chat, phone or email. 
								   	<br/><span style="">More >></span></p>
							</a>
					  	</div>
					</div>
...
<style type="text/css">
	...
	@media (min-width: 768px) /*and (min-width: 320px)*/ and (orientation: portrait){
	...
	<div data-sw-dms-panel-container class="sw-dms-panel-container sw--text-white sw-grid-flex sw-grid-flex__cell-3-4 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-3-4--mob-landscape sw-grid-flex--wrap--mob sw-grid-flex--wrap--tab sw-dms-flex--nowrap--mob-landscape sw--position-relative" style="width: 100%;">
		...
		<div data-sw-dms-panel="design" class="sw-dms-panel sw-dms-panel--tab-xl sw-dms-panel--mob-tab sw-dms-panel--mob-xs sw-design-panel sw-design-panel--mob-tab sw-grid-flex__cell-1-3 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-1-3--mob-landscape sw--position-relative factory_design" id="">
			...
			<div class="sw-dms-panel__inner-div sw-dms-panel__inner-div--tab sw-dms-panel__inner-div--mob sw--position-absolute sw--padding-hor-7">
				<h2 class="sw--margin-bottom-1 sw-dms-panel-header sw-dms__text--responsive sw-dms__text--responsive-small sw-dms-panel-header--big sw-dms-panel-header--mob sw-dms-panel-headerâ-tab sw--font-family-sharp-grotesque" style="color: #fff;">Design</h2>
				<p class="sw--font-size-18 sw-dms-panel-sub-header sw-dms-panel-sub-headerâ-tab sw-dms-panel-sub-header--mob sw--margin-bottom-7" style="color: #fff;">Design your product<br> with us.</p>
				<a data-creator-choice-button="/img/rrstatic/design.img" class="sw--uppercase sw--hide-mobile sw--hide-tablet sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-bottom-5 btn btn_orange" href="<?php echo site_url();?>pages/efactory_design">Start A Project</a><div class="clearfix"></div>
				<p class="sw--margin-top-1 sw-dms-panel__inner-div__main-text sw-dms-panel__inner-div__main-text--tab sw-dms-panel__inner-div__main-text--mob-tab" style="color: #fff;">
					Work with a skilled product designer to turn your ideas into real products. We can start from scratch or evolve a product for on-going fabrication.
				</p>
			</div>
