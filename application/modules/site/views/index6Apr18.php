...
/*testimonial*/
.testimonial{background:#fff; padding-bottom:30px;}
...
.soc-media_footer i:hover.fa{color:#fff!important;}

.soc-media i.fa, .soc-media_footer i.fa{
    font-size: 30px;
    margin: 0 10px;
	cursor:pointer;
}

.soc-media i.fa.fa-facebook, .soc-media_footer i.fa.fa-facebook {
    color: #3b5998;
}

.soc-media i.fa.fa-twitter, .soc-media_footer i.fa.fa-twitter {
    color: #00aced;
}

.soc-media i.fa.fa-linkedin, .soc-media_footer i.fa.fa-linkedin {
    color: #007bb6;
}

.soc-media i.fa.fa-youtube, .soc-media_footer i.fa.fa-youtube {
    color: #dd4b39;
}
.soc-media i.fa.fa-rss, .soc-media_footer i.fa.fa-rss {
    color: #ff6501;
}
.h2-tag{    
	line-height: normal;    
        ...
        <div class="slider" slide-interval="30000">
            <div class="slide active">
                ...
                <div class="slide-text">
                    <h1>TERANEX, your intelligent assistant for all machine needs </h1>
                   <!-- <p>For your page</p> -->
                </div>
            </div>
  ...
  <div class="container padd-0 mar-30-0">
          ...
          <div class="col-sm-12 col-xs-12 padd-0">
			...
			<div class="sec-img-heading">
				...
				<a class="btn-default"> See More</a>
				</div>
			</div>
          </div>
    </div>
...
<section>
    <div class="container padd-0">
        <div class="col-sm-12 padd-0">
           <h1>market intelligence & consulting</h1>
		   <div class="row">
          <div class="col-sm-4 col-xs-12">
			<div class="gray-bg1">
          ...
          <div class="col-sm-4 col-xs-12">
			<div class="gray-bg1">
             <img src="<?php echo $theme_url?>/images/research.jpg" class="img-responsive">
