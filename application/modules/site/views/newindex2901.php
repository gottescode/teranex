	...
	<div class="container" style="margin-bottom: 15px;">
		<div class="col-sm-12" style="position: relative;" >
			<div class="col-sm-4 col-xs-12 padd-0" >
				...
				<center>
					<div class="row">
						<h2 style="font-size: 28px; margin-bottom: 26px;">Buy</h2>
					</div>
				</center>
				...
				<div class="col-sm-12 col-xs-12 padd-0" >
							...
							<a target="" href="<?php echo site_url();?>remoteprogramming">
								...
								<!-- 
								   	...
								   	<h3>Cloud programming</h3>
								-->
								   	<h3>Machine-on-Rent</h3>
...
<style type="text/css">
	...
	.sw-dms-panel-container-bg__make.macademy_sw-dms-panel-container-bg__make {
	    /* background-image: url('<?php echo $theme_url?>/images/factory-make1-min-dark.png'); */
	    /* background-image: url('<?php echo $theme_url?>/images/Depositphotos_163540240_l-2015.jpg');  */
	     background-image: url('<?php echo $theme_url?>/images/courses_broad.jpg'); 
	    height: 100%;
	    width: 100%;
	    background-size: cover;
	    position: absolute;
	...
	.sw-dms-panel-container-bg__sell.macademy_sw-dms-panel-container-bg__sell {
	    ...
	    /* background-image: url('<?php echo $theme_url?>/images/newEventBroad.jpg'); */
	    background-image: url('<?php echo $theme_url?>/images/Depositphotos_48396683_s-2015.jpg');
	    height: 100%;
	    width: 100%;
	    background-size: cover;
	    position: absolute;
	...
	.sw-make-panel__bg.macademy_sw-make-panel__bg {
	    ...
	    /* background-image: url('<?php echo $theme_url?>/images/onlinecourse-macademy-minNew.jpg'); */
	     background-image: url('<?php echo $theme_url?>/images/course_small.jpg');
	    -webkit-transition: opacity 0.9s ease-in-out;
	    transition: opacity 0.9s ease-in-out;
	}
...
<div>
	<center>
		<h1 style="margin: 18px 0;text-transform: inherit;margin-top:18px; ">Teranex Learning Platform</h1>
		<!--<ul class="feature" style="margin-bottom: 24px;"><li> 
		
		Design Your ProductUpload Your Drawings</li><li>|</li><li> Create Your Program </li><li>|</li><li>Make Your Product</li></ul>-->
	</center>
</div>
...
<div class="sw-dms-section sw-grid-flex sw--width-full sw-grid-flex--wrap--mob sw-grid-flex--wrap--tab sw-dms-flex--nowrap--mob-landscape text-white">
	<div data-sw-dms-panel-container class="sw-dms-panel-container sw--text-white sw-grid-flex sw-grid-flex__cell-3-4 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-3-4--mob-landscape sw-grid-flex--wrap--mob sw-grid-flex--wrap--tab sw-dms-flex--nowrap--mob-landscape sw--position-relative" style="width: 100%;">
		...
		<div data-sw-dms-panel="sell" class="sw-dms-panel sw-dms-panel--tab-xl sw-dms-panel--mob-tab sw-dms-panel--mob-xs sw-sell-panel sw-sell-panel--mob-tab sw-grid-flex__cell-1-3 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-1-3--mob-landscape sw--position-relative factory_sell" id="">
			...
			<div class="sw-dms-panel__inner-div sw-dms-panel__inner-div--tab sw-dms-panel__inner-div--mob sw--position-absolute sw--padding-hor-7">
				<h2 class="sw--margin-bottom-1 sw-dms-panel-header sw-dms-panel-header--big sw-dms__text--responsive sw-dms__text--responsive-small sw-dms-panel-header--mob sw-dms-panel-headerâ-tab sw--font-family-sharp-grotesque" style="color: #fff;">Live Events</h2>
				<p class="sw--font-size-18 sw-dms-panel-sub-header sw-dms-panel-sub-headerâ-tab sw-dms-panel-sub-header--mob sw--margin-bottom-7" style="color: #fff;">To attend panel discussions,<br>product launches & webinars within manufacturing industry.</p>
				<a data-creator-choice-button="/img/rrstatic/sell.img" class="sw--uppercase sw--hide-mobile sw--hide-tablet sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-bottom-5 btn btn_orange" href="<?php echo site_url();?>events">Events</a><div class="clearfix"></div>
				<p class="sw--margin-top-1 sw-dms-panel__inner-div__main-text sw-dms-panel__inner-div__main-text--tab sw-dms-panel__inner-div__main-text--mob-tab" style="color: #fff;">To attend panel discussions,product launches & webinars within manufacturing industry.</p>
		...
		<div data-sw-dms-panel="make" class="sw-dms-panel sw-dms-panel--tab-xl sw-dms-panel--mob-tab sw-dms-panel--mob-xs sw-make-panel sw-make-panel--mob-tab sw-grid-flex__cell-1-3 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-1-3--mob-landscape sw--position-relative factory_make" id="">
			...
			<div class="sw-dms-panel__inner-div sw-dms-panel__inner-div--tab sw-dms-panel__inner-div--mob sw--position-absolute sw--padding-hor-7">
				<h2 class="sw--margin-bottom-1 sw-dms-panel-header sw-dms-panel-header--big sw-dms__text--responsive sw-dms__text--responsive-small sw-dms-panel-header--mob sw-dms-panel-headerâ-tab sw--font-family-sharp-grotesque" style="color: #fff;">Training Courses</h2>
				<p class="sw--font-size-18 sw-dms-panel-sub-header sw-dms-panel-sub-headerâ-tab sw-dms-panel-sub-header--mob sw--margin-bottom-7" style="color: #fff;">Avail remote training services for the <br>products purchased on Stelmac.</p>
				<a data-creator-choice-button="/img/rrstatic/make.img" class="sw--uppercase sw--hide-mobile sw--hide-tablet sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-bottom-5 btn btn_orange" href="<?php echo site_url();?>remotetraining/online_courses/" target="">Courses</a><div class="clearfix"></div>
			<!-- 	<p class="sw--margin-top-1 sw-dms-panel__inner-div__main-text sw-dms-panel__inner-div__main-text--tab sw-dms-panel__inner-div__main-text--mob-tab" style="color: #fff;">We manufacture high-quality, affordable products in 40 of the best materials and finishes, from plastics to metals. Upload for an instant quote or contact us to co-develop a solution for unique products.</p>				-->
				<p class="sw--margin-top-1 sw-dms-panel__inner-div__main-text sw-dms-panel__inner-div__main-text--tab sw-dms-panel__inner-div__main-text--mob-tab" style="color: #fff;">Avail remote training services for the <br>products purchased on Stelmac.</p>				
