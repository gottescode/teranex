        ...
        <div class="slider" slide-interval="30000">
            ...
            <div class="slide">
                <div class="slide-img" img-src="<?php echo $theme_url?>/images/used-machines.jpg"></div>
                 <!-- <div class="substrate"></div> -->
				 <div class="substrate1"></div>
				 <div class="substrate"></div>
                <div class="slide-text1">
                    <h1>TERANEX,</br> we match solutions to</br>our customer needs</h1>
					<h2>
						<span class="header-span">
							<span><span class="circle"> </span> fundamental research<span><br/>
							<span><span class="circle"> </span> actionable analytics</span><br/>
            ...
            <div class="slide">
                ...
                <div class="slide-text2">
                   <!--   <h1>TERANEX, a one stop for all your machine needs </h1> -->
					<h1>TERANEX,</br>an eco-system for all</br>your manufacturing needs</h1>
                </div>
                <div class="slide-text">
                   <!--   <h1>TERANEX, a one stop for all your machine needs </h1> -->
                   <h2>
