    ...
    <div class="slider" slide-interval="30000">
        <div class="slide active">
			...
			<div class="slide-text2 typewriter">
				<div class="container">
					<h1 class="typewriter1">TERANEX, an intelligent assistant</h1>
					<h1 class="typewriter2">for all your machine needs</h1>
					<h2>
        ...
        <div class="slide">
			...
			<div class="slide-text2 typewriter">
				<div class="container">
					<h1 class="typewriter1">At TERANEX, we match solutions </h1>
					<h1 class="typewriter2">to our customer needs</h1>
					<h2>
						<span class="header-span">
			...
			<div class="slide-text2 typewriter">
				<div class="container">
				   <!--   <h1>TERANEX, a one stop for all your machine needs </h1> -->
					<h1 class="typewriter1">TERANEX, an eco-system</h1>
					<h1 class="typewriter2">for all your manufacturing needs</h1>
					<h2>
						<span class="header-span">
...
<div class=" sec-marketplace padd_30" style="margin-top: 0;padding-top: 20px;">
	...
	<center class="pad-0-0-10" style="margin-bottom: 18px;">
		<h1 style="margin-top: 0px;">Explore the Marketplace for Machines</h1>
...
<section class="other-section other-section-10 elearning dark" style="background: #f9f9f9;">
