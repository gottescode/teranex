...
.scrolled .navbar-form .form-control {
    color: #7f7f7f;
}
  ...
  <div class="container-fluid padd-0">
        <div class="col-sm-12 row-flex padd-0">
		  ...
		  <!--<div class="social-sec">
			<a><span><i class="fa fa-facebook-square social-i" aria-hidden="true"></i></span></a><br/>
			<a><span><i class="fa fa-twitter-square social-i" aria-hidden="true"></i></span></a><br/>
			<a><span><i class="fa fa-linkedin-square social-i" aria-hidden="true"></i></span></a><br/>
			<a><span><i class="fa fa-youtube-square social-i" aria-hidden="true"></i></span></a><br/>
		 </div> -->
            <h1 style="text-align: right;">teraneX media</h1>
            <a style="color:#ff8a43;float: right;">See more  &nbsp;&nbsp;<span><i class="fa fa-arrow-right"></i></span></a>
          </div>
          
          <div class="col-sm-8 col-xs-12 padd-0">
...
<div class="col-sm-4">
	<h1 class="counter-value" data-count="6000">0</h1>
	<h3 class="text-center">No. of users</h3>
</div>
<div class="col-sm-4">
	<h1 class="counter-value" data-count="100">0</h1>
	<h3 class="text-center">% of industry participation</h3>
</div>
<div class="col-sm-4">
	<h1 class="counter-value" data-count="9999">1</h1>
