...
<div class=" sec-marketplace padd_30" style="margin-top: 0;padding: 20px 0;">
	...
	<div class="col-sm-12" style="position: relative;" >
		<div class="col-sm-3 col-xs-12" style="border-right: 1px solid #ccc;">
			<div class="ico-tiles">
			<center>
				<div class="row">
					<h2 style="font-size: 28px;">Collaboration</h2>
				        ...
				        <a target="_blank" href="javascript:void(0)">
						  	<div>
								<img src="<?php echo $theme_url?>/css/marketplace/exchange-groups.png">
					           	...
					           	<p>Benefit from a virtual warehouse of spare parts, trade excess capacities & share.</p>
				        </a>
					</div>
				</div>
			</div>
		...
		<div class="col-sm-3 col-xs-12" style="border-right: 1px solid #ccc;">
			<div class="ico-tiles">
				...
				<center>
				  <div class="row">
					  <h2 style="font-size: 28px;"> Machines</h2>
		...
		<div class="col-sm-3 col-xs-12" style="border-right: 1px solid #ccc;">
			<div class="ico-tiles">
				<center>
				  <div class="row">
				        <h2 style="font-size: 28px;">Remote Services</h2>
						...
						<a target="_blank" href="<?php echo site_url();?>remotetraining">
						  	<div>
								<img src="<?php echo $theme_url?>/css/marketplace/eacadmy.png">
							   	...
							   	<p>We can provide remote training services for the products. </p>
						</a>
				  	</div>
					 <!-- <div class="col-sm-6 col-xs-12">
		...
		<div class="col-sm-3 col-xs-12" style="">
			<div class="ico-tiles">
				<center>
				  <div class="row">
				        <h2 style="font-size: 28px;">Trade Services</h2>
				       <!--  <p class="marketPlace-heading">Leverage our range of remote services</p> -->
				    </div>
				</center>
				<div class="">
