	...
	<div class=" padd-0 paralax-section1 " style="background-image: url('<? echo $theme_url?>/images/market_int_bck.jpg');height: 100%;width: 100%;background-size: cover;">
		<div style="width: 100%;background-color: #000000ad">
			<div class="col-sm-12" style="padding: 30px 0;">
				<center>
					<h1 class="white-text">TERANEX Fabrication Services</h1>
...
<section>
	<div class="container">
		<center><h2>TERANEX Online Fabrication Services</h2>
		<p>At TERANEX, we provide manufacturing solutions in the fields of machine tools, laser technology and electronics</p></center>
		<center><h2></h2></center>
