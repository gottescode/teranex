...
/*testimonial*/
.testimonial{background:#fff; padding-bottom:38px;}
...
<div class="section container padd-0" style="margin-top: 68px;">
        <div class="slider" slide-interval="30000">
            <div class="slide active">
                ...
                <div class="slide-text">
                    <h1>TeraneX, an AI driven intelligent assistant for all your machine needs </h1>
                   <!-- <p>For your page</p> -->
                </div>
            </div>
          ...
          <div class="slide">
            ...
            <div class="slide">
                <div class="slide-img" img-src="<?php echo $theme_url?>/images/bending-machines.jpg"></div>
                 <!-- <div class="substrate"></div> -->
				 <div class="substrate"></div>
                <div class="slide-text">
...
<section style="">
<div class="container" style="background: #f9f9f9; padding-bottom: 20px;">
...
<div class="row">
  <div class="col-sm-6 col-xs-6">
    <a href="<?php echo site_url()."consultant/remoteapp_service"?>" class="Digital">
...
<div class="row">
  ...
  <div class="col-sm-6 col-xs-6">
    <a href="<?php echo site_url()."events"?>" class="Software">
...
<section>
  <div class="container padd-0">
        <div class="col-sm-12 row-flex padd-0 sec-container">
          ...
          <div class="col-sm-6 col-xs-12 padd-0">
            <img style="height:307px; width:100%;" src="<?php echo $theme_url?>/images/dig-mfg1.png" class="img-responsive">
			<h1 class="text-heading">digital manufacturing</h1>
          </div>
        </div>
    </div>
</section>
  ...
  <div class="container padd-0">
        <div class="col-sm-12 row-flex padd-0 sec-container">
          <div class="col-sm-6 col-xs-12 padd-0">
			...
			<h1 class="text-heading">TERANEX Media</h1>
          </div>
          <div class="col-sm-6 col-xs-12 sec-text-bg">
           <h1 class="h1tag">inside TERANEX media</h1>
          </div>
        </div>
    </div>
</section>
<section>
    <div class="container padd-0">
        <div class="col-sm-12 row-flex padd-0 sec-container">
          <div class="col-sm-6 col-xs-12 sec-text-bg">
           <h1 class="h1tag">inside TERANEX market intelligent & consulting</h1>
          </div>
          <div class="col-sm-6 col-xs-12 padd-0">
             <img style="height:307px; width:100%;" src="<?php echo $theme_url?>/images/partners.jpg" class="img-responsive">
			<h1 class="text-heading">market intelligent & consulting</h1>
          </div>
        </div>
    </div>
</section>
