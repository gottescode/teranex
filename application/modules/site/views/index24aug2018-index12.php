...
h1.swapheading{
	...
	/*color: #fff;*/
	font-family: 'SharpGrotesk-Thin25' !important;
}
</style>
<div style="background:#f9f9f9 ;padding-top: 10px;">
	<center>
		<h1 class="swapheading" style="">On-Demand eFactory</h1>

		<ul class="feature" style="margin-bottom: 20px;"><li style="">Learn To Build Products. Start Manufacturing. Build Your Business.</li></ul>
	</center>
</div>
