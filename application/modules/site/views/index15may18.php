...
<div class="container" style="background: #f9f9f9; padding-bottom: 20px;  position:relative;  margin-top: 30px;">
	...
	<div class="col-sm-4 col-xs-12">
		<div class="ico-tiles">
			<div class="row">
			  <div class="col-sm-offset-1 col-sm-8 col-xs-12" style="opacity: 0;">
				<a target="_blank" href="<?php echo site_url();?>machine">
					<div>
						<img src="<?php echo $theme_url?>/css/marketplace/machine.png">
					</div>
					<h3>Machines</h3>
					<p style="display:block;">Used machines are a cost effective way to enter the industry.</p>
				</a>
			  </div>
			</div>
			<div class="row">
	...
	<div class="linearrow">
		<img src="<?php echo $theme_url?>/images/return-arrow3.png" />
	</div>
	<div class="col-sm-4 col-xs-12">
		<div class="ico-tiles">
			<div class="row">
			...
			<div class="row">
			  ...
			  <div class="col-sm-4 col-xs-12">
				<div class="gray-bg1">
				 ...
				 <h2 class="text-center h2-tag">Machine Analytics</h2>
				 </a>
				</div>
			  </div>
			</div>
...
<section>
    <div class="container padd-0">
        <div class="col-sm-12 padd-0">
           <h1 class="text-center">Collaboration Services</h1>
			<div class="row">
			  <div class="col-sm-4 col-xs-12">
				<div class="gray-bg1">
			  ...
			  <div class="col-sm-4 col-xs-12">
				<div class="gray-bg1">
				 <a target="_blank" href="<?php echo site_url();?>pages/commingsoon">
				 <img src="<?php echo $theme_url?>/images/12435.jpg" class="img-responsive">
				 <h2 class="text-center h2-tag"></h2>
				 </a>
				</div>
			  </div>
			</div>
