...
.counterbg{ background-image: url('<?php echo $theme_url?>/images/3dprinting2.jpg');
    height: 100%;
    width: 100%;
    ...
    <div class="slider" slide-interval="3000">
        <div class="slide active">
			...
			<div class="slide-text2 typewriter">
				<div class="container">
					<h1 class="typewriter1">TERANEX, an intelligent assistant for all your machine needs</h1>
					<h2>
						<span class="item-1">
					...
					<div class="index_search">
						<form class="navbar-form menu-ico-mar">
	                        <div class="form-group" style="margin-bottom:0px;">
	                           <input type="text" class="form-control form-control-ser" placeholder="Search" style="background: #fff;" />
	...
	<div class="col-sm-12" style="position: relative;" >
		...
		<div class="col-sm-4 col-xs-12" style="border-left: 1px solid #333;border-right: 1px solid #333;">
			...
			<div class="ico-tiles">
				...
				<div class="row">
				  <div class="col-sm-6 col-xs-12">
					<a target="_blank" href="https://teranex.co/ecommerce/product-category/toolings/">
					  <div>
				  ...
				  <div class="col-sm-6 col-xs-12">
					<a target="_blank" href="https://teranex.co/ecommerce/product-category/spare-parts/">
					  <div>
        ...
        <p class="marketPlace-heading">Get inspired to build your business</p>
			...
			<div class="ico-tiles">
				<div class="row">
				 ...
				 <!-- <div class="col-sm-6 col-xs-12">
				    <a target="_blank" href="<?php echo site_url();?>stelmac/contact_manufacturing">
					  <div>
			...
			<div class="col-sm-12" style="padding-top: 15px;">
				...
				<div>
					<ul class="tab-widget icon-tab tab-pd">
						...
						<li><a target="_blank" href="<?php echo site_url();?>snapshot/" data-tb="#service-tab-2" class="flex-cc">
							<i class="fa fa-line-chart" aria-hidden="true"></i></a>
							<h3 class="fs16 bold-2 mr-t-10">Snapshot</h3>
						</li>
						<li><i class="fa fa-plus fa-lg" aria-hidden="true"></i></li>
						<li>
						...
						<li><i class="fa fa-plus fa-lg" aria-hidden="true"></i></li>
						<li>
							<a target="_blank" href="https://teranex.co/mediacenter" data-tb="#service-tab-4" class="flex-cc">
...
<section class="counterbg">
	<div class=" padd-0" style="width: 100%;background-color: #00000085; height: 388px; position: relative;">
	<h1 style="position: absolute;right: 6%;color: #fff;top: 20%;font-size: 60px;">Inside TERANEX <br/>Digital Manufacturing</h1>
	<span style="position: absolute;right: 36px;color: #fff;bottom: 26%;font-size: 28px;width: 42%;text-align: left;">
		<span class="circleDM" style="margin: 0; margin-bottom: 5px; margin-right: 10px;"></span> Virtual <span class="circleDM"></span> On-Demand <span class="circleDM"></span> Convenient
	</span>
 <!-- <img style=" width:100%;" src="<?php echo $theme_url?>/images/3dprinting.jpg" class="img-responsive">
