...
<section class="content-header">
  <span style="font-size: 24px;padding: 10px;">Group Buying Suppliers List</span>
						...
						<div class="table-responsive">
							<table class="table table-bordered table-striped" id="product_table">
								...
								?>
											...
											<?php if($rowData['request_status'] === 'R'){ ?>
									    ...
									    <?php	} ?>
									    <?php if($rowData['request_status'] === 'A'){ ?>
									    <td><a href="<?php echo site_url()."groupbuying/admin/viewGroupBuyingSupplierQoute/$rowData[gsr_id]"?>" class="btn btn-xs btn-primary">View Quotation</a></td>
									    <?php	} ?>
											</tr>
									<?php }
