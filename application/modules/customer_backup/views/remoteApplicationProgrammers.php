						...
						if($requestList >0){ $i=1;
							...
							<tr>
								...
								<td> 
									...
									<a href="<?=site_url()."customer/remoteApplicationServiceProgrammers/".$rowData['rpr_id']?>" class="btn btn-xs btn-success" >Programmer List</a> &nbsp; &nbsp;  
										
									<?php  }else if($rowData['programmer_id']>'0'){
										
										?>
										<a href="<?php echo site_url()."customer/scheduleListRemoteProgramming/".$rowData['rpr_id']?>"class="btn btn-xs btn-primary">Meeting List</a>
										<?
									} 
									?>
								</td> 
