	...
	<div class="bg_white">
		<div class="col-md-10 col-sm-12 col-xs-12">  
			<table id='' class="table table-striped table-hover">
				...
				<tbody> 
				<?php if($remoteappVideoRequestList){ 
						$SNo = 1;
						foreach($remoteappVideoRequestList  as $rowData)
						{
							?>
							<tr>
								<td><? echo $SNo;?></td>
								...
								<td><a href="<?php echo site_url()."customer/remoteappVideoClassScheduleCustomer/".$rowData['ravr_id']?>" class="btn btn-xs btn-info" >Course List</a></td> 
							</tr>
							<?
							$SNo ++;
						}
