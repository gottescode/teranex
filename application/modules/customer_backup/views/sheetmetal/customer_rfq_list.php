...
<div class="container-fluid myprofile-bg dahboard-bg">
    <div class="container">
        <div class="col-sm-4 padd-0">
            <ul>
                <li class="myprofile">Sheet Metal List</li>
            </ul>
        </div>
                    ...
                    <tbody>
						...
						if($rfqData['result']){ $i=1;
                                ...
                                <td>
									...
									<a href="<?php echo site_url() ?>customer/groupbuying/quoatationDetailsSheetMetal/<?=$row['id']; ?>" class= "btn btn-xs" >Quotation</a> 	
									<? } ?>&nbsp; &nbsp; 
