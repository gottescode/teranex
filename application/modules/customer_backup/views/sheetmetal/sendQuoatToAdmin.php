...
<div class="container-fluid myprofile-bg dahboard-bg">
  <div class="container">
    <div class="col-sm-4 padd-0">
      <ul>
        <li class="myprofile">Send Quotation</li>
      </ul>
    </div>
      	...
      	<div class="border_bot col-sm-offset-3 col-md-4 col-sm-4 col-xs-12 supplier-form" style="background-color: #fff;padding:40px 40px;box-shadow: 0px 0px 10px #dfdcdc;"> 
      		<form class="form" name="sendQuotation" id="sendQuotation" method="post" action="">
      			<div class="form-group">
      				<input type="text" class="form_bor_bot" id="supplier_amount" name="supplier_amount" placeholder="Enter Final Amount" value=""  /><span class="compulsary">*</span>
      			</div><div class="clearfix"></div>
      		
      			<div class="form-group">
      			   <center><input type="submit" name="btnSubmit" id="submit" class="btn btn_orange" value="Submit" /></center>
