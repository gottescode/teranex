                ...
                <table id='' class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        foreach ($rfqData['result'] as $row) {
                            ...
                            <tr>
                                <td><? echo $SNo;?></td>
                                <td><? echo $custData['sheetmetal_name'];?></td> 
                                <td><? echo $custData['sheetmetal_category'];?></td> 
                                <td><? echo $custData['sheetmetal_type'];?></td> 
                                <td><? echo $custData['sheetmetal_brand'];?></td> 
                                <td><? echo $custData['sheetmetal_thickness'];?></td> 
                                <td><? echo $custData['sheetmetal_size'];?></td> 
                                <td><? echo $row['sheet_quantity'];?></td> 
                                ...
                                <td>
									...
									<a href="<?php echo site_url() ?>customer/groupbuying/sendQuoatationToAdminSheetMetal/<?=$row['sup_id']; ?>" class= "btn btn-xs" >Send Quotation</a> 	
									<? } ?>&nbsp; &nbsp; 
