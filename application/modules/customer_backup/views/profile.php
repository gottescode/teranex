    ...
    <div class="container">
        ...
        <div class="col-sm-4 padd-0">
            ...
            <ul>
                ...
                <li class="myprofile">Welcome <? echo ucwords($_SESSION['u_name']);?></li>

            </ul>

        </div>
        <div class="col-sm-8 padd-0">
            <ul style="float: right;margin: 10px 0;">
                <li class="" style="display: inline-block;"><a href="<?php echo site_url(); ?>">Go To My Stelmac </a> |</li>
                <li style="display: inline-block;"><a href="<?php echo site_url() . "customer/profile_edit"; ?>"><span><i class="fa fa-pencil"></i></span> Edit Profile</a></li>
            </ul>
        </div>
...
<div class="welcome-j-bg">
    <div class="container">
        <!-- <div class="col-sm-12 padd-0">
            <div class="col-sm-6 col-lg-6 padd-0">
              <ul class="pull-left">
                        ...
                        <div class="profile-left">
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <?php if ($customer_data['u_date_birth'] == '00-00-0000') { ?>
                                            <label class="contact-label-text"style="padding: 0;"></label>
                                        <?php } else { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <label class="contact-label-text"style="padding: 0;"> <?php
