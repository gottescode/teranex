			...
			<div class="border_bot col-sm-offset-3 col-md-4 col-sm-4 col-xs-12" style="background-color: #fff;padding:40px 40px;box-shadow: 0px 0px 10px #dfdcdc;">  
					...
					<form class="form" name="qoutationAdd" id="qoutationAdd" method="post" action="" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input type="text" class="form_bor_bot" id="course_date" name="course_date" placeholder="Course Date"  value="<?php echo $result['course_date']?>" /><span class="compulsary">*</span>

						</div>

						<div class="form-group">

							<input type="text" class="form_bor_bot" id="course_time" name="course_time" placeholder="Course Time"   value="<?php echo $result['course_time']?>"/>
