										...
										<?php 
											if($event_list >0){ $i=1;
												...
												<tr>
													...
													<td><a href="<?=site_url()."events/admin/updateEvent/".$rowData['event_id']?>" aria-haspopup="true" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp; &nbsp;
														<a onclick="return confirm('Are You Sure To Delete This Entry?')"  href="<?=site_url()."events/admin/deleteEvent/$eid/".$rowData['event_id']?>" aria-haspopup="true" title="Delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a>&nbsp; &nbsp;
											...
											<tr><td colspan="9"><center><input  type='submit' class="btn btn-primary pull-right" name='btnSubmit' value='Update'></center></td></tr>
									</table>  
								</div>
							</form>
						</div>
