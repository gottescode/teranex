		  	...
		  	<div class=" report_cat_details">
			    <div id="" class="">
			      	<div class="gray_bg">
			      		...
			      		<h3 class="padd_5"><?php echo $single_category_details['analytics_category_name'] ?></h3>
			      			
			      	</div>
			      	<p><?php echo strhtmldecode($single_category_details['analytics_category_description']) ?></p>
					<h4>Reports</h4>


					<ul class="all_report">
						<?php// print_r($analytics_list);exit; ?>
        ...
        <div class="modal-body">
          	<div class="border_bot col-xs-12 " > 
	      		<form class="form" name="call_request" id="call_request" method="post" action="" novalidate="novalidate">
	             	...
	             	<div class="form-group">
	      				<input type="text" class="form_bor_bot alphaSpace" id="job_title" name="job_title" placeholder="Job Title" value=""><span class="compulsary">*</span>
	              	</div>
	              	<div class="form-group">
