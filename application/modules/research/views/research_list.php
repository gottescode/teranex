		  	...
		  	<div class=" report_cat_details">
			    <div id="" class="">
					...
					foreach($category_list as $rowCat){
						//print_r($category_list);exit;
					?>
									<!--<p><a href="<?php echo site_url()."research/research_list/$rowCat[report_category_id]/".formaturl($rowCat['report_category_name'])?>"> &nbsp;</a><?php echo $rowCat['report_category_name'] ?></a></p>
									<?php }} ?>-->
								</div>
							</div>
						</li>
