			...
			<div class="col-sm-12" style="padding: 30px 0;">
				...
				<div>
					<ul class="tab-widget icon-tab tab-pd">
						...
						<li>
							<a target="_blank" href="<?php echo site_url()."analytics";?>" data-tb="#service-tab-2" class="flex-cc">
							<i class="fa fa-line-chart" aria-hidden="true"></i></a>
							<h3 class="fs16 bold-2 mr-t-10">Monitoring</h3>
						</li>
						<li><i class="fa fa-plus fa-lg" aria-hidden="true"></i></li>
						<!-- <li>
						...
						<li><i class="fa fa-plus fa-lg" aria-hidden="true"></i></li> -->
						<li>
							<a target="_blank" href="<?php echo site_url()."events";?>" data-tb="#service-tab-5" class="flex-cc">
							<i class="fa fa-calendar" aria-hidden="true"></i></a>
							<h3 class="fs16 bold-2 mr-t-10">Events</h3>
						</li>
						<li><i class="fa fa-plus fa-lg" aria-hidden="true"></i></li>
						<li>
							<a target="_blank" href="<?php echo site_url()."/mediacenter/category/media/";?>" data-tb="#service-tab-6" class="flex-cc">
