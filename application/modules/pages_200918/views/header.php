...
<html lang="en">
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="slider/css/slider.css">
  </head>
  <body>
	<div class="container-fluid menu-border">
	<nav id="navigation" class="navbar navbar-dark bg-primary navbar-fixed-top">	
         <!-- <nav class="navbar navbar-default navbar-ex navbar-fixed-top" role="navigation">
           <div class="container-fluid"> -->
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="padding:0px; margin-bottom:10px;">
					<img src="images/logo1o11.png" class="img-responsive trans">
					<img src="images/logo1o1.png" class="img-responsive logo-hide">
				</a>
            </div>
            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <div class="col-md-3 col-sm-4 right-icon">
                    <div class="row">
                        <!-- <div class="btn-group"> -->
                        <!-- <a href="index.php" aria-haspopup="true" aria-expanded="false" title="Home"><img src="images/home-icon.jpg" width="23" height="21"></a> -->
                        <!-- </div> -->
                        <div class="btn-group">
                            <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Help">
							<img src="images/help.png" width="23" height="21" class="trans">
							<img src="images/help1.png" width="23" height="21" class="non-trans"></a>
                        ...
                        <div class="btn-group">
                            <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Track order">
								<img src="images/truck1.png" width="27" height="21" class="trans">
								<img src="images/truck.png" width="27" height="21" class="non-trans"></a>
                            <ul class="dropdown-menu" style=" min-width:160px;">
                        ...
                        <div class="btn-group">
							...
							<img src="images/shoping1.png" width="27" height="21" class="trans">
							<img src="images/shoping.png" width="27" height="21" class="non-trans"></a>
                        ...
                        <div class="btn-group">
							...
							<img src="images/user1.png" width="17" height="21" class="trans">
							<img src="images/user.png" width="17" height="21" class="non-trans">
							</a>
                        ...
                        <div class="btn-group">
                            <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Links">
								<img src="images/lins1.png" width="17" height="21" class="trans">
								<img src="images/lins.png" width="17" height="21" class="non-trans">
							</a>
                ...
                <ul class="nav navbar-nav navbar-nav-ex">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <ul class="multi-column-dropdown">
                                        <h5><a href="machines.php">Machines</a></h5>
                                        <li class="divider"></li>
                                        <li><a href="new_machines.php">New Machines</a></li>
                                        <li><a href="pre_owned_machines.php">Pre-Owned Machines</a></li>
                                    </ul>
                                </div>
                                <div class="col-sm-3">
                                    <ul class="multi-column-dropdown">
                                        <li>
                                            <h5><a href="toolings.php">Toolings</a></h5>
                                        </li>
                                        <li class="divider"></li>
                                        <li><a href="coming_soon.php">Press Punch Tools </a>
                                        </li>
                                        <li><a href="coming_soon.php">Bending Tools</a></li>
                                        <li><a href="coming_soon.php">Drilling Tools</a></li>
                                        <li><a href="coming_soon.php">Cutting Tools</a></li>
                                        <li><a href="coming_soon.php">Laser Cutting Tools</a></li>
                                        <li><a href="coming_soon.php">Welding Tools</a></li>
                                        <li><a href="coming_soon.php">Handheld Tools</a></li>
                                        <li><a href="coming_soon.php">Laser Welding Tools</a></li>
                                        <li><a href="coming_soon.php">Power Tools</a></li>
                                        <li><a href="coming_soon.php">Powder Coating Tools</a></li>
                                    </ul>
                                </div>
                                <div class="col-sm-3">
                                    <ul class="multi-column-dropdown">
                                        <li>
                                            <h5><a href="spare_parts.php">Spare Parts</a></h5>
                                        </li>
                                        <li class="divider"></li>
                                        <li><a href="coming_soon.php">Service Parts</a></li>
                                        <li><a href="coming_soon.php">Consumables</a></li>
                                    </ul>
                                </div>
                            </div>
                        </ul>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">eAcademy <span class="caret"></span>
					 </a>
                        <ul class="dropdown-menu multi-column columns-3">
                            <div class="row">
                    ...
                    <li><a href="forum_front.php">Forum</a></li>
                </ul>
               ...
               <!-- <ul class="nav navbar-nav navbar-nav-ex">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Sourcing <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                        <li><a href="consultants.php">Consultants</a></li>
                        <li><a href="programmers.php">Programmers</a></li>
                        <li><a href="service_enggs.php">Service Engineers</a></li>
                        <li><a href="app_enggs.php">Application Engineers</a></li>
                        <li><a href="trainers.php">Trainers</a></li>
                        <li><a href="suppliers.php">Suppliers</a></li>
                        <li><a href="coming_soon.php">Distributors</a></li>
                        <li><a href="coming_soon.php">Manufacturers</a></li>
                        </ul>
                    </li>
                    <li><a href="forum_front.php">Forum</a></li>
                </ul> -->

				<form class="navbar-form navbar-right navbar-nav-ex">
