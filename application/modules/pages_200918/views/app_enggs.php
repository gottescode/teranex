...
<div class="container-fluid myprofile-bg dahboard-bg">
  <div class="container">
    <div class="col-sm-4">
      <ul>
        <li class="myprofile">Application Engineers</li>
      </ul>
    </div>
  </div>
  <!-- /.container --> 
...
<div class="container-fluid programmers-grey-bg">
  <div class="container">
    ...
    <div class="col-sm-8 col-md-10">
     ...
     <p><span class="one-ten-text">1 - 10</span> of 64 App Engineers</p>
     </div>
...
<!-- /.container-fluid -->
  ...
  <div class="container">
    <center>
      <h1 class="meet-some-text">Meet our pool of app engineers</h1>
    </center>
      <div class="container">
      <div class="row">
        <div class="col-sm-4">
