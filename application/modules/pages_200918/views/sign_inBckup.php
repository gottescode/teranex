...
<div style="padding:30px 0">
		    ...
		    <form class="form-signin" name="register" id="register" method="post" enctype="multipart/form-data" action="" > 
		        <h2 class="form-signin-heading">Sign up</h2>
					<div class="form-group ">
						<input type="email" id="s_email" name="s_email" class="form_bor_bot " placeholder="Email ID" >
					</div>
					<div class="form-group">
					  	<input type="text" class="form_bor_bot numbersOnly"  id="s_mobileno" name="s_mobileno" minlength="10" maxlength="10" placeholder="Mobile Number">
					</div>
					
		        	<div class="form-group">	        			
	        			<input type="password" id="s_password" name="s_password" class="form_bor_bot " placeholder="Password" >
	        		</div>
	        		<div class="form-group">
	        			<input type="password" id="conf_password" name="conf_password" class="form_bor_bot" placeholder="Re-confirm password" >
	        		</div>
	        		<div class="form-group">
						<select class="form_bor_bot"   id="SignupType" name="SignupType">
		        	...
		        	<div class="form-group">
		        		<div class="checkbox">
					          <label>
					           <input class="required" name="acceptPrivacy" id="acceptPrivacy" type="checkbox" />I accept <a href="<?php echo site_url()?>pages/privacystatement" target="_blank"> privacy policy</a>
					          </label>
				        </div>
		        	</div>
		        	<div class="form-group">
	...
	<div class="col-sm-6 sign-in">
		<div class="border_bot col-sm-offset-2 col-sm-8 " style="background-color: #fff;padding:10px 40px;box-shadow: 0px 0px 10px #dfdcdc;">
		    <form class="form-signin" name="login" id="login" method="post" action="<?php echo site_url()."pages/login"?>">
		        ...
		        <div class="form-group">
			        	<input type="text" name="u_email" id="u_email" class="form_bor_bot" placeholder="Email ID" >
		        </div>
		        <div class="form-group">
				        <input type="password" name="u_password" id="u_password" class="form_bor_bot" placeholder="Password" > 
 ...
 <div id="otp_modal"  role="dialog"  class="modal fade"> 
