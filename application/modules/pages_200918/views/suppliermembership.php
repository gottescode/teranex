    ...
    <div class="col-sm-12 rfq_works1 padd-0">
    	<div class="col-sm-10 pading_left_0">
	    	...
	    	<div class="border_bot col-md-12 col-sm-12 col-xs-12" style="background-color: #fff;padding:40px 40px;box-shadow: 0px 0px 10px #dfdcdc;height:;">
          		<form class="form-horizontal" name="supplier_membership" id="supplier_membership" method="post" action="">
	             	<div class="form-group ">
	                  	<input type="text" class="form_bor_bot" id="supplier_name" name="supplier_name" placeholder="Supplier Name"><span class="compulsary">*</span>
	                </div>
	                <div class="form-group">
	                ...
	                <div class="form-group">
	              	...
	              	<div class="form-group col-sm-12 text-center">
	            	  	<center><input type="submit" name="btnSupplierMembership" id="submit" class="btn input-form contact-submit btn_orange" value="Submit"></center>
	              	</div>
          		</form>
      		</div>
		</div>
