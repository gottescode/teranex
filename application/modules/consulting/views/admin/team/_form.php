			...
			<form class="form-horizontal" role="form" action="" id="team_form" method="post" enctype="multipart/form-data">
				<fieldset>
				   <div class="form-group">
					...
					<div class="col-sm-6">
					<input type="text" name="name" id="name lettersOnly" class="form_bor_bot required" value="<?=$team_data['name']?>">
					</div>
				  </div> 
				   <div class="form-group">
					<label class="control-label col-sm-3" for="designation">Designation:<span class="star">*</span></label>
					<div class="col-sm-6">
					<input type="text" name="designation" id="designation" class="form_bor_bot lettersOnly required" value="<?=$team_data['designation']?>">
					</div>
				  </div> 
				   <div class="form-group">
					<label class="control-label col-sm-3" for="role">Role<span class="star">*</span></label>
					<div class="col-sm-6">
					<input type="text" name="role" id="role" class="form_bor_bot lettersOnly required" value="<?=$team_data['role']?>">
					</div>
				  </div> 
				   <div class="form-group">
					<label class="control-label col-sm-3" for="experiance">Experience<span class="star">*</span></label>
					<div class="col-sm-6">
					<input type="text" name="experiance" id="experiance" class="form_bor_bot numbersOnly required" value="<?=$team_data['experiance']?>">
					</div>
				  </div> 
				  <div class="form-group">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-8">
					<textarea name="qualification" id="qualification" class="form-control lettersOnly required" ><?=$team_data['qualification']?></textarea>	
					</div>
				  </div> 
					...
					<div class="col-sm-6">
					<input type="file" name="team_image" id="team_image" class="" accept="image/*" >
   ...
   rules: {  
			...
			messages: { 
			   ...
			   designation:{
			   	...
			   	prev_company:{
				   required:"Please enter previous company"
			   	},
				specialization:{
				   required:"Please enter specialization"
			   	},
				qualification:{
				   required:"Please enter qualificaion"
			   	},
				team_image:{
