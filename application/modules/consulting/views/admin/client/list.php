    ...
    <!-- Content Header (Page header) -->
		<section class="content-header">
		  ...
		  <ol class="breadcrumb">
			...
			<li class=""><a href="<?=site_url()."consulting/admin"?>"> Client</a></li>
	 ...
	 <!-- Main content -->
		<section class="content">
			<div class="row">
				<div class="col-xs-12">
					<div class="box">
						<div class="padd-15"><a href="<?=site_url()."consulting/admin/createClient"?>" class="btn btn-info" role="button">Add Client</a></div>
						...
						<div class="box-body"> 
							...
							<img class="img-responsive event-img" src="<?=site_url().'uploads/client/'.$rowData['client_image']?>" height="72" width="72">
							  <?php }?></td>
													...
													<td><a href="<?=site_url()."consulting/admin/updateClient/".$rowData['client_id']?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp; &nbsp;
														<a onclick="return confirm('Are You Sure To Delete This Entry?')"  href="<?=site_url()."consulting/admin/deleteClient/".$rowData['client_id']?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
														<a href="<?=site_url()."consulting/admin/clientList/".$rowData['client_id']?>"<i style="font-size:18px;margin-left: 10px;" class="fa">&#xf0fe;</i></a>
