...
/* =============== MACHINE DETAILS ================= */
	...
	public function machineFinaceRequest() { 
		$result = $this->db_lib->fetchMultiple(" machine_finance_request MFR JOIN machine_details MD ON MFR.machine_id=MD.md_id", "	mfr_id<>0 ORDER BY enquiry_date","MFR.*, MD.model_no,MD.brand_name"); 
        return $result;
    }
