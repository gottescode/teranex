 ...
 <div class="page-container">
        <div class="container">
           <div class="page-title-container">
                <div class="page-heading">Request For Machine Demo</div>
                <div class="progress form-progress-bar">
                    <div class="progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:50%">
                    </div>
                </div>
                <form method="POST" name="machine-video-req" id="machine-video-req" enctype="multipart/form-data" class="form-container">
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            <div class="form-card-container">
                                <div class="page-heading">Machine Demo</div>
                                ...
                                <div class="form-set-content pt-0">
                                        What would do you like to see in your demo? Specify parameters such as material, thickness, application, geometry, and functions.
                                </div>
                                <div class="form-set-content">
                                    <div class="form-group">
                                    <textarea class="full-width form-control"	name="description" placeholder="Ender your part description here.." rows="4"></textarea>
                                </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-card-container">
                                ...
                                <div class="form-set-content">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 no-padding">
                                        <div class="form-group">
                                        <input class="input-control form-control" type="text"name="part_type" placeholder="Part 1 Name">
                                    </div>
                                    </div>
                                </div>
                                <div class="form-set-content">
                                    <label >Application Type</label>
                                    <select class="form-select-box" name="application_type">
                                        <option value="">Please Select</option>
                                ...
                                <div class="page-heading mt-20">Attach Drawings</div>
                                <div class="form-set-content">
                                    <div class="file-browser pt-0">
                                        <span class="control-fileupload">
                                            <label for="file"></label>
                                            <input type="file" name="attach_drawing" id="file">
                                        </span>
                                    </div>
                                </div>
                                <div class="form-set-content flex">
                                    <div class="form-group flex">
                                    <label >Description</label>
                                    <textarea class="form-control" name="part_description" placeholder="Ender your part description here.." rows="4"></textarea>
                                </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="submit-btn-container">
                        ...
                        <button class="btn submit-btn" name="submit" value="submit">Submit!</button>
                    </div>
                </form>
            </div>
