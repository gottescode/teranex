 ...
 <div class="page-container">
        <div class="container">
            <div class="page-title-container">
               ...
               <div class="page-title-container">
                <div class="page-heading">FinTech</div>
                <div class="progress form-progress-bar">
                    <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width:60%">
                    </div>
                </div>
                <form class="form-container" name="fintech" id="fintech" method="POST" enctype="multipart/form-data">
                    <div class="row">
                            ...
                            <div class="form-card-container">
                                ...
                                <div class="form-set-content no-padding">
                                    <div class="radio radio-FinTech">
                                        <input type="radio" name="fin_type" id="radio1" value="Term Loan" checked>
                                        <label for="radio1">
                                            Term Loan
                                        </label>
                                    </div>
                                    <div class="radio radio-FinTech">
                                        <input type="radio" name="fin_type" id="radio2" value="External Commercial Borrowing">
                                        <label for="radio2">
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-8 col-xl-8">
                            ...
                            <div class="form-card-container">
                                ...
                                <div class="form-set-content">
                                    <label  class="full-width">Your Aathaar</label>
                                    <div class="file-browser">
                                        <span class="control-fileupload">
                                            <label for="file9"></label>
                                            <input type="file" name="personal_adhar_card" id="file">
                                        </span>
                                    </div>
                                </div>
                                <div class="form-set-content">
                                    ...
                                    <div class="file-browser">
                                        <span class="control-fileupload">
                                            ...
                                            <input type="file" id="file1" name="personal_pan_card">
                                        </span>
                                    </div>
                                </div>
                                <div class="form-set-content">
                                    ...
                                    <div class="file-browser">
                                        <span class="control-fileupload">
                                            <label for="file2"></label>
                                            <input type="file" id="file2" name="personal_address_proof">
                                        </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-set-content">
                                    ...
                                    <div class="file-browser">
                                        <span class="control-fileupload">
                                            ...
                                            <input type="file" id="file3" name="business_pan_card">
                                        </span>
                                    </div>
                                </div>
                                <div class="form-set-content">
                                    ...
                                    <div class="file-browser">
                                        <span class="control-fileupload">
                                            ...
                                            <input type="file" id="file4" name="business_address_proof">
                                        </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-set-content">
                                    ...
                                    <div class="file-browser">
                                        <span class="control-fileupload">
                                            ...
                                            <input type="file" id="file5" name="company_bank_statement">
                                        </span>
                                    </div>
                                </div>
                                <div class="form-set-content">
                                    ...
                                    <div class="file-browser">
                                        <span class="control-fileupload">
                                            ...
                                            <input type="file" id="file6" name="company_balance_sheet">
                                        </span>
                                    </div>
                                </div>
                                <div class="form-set-content">
                                    ...
                                    <div class="file-browser">
                                        <span class="control-fileupload">
                                            ...
                                            <input type="file" id="file7" name="company_invoice_sheet">
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="submit-btn-container">
						<button type="submit" value="submit" name="submit" class="btn submit-btn">Submit</button>
                    </div>
                </form>
            </div>            
		</div>
