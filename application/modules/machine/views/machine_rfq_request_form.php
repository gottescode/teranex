	...
	<div class="page-container">
        <div class="container">
			<div class="page-title-container">
                <div class="page-heading">Request For Quote - Quote Details</div>
                <div class="progress form-progress-bar">
                    <div class="progress-bar" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width:20%">
                    </div>
                </div> 
                <form class="form-container" method="POST" enctype="multipart/form-data" name="rfq" id="rfq">
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            <div class="form-card-container">
                                <div class="page-heading">Machine Details</div>
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                            <div class="form-card-container">
                                <div class="page-heading">Your Details</div>
                                <div class="form-set-content">
                                        <table style="width:100%">
                                          <tr>
                                            <th>Name</th>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="form-card-container quote-timeline">
                                <div class="flex align-items-center">
                                	<div class="form-set-content">
                                        <div class="quote-timeline-title">
                                        	Quote Needed by
                                        </div>
                                    </div>
                                    <div class="form-set-content">
                                        ...
                                        <select class="form-select-box" name="preferred_date" id="preferred_date">
                                            <option value="20-05-2019">20-05-2019</option>
                                        </select>
                                    </div>
                                    <div class="form-set-content">
                                        <label>
                                        ...
                                        <select class="form-select-box" name="currency">
                                            <option value="Indian Ruppes">Indian Ruppes</option>
                            ...
                            <div class="form-card-container quote-timeline">
                                <div class="flex align-items-center">
                                    ...
                                    <div class="form-set-content">
                                        ...
                                        <select class="form-select-box" name="delivery_preferred_date">
                                            <option value="20-05-2019">26-05-2019</option>
                                        </select>
                                    </div>
                                    <div class="form-set-content">
                                        <label>
                                        ...
                                        <select class="form-select-box" name="paid_by">
                                ...
                                <div class="flex align-items-center">
                                    <div class="form-set-content delevery-width">
                                        <input class="input-control" type="text" name="delivery_address" placeholder="Please enter your delevery address">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-card-container quote-timeline">
                                <div class="flex align-items-center">
                                    ...
                                    <div class="form-set-content">
                                        ...
                                        <select class="form-select-box" name="mode_of_advance_payment">
                                    ...
                                    <div class="form-set-content">
                                        ...
                                        <select class="form-select-box" name="remaining_payment">
                                            <option value="">Please Select</option>
                                            <option value="Option 1">Option 1</option>
                                            <option value="Option 2">Option 2</option>
                                        </select>
