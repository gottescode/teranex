...
<div class="container-fluid myprofile-bg dahboard-bg">
  <div class="container">
    ...
    <div class="col-sm-4">
     	<p class="pull-right"><a href="<?php echo site_url()."/machine/machineListNew/machineList/machines"?>">Back to Results</a> | <a href="<?php echo site_url()."/machine/machineListNew/machineList/machines"?>">See more models</a></p>
    </div>
  </div>
  <!-- /.container --> 
</div>
