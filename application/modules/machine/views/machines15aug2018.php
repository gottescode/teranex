				...
				<div class="col-sm-3 padd-8">
					<div class="bx-shadow" style="border:none;min-height: 400px;box-shadow: 0px 0px 10px #dfdcdc;">
						...
						<div class="machine_info">
							<center><span class="" style="padding: 0 15px;font-size: 18px;"><?php echo $rowMachine['modelName'];?></span>  <br/><span  style="padding: 0 15px;"><?php echo $rowMachine['city_name'].", ".$rowMachine['state_name']?></span>
