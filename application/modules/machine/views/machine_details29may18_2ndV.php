		...
		<div class="col-sm-12">
			<div class="" id="at_glance">
			  	...
			  	<div class="col-sm-6 consu-table">
					...
					<video width="100%" height="317" controls style="margin-top: -20px;">
			...
			<div class="" id="Software">
				...
				<div class="col-sm-12 padd-0">
					<div class="col-sm-3 padd-8 soft-list-item">
						 <div>
			...
			<div class="full-width pull-left" id="contact">
					...
					<div class="col-sm-6">
						<form role="form" action="" id="contactEnquiry" method="post" enctype="multipart/form-data">
							<?php
								if($user_id==''){ echo "<h3 style='margin-top: 33px;'>Please login before submit request. <a class='orng_clr' href='#'  data-toggle='modal' data-target='#signinModal'>Click Here</a></h3> ";}?>
