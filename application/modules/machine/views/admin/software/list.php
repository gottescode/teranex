									...
									<table class="table table-bordered table-striped" id="community_table">
										...
										$i=1;
											...
											<tr>
												...
												<td>
													<a href="<?=site_url()."machine/admin/machineSoftwareUpdate/".$row['ms_id']; ?>" aria-haspopup="true" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
													&nbsp;&nbsp;
													<a onclick="return confirm('Are You Sure To Delete This Entry?')"  href="<?=site_url()."machine/admin/deleteMachineSoftware/".$row['ms_id']; ?>" aria-haspopup="true" title="Delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
												</td> 
											</tr>
											<? } ?>
										</tbody>
