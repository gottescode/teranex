			...
			<form class="form-horizontal" role="form" action="" id="casestudy_form" method="post" enctype="multipart/form-data">
				<fieldset>
				   <div class="form-group">
					...
					<div class="col-sm-6">
					<input type="text" name="printing_application_name" id="printing_application_name" class="form_bor_bot required" value="<?=$PrintingApplication_list['printing_application_name']?>">
					</div>
				  </div> 
				  ...
				  <div class="form-group">
					<label class="control-label col-sm-3" for="printing_application_image">Printing Application Image :</label>
					<div class="col-sm-6">
