...
class Api extends API_Controller {
  function __construct() {
	...
	*/
	...
	public function AdditiveManufacturingSupplierListAcceptByadmin_get($drrs_id) {
		...
		if( !(int)$drrs_id){
			...
			$response = [
				...
				"result" => $this->additivemanufacturing_model->AdditiveManufacturingSupplierListAcceptByadmin($drrs_id),
