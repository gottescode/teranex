...
class ZoomAPI{
	...
	/* private $api_key = 'JD0WIQd-TGmYFC2RM_DbBA';
	private $api_secret = 'Ya2DXZsviVwjurDvjrZD3CcQdTcZ5woJJkf7';
	private $api_url = 'https://api.zoom.us/v2/'; */
	
	/* Swapnali Account */
	/* private $api_key = 'ayURDN9URhCS3rXKRC_8eg';
	private $api_secret = '2jYsU6EqsPCp667fe8bvDAu1NSeTzq4Jjay8';
	private $api_url = 'https://api.zoom.us/v2/';
	 */
	/* Stelmac Account */
	private $api_key = 'MS1SBb2iRlaRtRc58Dd7KA';
	private $api_secret = 'vn1CCJ96UfnWAqKvbINTZNGnv0xExd3gRJod';
	private $api_url = 'https://api.zoom.us/v2/';
...
/* Schedule Meeting From Consultant */
	function createMeeting($data){		
	//$data is all the requested parameter for API
		$createMeetingArray = array();
		$timestamp = $data['datetimepicker'];
		$splitTimeStamp = explode(" ",$timestamp);
		$date = $splitTimeStamp[0];
		$time = $splitTimeStamp[1];
		$data['datetimepicker'] = $date."T".$time."Z";
		$createMeetingArray['topic'] = $data['title'];
		$createMeetingArray['start_time'] = $data['datetimepicker'];
		$createMeetingArray['type'] = 2;
		$createMeetingArray['duration'] = $data['duration'];
		/* $createMeetingArray['timezone'] = 'Asia/Calcutta'; */
		$createMeetingArray['timezone'] = 'Australia/Melbourne';
		return $this->sendRequest_post('users/stelmacdeveloper@gmail.com/meetings',$createMeetingArray);
	}   
