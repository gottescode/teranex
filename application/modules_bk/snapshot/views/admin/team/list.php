  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <!-- Content Header (Page header) -->
		<section class="content-header">
		  <span style="font-size: 24px;padding: 10px;">snapshot Team</span>
		  
		  <ol class="breadcrumb">
			<li><a href="<?=site_url()."dashboard"?>"><i class="fa fa-dashboard"></i> Home</a></li>
			<li class=""><a href="<?=site_url()."snapshot/admin"?>">snapshot Team</a></li>
	 ...
	 <!-- Main content -->
		<section class="content">
			<div class="row">
				<div class="col-xs-12">
					<div class="box">
						<div class="padd-15"><a href="<?=site_url()."snapshot/admin/createTeam"?>" class="btn btn-info" role="button">Add Team Member</a></div>
						...
						<div class="box-body"> 
							...
							<img class="img-responsive event-img" src="<?=site_url().'uploads/team/'.$rowData['team_image']?>" height="72" width="72">
							  <?php }?></td>
													...
													<td><a href="<?=site_url()."snapshot/admin/updateTeam/".$rowData['team_id']?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp; &nbsp;
														<a onclick="return confirm('Are You Sure To Delete This Entry?')"  href="<?=site_url()."snapshot/admin/deleteTeam/".$rowData['team_id']?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
														<a href="<?=site_url()."snapshot/admin/teamList/".$rowData['team_id']?>"<i style="font-size:18px;margin-left: 10px;" class="fa">&#xf0fe;</i></a>
