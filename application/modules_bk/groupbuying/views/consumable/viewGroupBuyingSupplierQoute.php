...
<section class="content-header">
  <span style="font-size: 24px;padding: 10px;">Group Buying Suppliers Quotation</span>
...
?>
   <center><a href="<?=site_url()."groupbuying/admin/GroupBuyingSupplierListAcceptByadmin/".$result['gsr_id']?>" class="btn btn-success">Accept</a> &nbsp; &nbsp;  </center>
