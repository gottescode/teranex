	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box">
				...
				<div class="box-body"> 
					<form id="" name="" class="form-horizontal" enctype="multipart/form-data" method="post" action= "<?php echo site_url()."groupbuying/serviceparts/assignSupplierForRequest"?>">
						...
						<input type="hidden" name="service_quantity" value="<?php echo $service_quantity; ?>">
						<input type="hidden" name="service_parts_name" value="<?php echo $service_parts_name; ?>">
