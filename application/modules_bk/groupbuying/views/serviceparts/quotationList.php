									...
									<tr> 
										...
										<td><?
											...
											<?	
												...
												?>
												<a href="<?php echo site_url()."groupbuying/serviceparts/sendQuotationCustomer/".$row['id']."/".$row['admin_rfq_id']."/".$row['supplier_id']?>" class="btn btn-xs btn-success">Accept & Send </a>&nbsp;
												<?
											}
										?></td>
									</tr>
