						...
						<div class="box-body"> 
							...
							<img class="img-responsive event-img" src="<?=site_url().'uploads/groupbuying/'.$rowData['groupbuying_cat_image']?>" height="72" width="72">
							  ...
							  <?php }?></td>
													...
													<td><a href="<?=site_url()."groupbuying/admin/updateCategory/".$rowData['groupbuying_cat_id']?>" aria-haspopup="true" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp; &nbsp;

														<a onclick="return confirm('Are You Sure To Delete This Entry?')"  href="<?=site_url()."groupbuying/admin/deleteCategory/".$rowData['groupbuying_cat_id']?>" aria-haspopup="true" title="Delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a>&nbsp; &nbsp;

														<!-- <a href="<?=site_url()."groupbuying/admin/groupbuyingCategory/".$rowData['groupbuyingg_cat_id']?>"<i class="fa fa-plus-square"></i></a> -->
