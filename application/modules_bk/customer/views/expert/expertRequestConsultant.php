					...
					<tbody>
							...
							if($requestList >0){ $i=1;
								...
								<tr>
									...
									?>
										<a href = "<?php echo site_url()."customer/accept_xpert_request/{$rowData['expert_id']}"?>" class="btn btn-xs btn-success">Accept</a>
										<a href = "<?php echo site_url()."customer/reject_xpert_request/{$rowData['expert_id']}"?>" class="btn btn-xs btn-danger">Reject</a>
									<?
										}
									?>										
										<?php
											if($rowData['meeting_status']=='N'&&$rowData['is_accepted_by_consultant']==='Y'){
												?>
											<a href = "<?php echo site_url()."customer/scheduleCourseExpert/{$rowData['expert_id']}"?>" class="btn btn-xs btn-primary">Schedule Meeting</a>
										<?
											}
