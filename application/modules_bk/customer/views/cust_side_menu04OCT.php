...
<?php $user_type = $this->session->userdata('user_type'); ?>
    <div class="col-xs-6 col-sm-3 col-md-3 col-lg-2 col-flex padd-0" style="min-height: 100%;">
      	<div class="sidebar-navigation">
	        <ul class="main_ul">
	        	<li> <a href="<?php echo site_url()."customer/profile_detail/";?>">Company</a></li>
	        	<li> <a href="<?php echo site_url()."customer/alluserList/";?>">Users</a></li>
	        	<li> <a href="<?php echo site_url()."customer/collectiveBuying/";?>">Collective Buying</a></li>
	        	<li> <a href="<?php echo site_url()."customer/machineServices/";?>">Machine Services</a></li>
	        	<li> <a href="<?php echo site_url()."customer/applicationService/";?>">Application Services</a></li>
	        	<li> <a href="<?php echo site_url()."customer/trainingCourses/";?>">Training Courses</a></li>
	        	<li> <a href="<?php echo site_url()."customer/marketIntelligence/";?>">Market Intelligence</a></li>
	        	<li> <a href="<?php echo site_url()."customer/tradeServices/";?>">Trade Services</a></li>
	        	<li> <a href="<?php echo site_url()."customer/customerServices/";?>">Customer Services</a></li>
