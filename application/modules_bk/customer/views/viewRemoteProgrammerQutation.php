			...
			<div class="border_bot col-sm-offset-3 col-md-4 col-sm-4 col-xs-12" style="background-color: #fff;padding:40px 40px;box-shadow: 0px 0px 10px #dfdcdc;"> 
				<form class="form" name="qoutationAdd" id="qoutationAdd" method="post" action="" enctype="multipart/form-data">
                     ...
                     <label>Download Quotation</label>
					    ...
					    <?php
                                    if ($result['uploaded_quotation'] != '') {
                                        echo "<a href='" . site_url() . "uploads/additive_manufacturing_uploaded_quotation/" . $result['uploaded_quotation'] . "' target='_blank'>Click Here</a>";
                                    }
                                    ?>
					...
					<div class="form-group col-sm-12 col-xs-6">
                                            <a href="<?=site_url()."customer/RemoteProgrammerAcceptBycustomer/".$result['rarp_id']?>" class="btn btn-success">Accept Quotation</a><br>
                                            <br>
                                            <a href="<?=site_url()."customer/RemoteProgrammerSupplierListAcceptByreject/".$result['rarp_id']?>" class="btn btn-danger">Reject Quotation</a>
