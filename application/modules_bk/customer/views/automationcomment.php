  ...
  <div class="container">
    ...
    <div class="col-sm-4 col-lg-3">
      <ul>
        ...
        <li class="pull-right"><a href="#">Go To My Teranex </a>&nbsp;|&nbsp; </li>
      </ul>
    </div>
  </div>
  <!-- /.container --> 
...
<div class="row margin_0" style="background-color: #353537;">
    ...
    <div class="col-md-10 col-sm-12 col-xs-12 bg_white padd-0" style="padding-top: 0;"> 
        <div class="col-sm-10" style="border-right: 1px solid #e7e7e7;">
    	    ...
    	    <?php if($automationCommentReplyList){
    			...
    			$url = site_url()."automation/api/automationCommentReplyFileList/".$rowreply['acr_id'];; 
