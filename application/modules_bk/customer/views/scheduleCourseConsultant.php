				  ...
				  <div class="form-group"> 
					...
					<div class="text-center">
					 ...
					 <input type="submit" name="btnSubmit" value="Submit" class="btn btn-primary btn_orange">  
					  ...
					  <input type="hidden" name="rar_id" value="<?php echo $rar_id?>"  >  
				...
				<tbody>
...

						{
							...
							<tr>
								...
								<td><a href="<?=site_url()."customer/tokboxLunchRemoteService/".$rowData['rab_id'];?>" target="_blank" class="btn btn-xs btn-primary"  >Launch</a></td>
