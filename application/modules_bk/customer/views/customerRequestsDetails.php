...
<div class="col-lg-10 col-md-9 col-sm-9 col-xs-12">  
	...
	<form class="form" name=" " id="" method="post" action="" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<?php    if($adtlist['request_status']=='QG'|| $adtlist['request_status']=='QS' || $adtlist['request_status']=='C') {   }
else{?>

				<a class="btn btn-success" href="<?php echo site_url()."customer/remoteApplicationProgrammAccept/".$rarp_id; ?>" >Generate Quotation</a>

				<a class="btn btn-danger" href="<?php echo site_url()."customer/remoteApplicationProgrammReject/".$rarp_id; ?>" >Reject</a>
