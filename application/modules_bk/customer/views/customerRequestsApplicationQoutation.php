				...
				<?php }	?>
					...
					<form class="form" name="qoutationAdd" id="qoutationAdd" method="post" action="" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input type="text" class="form_bor_bot" id="number_of_hours" name="number_of_hours" placeholder="Number of Hours"  value="<?php echo $result['number_of_hours']?>" /><span class="compulsary">*</span>

						</div>

						<div class="form-group">

							<input type="text" class="form_bor_bot" id="lead_time" name="lead_time" placeholder="Lead Time"   value="<?php echo $result['lead_time']?>"/>
						...
						<div class="form-group ">
							...
							<input type="text" class="form_bor_bot" id="tax_rate" name="tax_rate" placeholder="Tax Rate"   value="<?php echo $result['tax_rate']?>"/> 
