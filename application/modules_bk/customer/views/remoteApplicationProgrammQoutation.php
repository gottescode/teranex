				...
				<?php }	?>
					<form class="form" name="qoutationAdd" id="traineeAdd" method="post" action="" enctype="multipart/form-data">
						<div class="form-group">
							...
							<div class="col-sm-6">
                                                            <input type="text" class="form_bor_bot numbersOnly" id="number_of_hours" name="number_of_hours" placeholder="Number of Hours" required=""  value="<?php echo $result['number_of_hours']?>" />
							</div>
						</div><div class="clearfix"></div><br/>
						<div class="form-group">
							<label class="control-label col-sm-4" for="">Lead Time:</label>
							<div class="col-sm-6">
								<input type="text" class="form_bor_bot numbersOnly" id="lead_time" name="lead_time" placeholder="Lead Time"   required=""   value="<?php echo $result['lead_time']?>"/>
							</div>
						</div><div class="clearfix"></div><br/>
						<div class="form-group ">
							<label class="control-label col-sm-4" for="">Program Description:</label>
							<div class="col-sm-6">
								<textarea class="form_bor_bot  " id="program_description" name="program_description" required=""   placeholder="Program Description" ><?php echo $result['program_description']?></textarea> 
							</div>
						</div><div class="clearfix"></div><br/>
						<div class="form-group">
						...
						<div class="form-group ">
							...
							<div class="col-sm-6">
                                                            <input type="text" class="form_bor_bot numbersOnly" required=""   id="tax_rate" name="tax_rate" placeholder="Tax Rate"   value="<?php echo $result['tax_rate']?>"/> 
