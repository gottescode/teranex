...
<div class="container-fluid myprofile-bg dahboard-bg">
  <div class="container">
    <div class="col-sm-4 padd-0">
      <ul>
        <li class="myprofile">Trade Services</li>
      </ul>
    </div>
			...
			<div class="col-sm-12">
				<h3>Customer</h3> 
			 	<table id='' class="table table-striped table-hover">
					<thead>
						<tr bgcolor="#CCCCCC"><td>Sr.No</td><td>Created on </td><td>Service (Business Identity / Inspection service) </td> <td>Type </td><td>Status </td><td>Action</td></tr>
					</thead>
					<tbody>
						<tr>
							<td><?php echo $i++;?></td>
				...
				<h3>Superuser</h3> 
			 	<table id='' class="table table-striped table-hover">
					<thead>
						<tr bgcolor="#CCCCCC"><td>Sr.No</td><td>Created on </td><td>Customer name</td><td>Service (Business Identity / Inspection service) </td> <td>Type </td><td>Status </td><td>Action</td></tr>
					</thead>
					<tbody>
						<tr>
							<td><?php echo $i++;?></td>
