...
//print_r($arrUserData);exit;
  ...
  //   print_r($arrData);die;
    ...
    public function eventsList($id) {
        ...
        $result = $this->db_lib->fetchMultiple("event_booking EB JOIN event EE ON EB.event_id=EE.event_id", " EB.user_id = " . $id, "EE.event_id,EE.event_end_time,EE.session_id,EE.token_id,EE.event_name,EE.organizer_name,EE.event_status,EB.participant_no, EB.event_start_date, EB.event_start_time,eb_id");
...
/////////////////////////////    machine brand Model    //////////////////////////////////
    ...
    public function eventbookingList($strWhere) {

        return $this->db_lib->fetchMultiple('event_booking', $strWhere, '');
    }
    
        public function fetchsingleventbooking($id) 
    {

        $result = $this->db_lib->fetchMultiple("event_booking", "  eb_id = " . $id, "");
        return $result;
    }
    
        public function fetchsinglevent($id) 
    {
        $result = $this->db_lib->fetchMultiple("event","event_id=".$id, "");
        return $result;
    }
    
    
     public function close_event($data) {
          $event_id = $data["event_id"];
          $data_event['event_status']=2;
//          $data_event['session_id'] = '';
//          $data_event['token_id'] = '';
          $result = $this->db_lib->update("event",$data_event,"event_id=".$event_id);
          $result = $this->db_lib->update("event_booking",$data_event,"event_id=".$event_id);
          return $result;

    }
    
        public function start_event_organizer($data) 
       {
           // print_r($data);die;
           $event_id = $data["event_id"];
           $data_event['session_id'] = $data["sessionId"];
           $data_event['token_id'] = $data["tokenId"];
        ...
        return $result;
           ...
           public function findSingleJoinEvent_get($id) 
    {
        $result = $this->db_lib->fetchMultiple("event","event_id=".$id, "");
        return $result;
    }
