	...
	<div class="container allcourse catgry_name ">
		<div class="col-sm-12 padd-0">
			<div style="margin-bottom: 0px;">
				<span class="col-sm-8 padd-0">
					<h2>Courses in <?php echo $category_data['cat_name']?></h2>
				</span>
				<span class="col-sm-4 padd-0" style="padding: 20px 0 0"><!-- <a href="" class="btn-default addmore-btn btn_orange pull-right" data-toggle="modal" data-target="#advance_search_modal">Advanced Search</a> --></span>
			</div>
				  	...
				  	<div class="course-block">
					  	<div class="anti_shadow">
						  	<div class="courses-section">
							  	<a href="<?php echo site_url()."remotetraining/course_details/$rowCourse[cid]/".formaturl($rowCourse[name])?>">
      ...
      <div class="modal-body">
      	<div class="col-sm-12 border_bot " style="padding: 30px;">
	        <form class="form-horizontal" name="" id="adv_search_form" method="post" action="#">
				  ...
				  <div class="form-group">
						<select name="s_topic" id="s_topic" class="form_bor_bot">
				  ...
				  <div class="form-group">
						<select name="level" id="level" class="form_bor_bot">
