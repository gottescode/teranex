<?php $this->template->contentBegin(POS_TOP);?><br/>
		  ...
		  <div class="container">
			  <div class="col-sm-12 padd-0">
					...
					<div class="col-sm-12 no_padng ">
						...
						<img src="<?php echo site_url()."uploads/customer/".$consultant_data['u_avatar']?>"  class="img-responsive"  style="width: 90px;height: 90px; border-radius: 50%;" />
					<?php   }else{?>
							<img src="<?php echo site_url()."uploads/customer/user-default.png"?>"  class="img-responsive" style="width: 90px;height: 90px; border-radius: 50%;"/>
						<?php }?> 
						</span>
