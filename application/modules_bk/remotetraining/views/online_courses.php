			...
			<div class="col-sm-12" style="padding: 30px 0;">
				...
				<div>
					<ul class="tab-widget icon-tab tab-pd">
						...
						<li>
							<a target="" href="<?php echo site_url()."macademy/virtual_classroom";?>" data-tb="#service-tab-2" class="flex-cc">
						...
						<li><i class="fa fa-plus fa-lg" aria-hidden="true"></i></li> -->
						<li>
							<a target="" href="<?php echo site_url()."macademy/self_paced_learning";?>" data-tb="#service-tab-1" class="flex-cc">
							<i class="fa fa-address-card-o" aria-hidden="true"></i></a>
							<h3 class="fs16 bold-2 mr-t-10">Self Paced Learning</h3>
						</li>
						<li><i class="fa fa-plus fa-lg" aria-hidden="true"></i></li>
						<li>
							<a target="" href="<?php echo site_url()."macademy/projects";?>" data-tb="#service-tab-5" class="flex-cc">
							<i class="fa fa-file-text-o" aria-hidden="true"></i></a>
							<h3 class="fs16 bold-2 mr-t-10">Real Life Projects</h3>
						</li>
						<li><i class="fa fa-plus fa-lg" aria-hidden="true"></i></li>
						<li>
							<a target="" href="<?php echo site_url()."macademy/online_testing";?>" data-tb="#service-tab-6" class="flex-cc">
							<i class="fa fa-check" aria-hidden="true"></i></a>
							<h3 class="fs16 bold-2 mr-t-10">Online Testing</h3>
						</li>
						<li><i class="fa fa-plus fa-lg" aria-hidden="true"></i></li>
						<li>
							<a target="" href="<?php echo site_url()."macademy/certification";?>" data-tb="#service-tab-6" class="flex-cc">
