...
<section class="content-header">
  <span style="font-size: 24px;padding: 10px;">Remote Program Suppliers Quotation</span>
		...
		<div class="col-xs-12">
			<div class="box">
				...
				<form class="form" name="qoutationAdd" id="traineeAdd" method="post" action="" enctype="multipart/form-data">
					...
					<input type="file"  id="quotation_uploaded" name="quotation_uploaded" placeholder="" required=""  />
					</div>
					 <div class="clearfix"></div>
					<?php  if($singleList['programmer_id'] == '0'){ ?>
					 <div class="form-group ">
					<input type="hidden" class="" id="rarp_id" name="rarp_id" value="<?php echo $result['rarp_id']?>" />
