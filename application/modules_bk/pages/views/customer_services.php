...
<div class="container">
    <center> 
	    ...
	    <ul class="feature" style="margin-bottom: 20px;"><li>Stelmac offers a range of intelligence reports to help customers make purchase and sales decisions. Our revenue impact consulting</li></ul>
	    ...
	    <div class="col-sm-9 padd-0">
	    	<div class="tab-content helpcenter_info" style="padding-right: 0;">
	    		<div class="tab-pane fade in active" id="submitadispute">
					...
					<div class="submitAdispute">
						<div class="col-md-4 col-sm-12 ">
							...
							<p>The buyer has the option to contact the seller in case there has been a delay in the delivery of a product or if the product delivered is not as per the specifications or quality mentioned in the contract.</p>
						</div>
						<div class="col-md-4 col-sm-12 bdrL-R">
							<h3><i class="fa fa-desktop" aria-hidden="true"></i>Raise a Complaint</h3>
							<p>In case the buyer and seller do not mutually agree on a concern raised by the buyer, a complaint can be raised on the dispute resolution centre. The buyer can also track the status of the complaint raised.</p>
						</div>
						<div class="col-md-4 col-sm-12 ">
							<h3 style="left: 23px;"><i class="fa fa-shield" aria-hidden="true" style="left: -25px;"></i>Customer Service</h3>
							<p>A dispute between a buyer and a seller can be escalated to the Stelmac customer service team. A fair and unbiased mediation will be provided to resolve the issue.</p>
						</div>
					</div>
	    		</div>
	    		<div class="tab-pane fade" id="reportAbuse">
					...
					<div class="article ReportAbuse">
						<div class="article-content">
					        <p class="summary">At Stelmac, we believe in creating a powerful tool for asking questions online. We also believe that this tool should be used ethically, to help people “Ask Awesomely!”. If you believe a Stelmac is not being used in this way, you can report it for abuse.</p>
									...
									<form class="form-horizontal border_bot" name="reportabuse" id="reportabuse" method="post" action="#">
										<div class="form-group ">
										  <div class="col-sm-12">
											...
											<input type="text" class="form_bor_bot" name="url_infri">
										  </div>
										</div>
										<div class="form-group ">
										  <div class="col-sm-12">
										...
										<div class="form-group ">
										  <div class="col-sm-12">
											...
											<input type="text" class="form_bor_bot" name="email_add">
										  </div>
										</div>
										<div class="form-group ">
										  <div class="col-sm-12">
	    		...
	    		<div class="tab-pane fade" id="payLater">
					...
					<div>
						<h3>Tie-ups with financial services providers to help you with your purchase.</h3>
					  	<div class="">
					  	 	<p>We offer the option of financing through banks and financing companies. We provide customized financing solutions tailored specifically to your requirements and ensure that the best model is chosen. We can help you apply for loans and also connect with OEMs to avail the financial services that they offer. You can also avail the benefits of Deferred Letter of Credit. </p>
					  	</div>
					</div>	
	    		</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<form id="myForm" action="#" method="POST">
								  	<h3>Join Stelmac User Research</h3>
								  	<div class="tab">
								  	...
								  	<div class="tab">
										...
										<div class="checkbox">
										 	<p>
												...
												<label class="radio"  value="I have heard of Stelmac.io, but never used it">I have heard of Stelmac.io, but never used it.<input type="radio" name="how_long"> <span class="checkround"></span> </label>
		...
		$(document).ready(function(){
			...
			var val	=	{
			    ...
			    messages: {
					...
					feature_service:{
						required:"Please select features or services on Stelmac.io you have used before"
					},
					role_in_company:{
