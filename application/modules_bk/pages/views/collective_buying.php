...
<div class="container-fluid myprofile-bg">
  <div class="container">
    <div class="col-sm-4">
      <ul>
        <li class="myprofile">Services - Group Buying</li>
      </ul>
    </div>
  </div>
  <!-- /.container --> 
...
<div class="container">
  <div class="services-group-buying-bg">
    <div class="col-sm-3 services-support-menu-bg">
      <nav class="host-event-navigation">
        <ul class="host-event-mainmenu">
          <h3>Group Buying</h3>
          <li><a href="">Collective Buying Request</a></li>
          <li><a href="">Promotional Scheme</a>
...
<div class="container">
  ...
  <div class="col-sm-12">
    <h1 class="host-event-hd">Group Buying with Teranex</h1>
