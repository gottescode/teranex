ac<img class="img-responsive bnr-images" src="<?php echo $theme_url?>/images/paidfeedback-bnr.jpg" alt=" ">
		...
		<form id="regForm" class="form-horizontal"  method="post" action="<?php echo site_url() ?>/pages/getPaidForYourFeedback" enctype="multipart/form-data" >
				...
				<div class="border_bot col-sm-offset-3 col-md-6 col-sm-6 col-xs-12 " style="background-color: #fff;padding:40px 40px;box-shadow: 0px 0px 10px #dfdcdc;height:;">
				   <form class="form-horizontal" name="contact" id="contact_info" method="post" action="#" >
					   	<div class="form-group">
						 	<input class="form_bor_bot" oninput="this.className = ''" name="name" placeholder="Full name"><span class="compulsary">*</span>
						</div>
					   	<div class="form-group">
						 	<input class="form_bor_bot" oninput="this.className = ''" name="email" placeholder="Email"><span class="compulsary">*</span>
						</div>
					   	<div class="form-group">
						 	<input class="form_bor_bot numbersOnly" oninput="this.className = ''" name="phone" placeholder="Phone number" minlength="10" maxlength="10"><span class="compulsary">*</span>
						</div>
					   	<div class="form-group">
		  ...
		  <div style="overflow:auto; float: left; width: 100%; padding-bottom: 10px;">
		    <div style="float:right;">
		      ...
		      <button class="btn btn_orange swapnext"  type="button" id="nextBtn" onclick="nextPrev(1)">Next</button>
