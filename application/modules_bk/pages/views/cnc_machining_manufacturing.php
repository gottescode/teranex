...
<div class="container servay section-pad paidfeedback">
	...
	<div class="col-sm-12">
		<div class="row">
			<center><h2>CNC Machining Manufacturing</h2></center>
					...
					<form id="myForm" action="#" method="POST">
						...
						<div class="col-sm-12">
							<!-- <center><h2>Manufacture your Design</h2></center> -->
							  	<div class="tab">
							  		<div class="col-sm-8 text-center" style="border-right: ">
							  			<h3>Upload 3D Models </h3>
							  			<div class="form-group ">
							  				<p>Drag and drop any and all 3D models</p>
							  				<small>We can accept these file formats: .step, .stp, .sldprt, .x_t, .ipt, .3dxml, .catpart, .prt, .sat and .sldasm</small>
							  			</div><br/>
							  			<div class="form-group">
							  				<center><input type="file" name="" placeholder=""></center>
							  			</div><br/>
							  			<!-- <div class="form-group">
							  				<div class="col-sm-6">
							  					<input type="text" name="" placeholder="Phone Number" class="form-control numbersOnly" minlength="10" maxlength="10">
							  				</div>
							  				<div class="col-sm-6">
							  		...
							  		<div class="col-sm-4 text-center" style="border-left: 1px solid #ccc;">
							  			<p>Do you know what material you want?</p>
							  			<br/><br/>
							  			<div class="form-group">
							  				<input type="text" name="" class="form-control" placeholder="Search by Material">
							  			</div><br/>
							  			<div class="form-group">
							  				<input type="text" name="" class="form-control numbersOnly" placeholder="Dimensions">
							  			</div><br/>
							  			<div class="form-group">
							  				<input type="text" name="" class="form-control numbersOnly" placeholder="Type Thickness">
							  			</div><br/>
							  			<div class="form-group">
							  				<input type="number" name="" class="form-control numbersOnly" placeholder="Quantity required">
							  			</div>
							  		</div>
							  	</div>
							  	<div class="tab">
									<div class="col-sm-12">
										<h3>#Part(s) Uploaded</h3>
										...
										<div class="col-sm-12">
											...
											<div class="col-sm-8" >
												...
												<div class="form-group">
													<label>Dimensions : # * # * # nm &nbsp;| &nbsp; Thickness : # * # * #</label>
												</div>
												<div class="form-group">
													<label>Process : CNC Machining</label>
												</div>
												<div class="form-group">
													<label>Material : As selected by user</label>
												</div>
							  	...
							  	<div style="overflow:auto;">
								    <div class="text-center" style="">
										...
										<!-- <button type="button" class="submit btn_orange swapcust" id="submitRFP" >Submit RFP</button> -->
										<a href="javascript:void(0)" class="submit btn_orange swapcust" id="submitRFP">Submit RFP</a>
								    </div>
							  	</div>
						</div>
					</form>
