...
class Admin_model extends CI_Model {
	...
	public function menuListByuserRoleType($data) {
		...
		$result=$this->db_lib->fetchMultiple(" user_menu_access_master as UMA LEFT JOIN menu_master MM ON UMA.menu=MM.menu_id", " user_type = {$user_type} AND  user_role = {$user_role} AND access = 1","MM.menu_id,menu_desc,menu_url,menu_for,parent_id,UMA.id,user_type,user_role,menu");
		return $result;
	}
