							...
							<form id="" name="" class="form-horizontal" enctype="multipart/form-data" method="post">
								...
								<table class="table table-bordered table-striped" id="community_table">
										...
										<?=strhtmldecode($rowData['additive_manufacturing_process_description'])?></td>
													...
													<td><a href="<?=site_url()."additivemanufacturing/admin/updateAdditiveManufacturingProcesses/".$rowData['additive_manufacturing_process_id']?>" aria-haspopup="true" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp; &nbsp;
														<a onclick="return confirm('Are You Sure To Delete This Entry?')"  href="<?=site_url()."additivemanufacturing/admin/deleteAdditiveManufacturingProcesses/".$rowData['additive_manufacturing_process_id']?>" aria-haspopup="true" title="Delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
