			...
			<form class="form-horizontal" role="form" action="" id="casestudy_form" method="post" enctype="multipart/form-data">
				<fieldset>
				   <div class="form-group">
					...
					<div class="col-sm-6">
					<input type="text" name="additive_manufacturing_process_name" id="additive_manufacturing_process_name" class=" form_bor_bot required" value="<?=$additiveManufacturingProcesses_list['additive_manufacturing_process_name']?>">
					</div>
				  </div> 
				  ...
				  <div class="form-group">
					<label class="control-label col-sm-3" for="additive_manufacturing_process_image">Process Image :</label>
					<div class="col-sm-6">
