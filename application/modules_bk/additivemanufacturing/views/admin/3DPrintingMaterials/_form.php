			...
			<form class="form-horizontal" role="form" action="" id="casestudy_form" method="post" enctype="multipart/form-data">
				<fieldset>
				   <div class="form-group">
					...
					<div class="col-sm-6">
					<input type="text" name="printing_material_name" id="additive_manufacturing_name" class="form_bor_bot required" value="<?=$PrintingMaterials3D_list['printing_material_name']?>">
					</div>
				  </div> 
