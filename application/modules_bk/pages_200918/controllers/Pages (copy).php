		...
		if(isset($_POST['btnLogin'])){ 
			...
			if (!empty($pageData)  ){ 
				...
				/* 	$session["kicked"] = $response['result']['kicked'];  
					...
					/*$ch = curl_init();
					$url="http://localhost/orendaventures/ecommerce/wp-content/themes/nikado/kk.php";
					...
					curl_close($ch);
					//echo $data;die;*/
					redirect("http://localhost/orendaventures/ecommerce/wp-content/themes/nikado/kk.php");
