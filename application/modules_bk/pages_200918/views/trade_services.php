	    	...
	    	<div class="tab-content helpcenter_info" style="padding-right: 0;">
	    		<div class="tab-pane fade in active" id="tradeAssurance">
					...
					<div class="TradeAssurance">
						  	<p>Trade Assurance is a free service by TERANEX.io designed to create trust in trade. We provide a set of protections to give you assurance that suppliers will honor key terms of your contract.*</p>
						  	<p>With Trade Assurance, you’ll enjoy:</p>
						<div class="col-sm-12 box-bdr">
							<div class="col-sm-4">
							  	<h3>On-time shipment protection</h3>
							  	<p>If the supplier fails to ship by the date set in your contract, you’re protected. TERANEX.io will provide you with a refund.</p>
							</div>
							<div class="col-sm-4 borderLR">
							  	<h3>Product quality protection</h3>
							  	<p>Select either pre-shipment or post-delivery coverage – TERANEX.io will refund you if the product quality or quantity does not meet the terms set in your contract.</p>
							</div>
							<div class="col-sm-4">
							  	<h3>Payment protection for your covered amount</h3>
							  	<p>If the supplier breaks the on-time shipment or product quality terms of your contract, TERANEX.io will refund the covered amount of your payment.</p>
							</div>
						</div>
					...
					<div class="businessIdentity">
						<div class="col-sm-12 box-bdr">
							...
							<div class="col-sm-4">
							  ...
							  <p>Buyers who are verified enjoy more promotional events, held jointly with TERANEX.io's partners.</p>
							</div>
						</div>
	    		...
	    		<div class="tab-pane fade" id="inspectionService">
		    		<div class="helpcenter-heading">
						<p class="padd_5">What Is TERANEX.io Inspection Service?</p>
					</div>
					<div class="inspectionService">
						<div class="col-sm-12 padd-0">
						 	<!-- <h2 style="text-transform: unset;">What Is TERANEX.io Inspection Service?</h2> -->
						    <p class="p"style="line-height: 30px;">With TERANEX.io’s Inspection Service, you can order services from professional 3rd-party inspectors and inspection companies directly on at<a> http://TERANEX.io.</a> The inspector will visit the manufacturing and/or port facilities anywhere in India and make reports, including pictures, to certify that the goods being produced and shipped meet quality standards.</p>
					...
					<div class="securePayment">
						<div class="sec-bdr">	
							<div class="col-sm-12">
								...
								<p>TERANEX.io Secure Payment aims to provide a safe payment service for all parties engaged in international trade. By partnering with an independent online payment platform (Alipay), TERANEX.io provides payment security to both buyers and suppliers.</p>
							</div>
						</div>
						<div class="sec-bdr">
							<div class="col-sm-12">
