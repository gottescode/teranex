...
<h3>Customer Registration</h3>
	...
	if(isset($_POST['submit']))
	{
		...
		$CustomerType = mysqli_real_escape_string($cn, $_POST['CustomerType']);
		...
		if($Passcode == $RePasscode)
		{
			...
			{	
				...
				$query="insert into customer(Email, MobileNo, Passcode, CustomerType, doe, dou) values ('$Email', '$MobileNo', '$EncPassword', '$CustomerType', '$date_now', '$date_now')";
	...
	?>
	<form name="register" id="register" method="post" action="customer_registration.php">
		...
		<div class="form-group">
    		<select class="form-control" id="CustomerType" name="CustomerType">
				<option value="">Select Customer Type (Required)</option>
...
<h3>Customer Sign In</h3>
	...
	<form name="login" id="login" method="post" action="secure_login_cust.php">
		<div class="form-group">
