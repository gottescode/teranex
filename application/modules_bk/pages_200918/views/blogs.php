...
<div class="container">
  <div class="col-sm-4 col-lg-3">
    <div class="legal-sidebar blog-sidebar dropdown">
      <h3>News Room</h3>
      <ul>
        <li class="active"><a href="blogs.php">blogs@teranex</a></li>
 ...
 <h3><a href="blogs2.php">Laser Engineering and implications on industry</a></h3>  
 <p>By <span class="ylian-date">Ylian S.</span> on <span class="ylian-date">17/06/2017</span></p>  
<p>Panel discussion_Teranex era of smart 6 Aug Panel discussion_Teranex era of smart 6 Aug Panel discussion era of smart 6 Aug Date added: 06 Aug 2013 Panel discussion_ ... </p>
</div>
