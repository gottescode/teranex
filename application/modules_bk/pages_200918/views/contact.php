...
<div class="" style="margin-top: 80px;">
 <img src="<?php echo $theme_url?>/images/contact-us-min-min.png" width="100%" class="img-responsive bnr-images">
 </div>
<div class="container">
  ...
  <div class="col-sm-8 padd-0">
      <div class="border_bot col-md-12 col-sm-12 col-xs-12" style="background-color: #fff;padding:40px 40px;box-shadow: 0px 0px 10px #dfdcdc;height:;">
          <form class="form-horizontal" name="contact" id="contact" method="post" action="" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  <div class="col-sm-6">
                  <input type="text" class="form_bor_bot" id="country_state" name="country_state" placeholder="State Name"><span class="compulsary">*</span>
                </div>
                   <div class="col-sm-6">
                  <input type="text" class="form_bor_bot" id="city_name" name="city_name" placeholder="City Name"><span class="compulsary">*</span>
                </div>
			  ...
			  <div class="form-group">
							...
							<input id="captcha_image" name="captcha" placeholder="Enter Captcha Code" class="form_bor_bot" type="text">
...
$("#contact").validate({
   rules: {  
      ...
      messages: { 
        ...
        country_name:{
          required:"Please selsect country"
        },
        country_state:{
