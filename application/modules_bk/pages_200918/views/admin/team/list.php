  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <!-- Content Header (Page header) -->
		<section class="content-header">
		  <span style="font-size: 24px;padding: 10px;">Teranex Team</span>
		  
		  <ol class="breadcrumb">
			<li><a href="<?=site_url()."dashboard"?>"><i class="fa fa-dashboard"></i> Home</a></li>
			<li class=""><a href="<?=site_url()."pages/team"?>">Consulting Team</a></li>
	 ...
	 <!-- Main content -->
		<section class="content">
			<div class="row">
				<div class="col-xs-12">
					<div class="box">
						<div class="padd-15"><a href="<?=site_url()."pages/team/createTeam"?>" class="btn btn-info" role="button">Add Team Member</a></div>
						...
						<div class="box-body"> 
							...
							<img class="img-responsive event-img" src="<?=site_url().'uploads/team/'.$rowData['team_image']?>" height="72" width="72">
							  <?php }?></td>
													...
													<td><a href="<?=site_url()."pages/team/updateTeam/".$rowData['team_id']?>" aria-haspopup="true" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp; &nbsp;
														<a onclick="return confirm('Are You Sure To Delete This Entry?')"  href="<?=site_url()."pages/team/deleteTeam/".$rowData['team_id']?>" aria-haspopup="true" title="Delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a>&nbsp; &nbsp;
														<!-- <a href="<?=site_url()."pages/team/teamList/".$rowData['team_id']?>" aria-haspopup="true" title="Team List"><i class="fa fa-plus-square"></i></a> -->
