...
class Groupbuying_model extends CI_Model {
    ...
    public function GroupbuyingSuppliers($garID) { 
		...
		$result = $this->db_lib->fetchMultiple("groupbuying_supplier_request GSR JOIN master_user MU ON GSR.supplier_id=MU.uid", $strWhere,"MU.u_name,MU.u_email, GSR.gsr_id, GSR.request_status, request_supplier_date,supplier_id");
