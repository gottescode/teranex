<div class="container-fluid myprofile-bg dahboard-bg">
  <div class="container">
    <div class="col-sm-6 padd-0">
      <ul>
        <li class="myprofile">Remote Application Service Programmers List</li>
      </ul>
    </div>
    <div class="col-sm-6 padd-0">
  	<ul>
						...
						if($requestProgrammers>0){ $i=1;
							...
							<tr>
								...
								<?php if($rowData['customer_accept_status']=='Y' ){ ?>
									Accepected
								<?php }else{?>
									<a href="<?=site_url()."customer/viewRemoteProgramQoute/".$rowData['rarp_id']."/$rowData[rpr_id]"?>" class="btn btn-xs btn-success">View Qoutation</a> &nbsp; &nbsp;  
