...
<div class="container-fluid myprofile-bg dahboard-bg">
  <div class="container">
    <div class="col-sm-4 padd-0">
      <ul>
        <li class="myprofile">Remote Service Comment</li>
      </ul>
    </div>
	...
	<div class="bg_white">
		<div class="col-md-10 col-sm-12 col-xs-12">  
			<table id='' class="table table-striped table-hover">
				...
				<tbody> 
				<?php if($remoteServiceVideoRequestList){ 
						$SNo = 1;
						foreach($remoteServiceVideoRequestList  as $rowData)
						{
							?>
							<tr>
								<td><? echo $SNo;?></td>
								...
								<td><a href="<?php echo site_url()."customer/remoteServiceVideoClassScheduleCustomer/".$rowData['rsvr_id']?>" class="btn btn-xs btn-info">Course List</a></td> 
							</tr>
							<?
							$SNo ++;
						}
