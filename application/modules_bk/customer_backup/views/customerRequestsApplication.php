<div class="container-fluid myprofile-bg dahboard-bg">
  <div class="container">
    <div class="col-sm-6 padd-0">
      <ul>
        <li class="myprofile">Remote Application Programmer Details</li>
      </ul>
    </div>
    <div class="col-sm-6 padd-0">
  	<ul>
...
<div class="col-md-9 col-sm-9 col-xs-12 ">  
	<form id="" name="" class=="form-horizontal" type="multipart/form-data">
		...
		<h3>Part for Application:</h3>
			...
			<div class="form-group col-sm-12 checkbox">
				...
				<div class="col-sm-8 mar-t-10 profile-checkbox-label">
					<label><input type="checkbox" value="N"<?php if($result['no_nda_equired']=='N'){ echo "Checked";}?>>No NDA Required (Allow suppliers to view and quote on the RFQ) </label></br>
					<label><input type="checkbox" value="Y"<?php if($result['no_nda_equired']=='Y'){ echo "Checked";}?>>NDA Required (Suppliers must sign NDA before viewing and quoting on this RFQ)</label>
				</div>
			</div>
			<hr class="hr-rfq">
	  ...
	  <?php   if( $resultQuatation['request_status'] !='QG'){  }else{ ?> 
		<div class="form-group">
		<center>
			<a class="btn btn-success" href="<?php echo site_url()."customer/customerRequestsApplicationAccept/".$rarp_id; ?>" >Generate Quotation</a>
			<a class="btn btn-danger" href="<?php echo site_url()."customer/customerRequestsApplicationReject/".$rarp_id; ?>" >Reject</a>
		</center>
		</div>
	<?php }?>	
	</form>
