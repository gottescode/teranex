  ...
  <div class="container">
    ...
    <div class="col-sm-6 padd-0">
      ...
      <ul>
        ...
        <li class="myprofile">Digital Manufacturing Supplier Details</li>
	...
	<div class="bg_white">
		<div class="col-lg-10 col-md-9 col-sm-9 col-xs-12">   
			...
			<form id="" name="" class=="form-horizontal" type="multipart/form-data">
				...
				<?php   
                            //    print_r($adtlist['request_status']);die;ui
                                
                                if($adtlist['request_status']=='QG'|| $adtlist['request_status']=='QS'){  }
                                
                                else{?>

					<!-- <a class="btn btn-success" href="<?php echo site_url()."customer/digitalmanufacturingRfqAccept/".$drrs_id; ?>" >Accept</a>

					<a class="btn btn-danger" href="<?php echo site_url()."customer/digitalmanufacturingRfqReject/".$drrs_id; ?>" >Reject</a> -->

					<a class="btn btn-success" href="<?php echo site_url()."customer/customerRequestsRfqAccept/".$drrs_id; ?>" >Generate Quotation</a>

					<a class="btn btn-danger" href="<?php echo site_url()."customer/customerRequestsRfqReject/".$drrs_id; ?>" >Reject</a>
