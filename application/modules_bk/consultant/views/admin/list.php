  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <!-- Content Header (Page header) -->
		...
		<section class="content-header">
		  ...
		  <span style="font-size: 24px;padding: 10px;">Consultant</span>
		  ...
		  <ol class="breadcrumb">
			...
			<li class=""><a href="<?=site_url()."consultant/admin"?>">Consultant</a></li>
		...
		<section class="content">
			...
			<div class="row">
				...
				<div class="col-xs-12">
					...
					<div class="box">
						<div class="padd-15">
							<a href="<?=site_url()."consultant/admin/create"?>" class="btn btn-info" role="button">Add Consultant</a>
						</div>
								...
								<div class="table-responsive">
									...
									<table class="table table-bordered table-striped" id="consultant_table">
										...
										<?php 
											...
											if($consultant_list >0){ $i=1;

												foreach($consultant_list  as $rowData){
