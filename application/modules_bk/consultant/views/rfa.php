...
?>
<div class="container">
	<center><h1>Request for Application</h1></center>
	<div class="col-sm-offset-1 col-sm-10 border_bot">
		...
		<h3>Part for Application:</h3>
			...
			<div class="form-group col-sm-12 col-xs-6">
			  <center> <input type="submit" name="btnRfq" id="btnRfq" class="btn btn-default confirm-btn " value="Submit RFA" /></center>
			</div>
		</form>
