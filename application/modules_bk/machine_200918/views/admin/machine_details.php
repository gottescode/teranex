							...
							<tr class="col-sm-12 padd-0">
								...
								<td class="" style="padding: 0;">
									...
									<table class="table  table-striped">
										<thead><tr><th><p>Details</p></th></tr></thead>
										<tbody>
										<tr>
											<td>Machine</td>
											<td>Laser</td>
										...
										<tr>
											<td><?php echo strhtmldecode($machineDetails['machine_details']) ?></td>
											<td><?php echo strhtmldecode($machineDetails['laser_machine']) ?></td>
											<td><?php echo strhtmldecode($machineDetails['lch']) ?></td>
											<td><?php echo strhtmldecode($machineDetails['control_laser']) ?></td>
											<td><?php echo strhtmldecode($machineDetails['data_transfer']) ?></td>
											<td><?php echo strhtmldecode($machineDetails['safty']) ?></td>
											<td><?php echo strhtmldecode($machineDetails['additional_equipment']) ?></td>
										</tr>
										</tbody>
									</table>
								</td>
