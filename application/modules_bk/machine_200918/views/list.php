										...
										<?php 
											...
											if($machineCatList >0){ $i=1;
												...
												<tr>
													...
													<td>	<a href="<?=site_url()."machine/admin/update/".$row['mc_id']; ?>" ><i class="fa fa-pencil" aria-hidden="true"></i></a>

													&nbsp;<a onclick="return confirm('Are You Sure To Delete This Entry?')"  href="<?=site_url()."machine/admin/delete/".$row['mc_id']; ?>" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
