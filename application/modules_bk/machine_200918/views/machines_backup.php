				...
				<div class="col-sm-3 padd-8">
					<div class="bx-shadow" style="border:none;min-height: 472px;box-shadow: 0px 0px 10px #dfdcdc;">
						...
						<div class="machine_info">
							<center><p  style="padding: 0 15px;font-size: 18px;min-height:100px;margin:0;"><?php echo $rowMachine['modelName'];?></p><span  style="padding: 0 15px;"><?php echo $rowMachine['city_name'].", ".$rowMachine['state_name']?></span>
							<div class="gray_bg" style="padding: 5px 0;min-height: 50px;">
