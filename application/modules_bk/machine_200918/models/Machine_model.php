...
/* =============== MACHINE DETAILS ================= */
	...
	public function machineFinaceRequest() { 
		$result = $this->db_lib->fetchMultiple(" machine_finance_request MFR JOIN machine_details MD ON MFR.machine_id=MD.md_id JOIN machine_category MC ON MFR.machine_id=MC.mc_id", "	mfr_id<>0 ORDER BY enquiry_date","MFR.*, MD.model_no,MD.brand_name,MC.category_name"); 
        return $result;
    }
...
/////////////////////////////    machine brand Model    //////////////////////////////////
	 ...
	 */
 	public function machineVideoRequestList($userId){
		...
		$result=$this->db_lib->fetchMultiple("  machine_video_request "," user_id = $userId ", ""); 
		return $result;
	}
	 ...
	 * @return array  
	 */
	public function machineSoftwareList($strWhere=''){
		 
		$result = $this->db_lib->fetchMultiple("machine_software_list MSL LEFT JOIN machine_details MD ON MSL.machine_id=MD.md_id LEFT JOIN machine_brand_model as mbm ON mbm.md_id = MD.model_no" ,$strWhere,"MSL.*,MD.model_no,mbm.*");
		return $result;
	}
	/* machine software List
		11//5/2018
