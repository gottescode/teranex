												...
												<tr>
													...
													<?php 
														if($row['video_chat']=='C'){
															...
															echo " Book a live demo or automation inspection ";
														}else{
													...
													?>
													<a href="<?php echo site_url()."automation/admin/assignSupplier/".$row['avr_id']; ?>" class="btn btn-xs btn-success "> Assign Supplier</a></td>
													<?
														}else{
													?>	
														Assigned
