					...
					<div class="col-sm-6">
						<select type="text" name="brand_id" id="brand_id" class="form_bor_bot required" >
							...
							<?php if($brandList){
								...
								<option value="<?php echo $rowBrand['ab_id']?>" <?php if( $result['brand_id']==$rowBrand['ab_id']){ echo "selected";}?>><?php echo $rowBrand['brand_name']?></option>
							<?php }}?>
						</select>
					</div>
				  </div>  
				  ...
				  <div class="form-group"> 
					<div class="text-center">
					 <input type="submit" name="btnSubmit" value="Submit" class="btn btn-primary"> 
					  <input type="hidden" name="id" value="<?php echo $result['ad_id']?>"  > 
					</div>
				  </div>
				</fieldset>
			</form>
