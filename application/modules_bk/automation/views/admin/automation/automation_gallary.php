 <?php 
	 $image_path_url  = base_url().'uploads/automation';
?>
<div class="content-wrapper">
<section class="content-header">
    <h1>Automation Gallery List</h1>
    <ol class="breadcrumb">
    <li><a href="<?=site_url()?>dashboard/"><i class="fa fa-dashboard"></i>Home</a></li> 
    <li class="active">Automation Gallery List</li>
    </ol>
</section>
				 	...
				 	<div class="col-sm-12">
						<table class="table table-bordered table-striped" id="gallery">
							<thead>
								...
								<?php 
								$i=1;
								foreach($automationAllImages['result'] as $row){
								?>
								<tr>
										<td><?php echo $i;?></td>
										...
										<td>
											<a onclick="return confirm('Are you sure delete this entry?')"  href="<?=site_url()."automation/admin/delete_gallary/".$row['ap_id'].'/'.$row['ad_id']?>" aria-haspopup="true" title="Delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a> 
										</td> 
