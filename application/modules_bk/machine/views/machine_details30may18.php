	...
	<div class="container detail_heading">
		<div class="col-sm-12 padd-0">
			<div class="" id="at_glance">
			  	<div class="col-sm-4 padd-8 consu-table table_nb">
					<h1>At a Glance</h1>
			  	...
			  	<div class="col-sm-4 padd-8 consu-table">
			  		<h1>Photos</h1>
			  		<div>
			  			<ul class="bxslider">
						<?php if($machineAllImages){
							...
							<li><img src="<?php echo base_url()."uploads/machine/".$rowMachine['photo_name']?>" height="auto" width="100%"/></li>
						<?php }}}?> 
						</ul>
			  		</div>
			  	</div>
			...
			<div class="" id="Software">
				<div class="pull-left full-width">
					...
					<div class="col-sm-7">
						<button id="showllist" class="btn btn_orange">Show</button>
					</div>
				</div>
			...
			<div class="full-width pull-left" id="contact">
					...
					<div class="col-sm-6 padd-0">
						<form role="form" action="" id="contactEnquiry" method="post" enctype="multipart/form-data">
							<?php
								if($user_id==''){ echo "<h3 style='margin-top: 33px; float:right;'>Please login before submit request. <a class='orng_clr' href='#'  data-toggle='modal' data-target='#signinModal'>Click Here</a></h3> ";}?>
			...
			<div class="full-width pull-left" id="">
				<div class="">
