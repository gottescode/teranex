...
//	}
	...
	public function chatMsgInsert($data) { 
	
		$data['created_at']=date('Y-m-d H:i:s');
		$result = $this->db_lib->insert("chat_details",$data); 
        return $result;
    }
	
	public function chatMsgHistory($data) { 
//		$fromId=$data["msg_from"];
//		$reference_id=$data["reference_id"];
//		$table = " chat_details ";
//		$select = " msg_from,msg_to,message,created_at ";
//		$strWhere = " msg_from=$fromId OR msg_to=$fromId and reference_id=$reference_id";
//		$result = $this->db_lib->fetchMultiple($table,$strWhere,$select);
		...
		$table = "chat_details ";
		$select = "*";
		$strWhere = "(msg_from=$fromId AND msg_to=$toId) OR (msg_from=$toId AND msg_to=$fromId)";
		$result = $this->db_lib->fetchMultiple($table,$strWhere,$select);         
        return $result;
    }
...
/////////////////////////////    machine brand Model    //////////////////////////////////
	...
	//	$strWhere = " u_user_type = 'S' "; user_role
		$strWhere = " user_type = 1 AND user_role = 3 ";
