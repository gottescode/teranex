										...
										$i=1;
											...
											<tr>
												...
												<?php// if($row['supplier_id']==0) {?>
													<a href="<?=site_url()."additivemanufacturing/admin/request_to_supplier/".$row['dmr_id']; ?>" class="btn btn-success btn-xs">Assign Supplier</a>
												<?php //}?> <a href="<?php echo site_url()."additivemanufacturing/admin/additivemanufacturing_req_suppliers/$row[dmr_id]"?>" class="btn btn-primary btn-xs">Suppliers Quotation</a></td>
											</tr>
											<? } ?>
										</tbody>
									</table>  
