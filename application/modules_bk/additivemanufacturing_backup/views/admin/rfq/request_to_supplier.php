  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <!-- Content Header (Page header) -->
		<section class="content-header">
		  <span style="font-size: 24px;padding: 10px;">Additive Manufacturing Requests</span>
		  <ol class="breadcrumb">
									...
									<table class="table table-bordered table-striped" id="">
										...
										<?php 
											if($supplier_user_list >0){ $i=1;
												...
												<input type="hidden" name="dmr_id" value="<?php echo $dmr_id; ?>">
											<?php }
											}else{
										...
										<tr>
												<td colspan=4>
													<center><input type="submit" name="btnSubmit" id="updateBtnStyle1" class="btn btn-primary " value="Update"></center>
												</td>
											</tr>
									</table>  
								</div>
