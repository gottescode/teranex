...
class additivemanufacturing_model extends CI_Model {
 ...
 public function findSinglePrintingApplication($strWhere = 1) {
    ...
    public function AdditivemanufacturingSuppliers($dmrID) { 
		...
		$result = $this->db_lib->fetchMultiple("additive_manufacturing_rfq_request_supplier AMRR JOIN master_user MU ON AMRR.supplier_id=MU.uid", $strWhere."AND request_status='QG'","MU.u_name,MU.u_email, AMRR.dmr_id,AMRR.drrs_id,AMRR.qoutation_date,AMRR.supplier_id");
