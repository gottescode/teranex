							...
							<table class="table table-bordered table-striped" id="product_table">
								...
								<?php if($machineRaqList){ $i=1;
									...
									<tr>
										...
										<td><a href="<?php echo site_url()."groupbuying/admin/supplierList/$rowBuy[gar_id]"?>" class="btn btn-xs btn-success">Assign Supplier</a></td>
										<td><a href="<?php echo site_url()."groupbuying/admin/groupbuying_req_suppliers/$rowBuy[gar_id]"?>" class="btn btn-xs btn-primary">Suppliers Quotation</a></td>
									</tr>
								<?php }}?>
								</tbody>
							</table>  
