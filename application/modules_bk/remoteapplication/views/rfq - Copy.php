	...
	<div class="col-sm-offset-1 col-sm-10 border_bot" style="background-color: #fff;padding:40px;box-shadow: 0px 0px 5px #dfdcdc;">
		<form class="form" name=" " id="rfq_form" method="post" action="" enctype="multipart/form-data">
			...
			<div class="form-group col-sm-12">
				...
				<div class="col-sm-8">
					<input type="text" class="form_bor_bot" id="app_name" name="app_name" placeholder=""  />
				</div>
			</div>
			<div class="form-group col-sm-12">
				...
				<div class="col-sm-8">
					...
					<textarea class="form_bor_bot" name="app_desc" id="app_desc"></textarea>
				</div>
			</div>
			...
			<div class="form-group col-sm-12 checkbox">
				...
				<div class="col-sm-8 mar-t-10 profile-checkbox-label">
					<label><input type="radio" name="nda" value="N">No NDA Required (Allow suppliers to view and quote on the RFQ) </label></br>
