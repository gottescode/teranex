        ...
        <div class="container-fluid myprofile-bg dahboard-bg">
            <div class="container">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padd-0">
                    <center><h2 class="margin-0">Application Engineers</h2></center>
                </div>
            </div> 
        </div>
    ...
    <div class="container padd-0">
        <div class="row">
            ...
            <div class="col-sm-4 col-xs-12 padd-8">
                ...
                <div class=" dad">
                    <div class="son-1" style="background-image: url('<?php echo $theme_url ?>/images/process-optimization-min.jpg');"></div>
                    <div class="son-text">
                        <h3>Process Optimization</h3>
                        <p>We can help you optimize processes with the help of consultants with decades of experience and knowledge. We provide a tailored approach that can match your individual requirements perfectly.</p>
            ...
            <div class="col-sm-4 col-xs-12 padd-8">
                <!-- <a href="#"> -->
                <div class=" dad">
                    <div class="son-1" style="background-image: url('<?php echo $theme_url ?>/images/machine-upgrades-min.jpg');"></div>
                    <div class="son-text">
                        <h3>Machine Upgrades</h3>
                        <p>At Stelmac, we provide both live and structured training courses in the fields of CAD/CAM, Machine Operation and Maintenance</p>
                        <a href="javascript:void(0)"> View More >></a>
                        <!-- <h3>Remote Programming</h3>
                        <p>We offer remote programming support with the capability of providing rapid diagnostics.</p>
                        <a href="<?php echo site_url(); ?>remoteprogramming"> View More >></a> -->
                    </div>
                </div>
                <!-- </a> -->
            </div>
            <div class="col-sm-4 col-xs-12 padd-8">
                <!-- <a href="javascript:void(0)"> -->
                <div class=" dad">
                    <div class="son-1" style="background-image: url('<?php echo $theme_url ?>/images/productdevelopment-min.jpg');"></div>
                    <div class="son-text">
                        <h3>Product development / Prototyping</h3>
                        <p>We can assist you with product development and prototyping remotely. This could translate to faster time to market for products.</p>
                        <a href="javascript:void(0)"> View More >></a>
                    </div>
                </div>
                <!-- </a> -->
                            ...
                            <div class="T chatbox" style="margin-top: 8px;">
                                ...
                                <div class="type_msg">
                                    <div class="input_msg_write">
                                        ...
                                        <input type="hidden" class="write_msg" id="type" value="1001" />
                                        <?php
