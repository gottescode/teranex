...
<section class="content-header">
  <span style="font-size: 24px;padding: 10px;">Service Engineers RFQ Quotation List</span>
  
  <ol class="breadcrumb">
	<li><a href="<?=site_url()."dashboard"?>"><i class="fa fa-dashboard"></i> Home</a></li>
	<li class=""><a href="">RFQ Request List</a></li>
						...
						<div class="table-responsive">
							<table class="table table-bordered table-striped" id="product_table">
								...
								?>
									    ...
									    <td><a href="<?php echo site_url()."remoteapplication/admin/ViewRfqRequestFromSE/$rowData[racrp_id]"?>" class="btn btn-primary btn-xs">View Quotation</a></td>
											</tr>
									<?php }
