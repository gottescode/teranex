...
.sw-dms-panel-container-bg__design.macademy_sw-dms-panel-container-bg__design {
    background-image: url('<?php echo $theme_url?>/images/learn1-min-dark.png');
    height: 100%;
    width: 100%;
    background-size: cover;
    position: absolute;
...
.sw-dms-panel-container-bg__sell.macademy_sw-dms-panel-container-bg__sell {
    background-image: url('<?php echo $theme_url?>/images/showcase-min-dark.png');
    height: 100%;
    width: 100%;
    background-size: cover;
    position: absolute;
...
.sw-design-panel__bg.macademy_sw-design-panel__bg {
    background-image: url('<?php echo $theme_url?>/images/learn1-min.jpg');
    height: 100%;
    -webkit-transition: opacity 0.9s ease-in-out;
    transition: opacity 0.9s ease-in-out;
}
...
.sw-sell-panel__bg.macademy_sw-sell-panel__bg {
    background-image: url('<?php echo $theme_url?>/images/showcase-min.jpg');
    -webkit-transition: opacity 0.9s ease-in-out;
    transition: opacity 0.9s ease-in-out;
}
</style>
<div>
	<center>
		<h1 style="margin: 10px 0;">Factory For Everyone</h1>
		<!-- <h2>Create Your Products. Build Your Business.</h2> -->
		<ul class="feature" style="margin-bottom: 20px;"><li>Create Your Products. Build Your Business.</li></ul>
	</center>
</div>
...
<div class="">
	<center> 
		 <h1 class="" >Value Added Services</h1>
	...
	<div class="packages-slider">
		<div class="package-wrapper"> 
			<div class="package-initial">
				...
				<div class="package-heading">Information Services</div>
			...
			<div class="package-expanded"> 
				<div class="package-heading">Information Services</div> <br/>
		...
		<div class="package-wrapper"> 
			...
			<div class="package-expanded"> 
				...
				<div class="package-expanded--content"> 
					...
					<div> 
						<a target="_blank" href="<?php echo site_url()."footer/getPaidForYourFeedback";?>">
						<div>
					...
					<div>
						<a target="_blank" href="<?php echo site_url()."footer/helpCenter";?>"> 
						<div>
