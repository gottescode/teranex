                ...
                <div class="slide-text2">
					...
					<h2>
						<span class="header-span">
							...
							<span><span class="circle"> </span>applications</span>
						</span>
					</h2>
                   <!-- <p>For your page</p> -->
                </div>
...
<div class="row">
  ...
  <div class="col-sm-6 col-xs-6">
    <a target="_blank" href="<?php echo site_url();?>ecommerce/product-category/software/">
	  <div>
...
<div class="row">
  <div class="col-sm-6 col-xs-6">
    	<a target="_blank" href="<?php echo site_url();?>eacademy">
	  <div>
    ...
    <a target="_blank" href="<?php echo site_url();?>pages/commingsoon">
	  <div>
		<img src="<?php echo $theme_url?>/css/marketplace/training.png" />
           ...
           <h3>excess capacity utilization services</h3>
           <p>Application services help to master new design challenges.</p>
        </a>
  </div>
</div>
...
<section>
  <div class="container padd-0 mar-20-0">
	<div class="col-sm-12 padd-0">
      <h1 class="text-center mar-0-0-10">Collaboration</h1>
	  <div class="row">
          <div class="col-sm-4 col-xs-12">
			<div class="gray-bg1">
			 <a target="_blank" href="<?php echo site_url();?>community/forum">
             <img src="<?php echo $theme_url?>/images/comm3.jpg" class="img-responsive">
			 <h2 class="text-center h2-tag">User communities</h2>
			 </a>
			</div>
          </div>
          <div class="col-sm-4 col-xs-12">
          ...
          <div class="col-sm-4 col-xs-12">
			<div class="gray-bg1">
             ...
             <img src="<?php echo $theme_url?>/images/comm1.jpg" class="img-responsive">
			 <h2 class="text-center h2-tag">Industry Events</h2>
			 </a>
			</div>
          </div>
        </div>
...
<section>
<div class="container padd-0 mar-10-0-0">
...
<section>
    <div class="container padd-0">
        <div class="col-sm-12 padd-0">
           <h1 class="text-center">Research & Analytics</h1>
		   <div class="row">
          <div class="col-sm-4 col-xs-12">
			<div class="gray-bg1">
			 <a target="_blank" href="<?php echo site_url();?>pages/commingsoon">
...
<section>
  <div class="container padd-0">
		  <h1 class="text-center mar-0-0-10"><span style="text-transform:lowercase">e</span>Academy</h1>
          <div class="col-sm-12 col-xs-12 padd-0">
			...
			<div class="sec-img-heading">
				...
				<p>Used machines are a cost effective way to enter the industry.</p>
				<a href="<?php echo site_url();?>#" class="btn btn-see-more pull-right"> See More</a>
				</div>
			</div>
          </div>
    </div>
              ...
              <div class="carousel-inner">
                   ...
                   <div class="row">
                    <div class="col-sm-6">
					  <div class="testimonial-name">
                        ...
                        <p class="testimonial_subtitle"><span>Machine Health Monitoring Market</span>
                        </p>
						<button style="border: none;"><i class="fa fa-quote-left testimonial_fa" aria-hidden="true"></i></button>
						<p class="testimonial_para">Machine health monitoring is a technique which used to detect the machine performance with respect to its temperature, humidity Machine health monitoring is a technique which used to detect the machine performance with respect to its temperature, humidity Machine health monitoring is a technique which used to detect the machine performance with respect to its temperature, humidity Machine health monitoring is a technique which used to detect the machine performance with respect to its temperature, humidity ... <a class="btn btn-see-more pull-right" href="<?php echo site_url()."mediacenter";?>" target="_blank"> See More</a></p>
               ...
               <div class="item">
                   <div class="row">
                    <div class="col-sm-6">
						<div class="testimonial-name">
							<h4><strong>Customer Blogs</strong></h4>
							<p class="testimonial_subtitle"><span>AUTOMOTIVE SENSORS MARKET</span>
							</p>
							<button style="border: none;"><i class="fa fa-quote-left testimonial_fa" aria-hidden="true"></i></button>
							<p class="testimonial_para">Sensors are basically electronic devices that convert the physical input to electrical signal as output Sensors are basically electronic devices that convert the physical input to electrical signal as output Sensors are basically electronic devices that convert the physical input to electrical signal as output Sensors are basically electronic devices that convert the physical input to electrical signal as output ... <a class="btn btn-see-more pull-right" href="<?php echo site_url()."mediacenter/category/customer-blog/";?>" target="_blank"> See More</a></p>
							<button style="border: none; float:right;"><i class="fa fa-quote-right testimonial_fa" aria-hidden="true"></i> </button><br>	
						</div>	
                    </div>
                    <div class="col-sm-6">
                   ...
                   <div class="row">
                    <div class="col-sm-6">
						<div class="testimonial-name">
							...
							<p class="testimonial_subtitle"><span>KAY SOLOMON</span>
							</p>
							<button style="border: none;"><i class="fa fa-quote-left testimonial_fa" aria-hidden="true"></i></button>
							<p class="testimonial_para">Kay Solomon is a well-known thought leader in design innovation with a focus on helping leaders learn how to be more. Kay Solomon is a well-known thought leader in design innovation with a focus on helping leaders learn how to be more Kay Solomon is a well-known thought leader in design innovation with a focus on helping leaders learn how to be more. Kay Solomon is a well-known thought leader in design innovation with a focus on helping leaders learn how to be more... <a class="btn btn-see-more pull-right" href="<?php echo site_url()."mediacenter/category/experts/";?>" target="_blank"> See More</a></p>
							<button style="border: none; float:right;"><i class="fa fa-quote-right testimonial_fa" aria-hidden="true"></i> </button><br>	
						</div>	
                    </div>
                    <div class="col-sm-6">
