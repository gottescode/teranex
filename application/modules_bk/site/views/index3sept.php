...
<div class=" sec-marketplace padd_30" style="margin-top: 0;padding: 20px 0;">
	...
	<div class="col-sm-12" style="position: relative;" >
		...
		<center>
				<div class="row">
					<h2> Collaboration</h2>
					<p class="marketPlace-heading">Connect with a vast network of peers from your industry</p>
				</div>
			</center>
			<div class="ico-tiles">
				<div class="row">
					...
					<a target="_blank" href="<?php echo site_url();?>community/forum">
					  <div>
						<img src="<?php echo $theme_url?>/css/marketplace/team.png">
						   ...
						   <p>We provide access to a large user community for you to connect with prior as well as post making purchase decisions.</p>
					</a>
				  </div>
				 <div class="col-sm-6 col-xs-12">
					<a target="_blank" href="<?php echo site_url();?>groupbuying">
					  <div>
						<img src="<?php echo $theme_url?>/css/marketplace/teamwork.png">
						   ...
						   <p>Bringing buyers with similar needs together to work out cost effective deals with suppliers.</p>
					</a>
				  </div>
				</div>
				<div class="row">
					...
					<a target="_blank" href="<?php echo site_url();?>xpertconnect">
					  <div>
						<img src="<?php echo $theme_url?>/css/marketplace/support.png">
						   ...
						   <p>You get access to a group of freelancers who can immediately address your urgent machine repair/servicing needs.</p>
					</a>
				  </div>
				  <div class="col-sm-6 col-xs-12">
			        <a target="_blank" href="javascript:void(0)">
					  <div>
			           ...
			           <p>Benefit from a virtual warehouse of spare parts, trade excess capacities & share & discuss service errors with other users.</p>
			        </a>
				  </div>
				</div>
			</div>
		...
		<div class="col-sm-4 col-xs-12" style="border-left: 1px solid #333;border-right: 1px solid #333;">
			<center>
			  <div class="row">
				  <h2> Machines</h2>
					<p class="marketPlace-heading">Browse through an exhaustive range of machines & accessories</p>
				</div>
			</center>
			<div class="ico-tiles">
				<div class="row">
				  <div class="col-sm-6 col-xs-12">
					<a target="_blank" href="<?php echo site_url();?>machine">
						...
						<h3>Machines</h3>
						<p>Explore the range of new & used machines for your specific requirement.</p>
					</a>
				  </div>
				  <div class="col-sm-6 col-xs-12">
					<a target="_blank" href="<?php echo site_url();?>automation">
					  <div>
			           ...
			           <h3>Automation</h3>
			           <p>Leverage the benefits of highly automated production that can help shorten product lifecycles.</p>
			        </a>
				  </div>
					...
					<a target="_blank" href="http://www.teranex.io/ecommerce/product-category/toolings/">
					  <div>
						<img src="<?php echo $theme_url?>/css/marketplace/wrench.png">
						   ...
						   <h3>Toolings</h3>
						   <p>Choose from a variety of machine tools from different OEMS all under one roof.</p>
					</a>
				  </div>
				  <div class="col-sm-6 col-xs-12">
				 	...
				 	<a target="_blank" href="http://teranex.io/ecommerce/product-category/spare-parts/">
					  <div>
						<img src="<?php echo $theme_url?>/css/marketplace/car-parts.png">
						   ...
						   <h3>Spares</h3>
						   <p>Brand new as well as used spare parts from a range of OEMs to choose from.</p>
					</a>
		...
		<center>
		  <div class="row">
		        <h2> Services</h2>
		        <p class="marketPlace-heading">Leverage our range of remote services</p>
		    </div>
		</center>
			<div class="ico-tiles">
				<div class="row">
					...
					<a target="_blank" href="<?php echo site_url();?>consultant">
					  <div>
						<img src="<?php echo $theme_url?>/css/marketplace/television.png">
						   ...
						   <p>We can provide remote servicing of your machines at your convenience.</p>
					</a>
				  ...
				  <div class="col-sm-6 col-xs-12">
					  ...
					  <div>
						<img src="<?php echo $theme_url?>/css/marketplace/training.png">
						   ...
						   <p>Hassle-free remote application support is also provided.</p>
					</a>
				  </div>
				  </div>
				  <div class="row">
					...
					<a target="_blank" href="<?php echo site_url();?>remotetraining">
					  <div>
						<img src="<?php echo $theme_url?>/css/marketplace/eacadmy.png">
						   ...
						   <h3>Remote training Services</h3>
						   <p>We can provide remote training services for the products purchased on TERANEX. </p>
					</a>
				  </div>
				 <div class="col-sm-6 col-xs-12">
					<a target="_blank" href="">
					  <div>
			           ...
			           <p>We can provide remote monitoring & analysis services for your machines & prevent downtime by identifying problems beforehand.</p>
			        </a>
				  </div>
				</div>
...
.sw-dms-panel-container-bg__sell.macademy_sw-dms-panel-container-bg__sell {
    background-image: url('<?php echo $theme_url?>/images/onlinecourse-macademy2-dark.png');
    height: 100%;
    width: 100%;
    background-size: cover;
    position: absolute;
...
.sw-sell-panel__bg.macademy_sw-sell-panel__bg {
    background-image: url('<?php echo $theme_url?>/images/onlinecourse-macademy1.jpg');
    -webkit-transition: opacity 0.9s ease-in-out;
    transition: opacity 0.9s ease-in-out;
}
</style>
<div>
	<center>
		...
		<ul class="feature" style="margin-bottom: 20px;"><li>Learn To Build Your Products. Design Your Products. Make Your Products.</li></ul>
	</center>
</div>
