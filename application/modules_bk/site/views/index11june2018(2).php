...
<div class=" sec-marketplace padd_30" style="margin-top: 0;padding-top: 20px;">
	...
	<center class="pad-0-0-10" style="margin-bottom: 18px;">
		...
		<ul class="feature"><li>Unified Communication</li><li>|</li><li>Live Sales Consultation</li><li>|</li><li>Live Machine Demo</li><li>|</li><li>Time Study</li><li>|</li><li>Software</li><li>|</li><li>Finance</li><li>|</li><li>Smart Contract</li></ul>
	</center>
	<div class="col-sm-12" style="position: relative;" >
		...
		<div class="col-sm-4 col-xs-12" style="border-left: 1px solid #333;border-right: 1px solid #333;">
			<div class="ico-tiles">
				<div class="row">
				  <div class="col-sm-6 col-xs-12">
					<a target="_blank" href="https://gotteswork.com/ecommerce/product-category/toolings/">
					  <div>
				...
				<div class="row">
				  <div class="col-sm-6 col-xs-12">
					<a target="_blank" href="https://gotteswork.com/ecommerce/product-category/spare-parts/">
					  <div>
...
<section class="other-section other-section-10 dark">
	<div class=" padd-0 paralax-section1 " style="background-image: url('<? echo $theme_url?>/images/marketinteligence.jpg');height: 100%;width: 100%;background-size: cover;">
		<div style="width: 100%;background-color: #1d3a40;opacity: 0.8;">
			<div class="col-sm-12" style="padding-top: 15px;">
				...
				<div>
					<ul class="tab-widget icon-tab tab-pd">
						...
						<li><i class="fa fa-plus fa-lg" aria-hidden="true"></i></li>
						<li>
							<a target="_blank" href="https://gotteswork.com/mediacenter" data-tb="#service-tab-4" class="flex-cc">
...
<div class="clearfix"></div>
<section class="other-section other-section-10 elearning dark" style="height: 386px;">
        <div class="col-sm-6 col-xs-12 padd-0">
			<div class="sec-img-heading">
				<div class="sec-img-content" style="margin-top: 13.5%;">
				<h1 style="color: #000;">Contract manufacturing platform</h1>
				<p style="color: #000;">Used machines are a cost effective way to enter the industry.</p>
				<a target="_blank" href="<?php echo site_url();?>pages/commingsoon" class="btn btn-see-more"> See More</a>
				</div>
			</div>
        </div>
        <div class="col-sm-6 col-xs-12 padd-0">
        	<img style="height:auto; width:100%;" src="<?php echo $theme_url?>/images/contract_man_platform.jpg" class="img-responsive">
        </div>
</section>
<div class="clearfix"></div>
<section class="other-section other-section-10 elearning dark" style="height: 386px;">
        <div class="col-sm-6 col-xs-12 padd-0">
            <img style="height:auto; width:100%;" src="<?php echo $theme_url?>/images/digital_training_platform.jpg" class="img-responsive">
        </div>
        <div class="col-sm-6 col-xs-12 padd-0">
        	<div class="sec-img-heading">
				<div class="sec-img-content text-right" style="right:5%;margin-top: 13.5%;">
				<h1 style="color: #000;text-transform: none;">mAcademy</h1>
				<p style="color: #000;">Used machines are a cost effective way to enter the industry.</p>
...
<section style="">
	<div class=" padd-0">
		<div class="counter padd_30"style="background: #f9f9f9;">
...
<section class="other-section other-section-10 elearning dark" style="">
	<div class=" padd-0 paralax-section1" style="background-image: none;">
		<div class="col-sm-12 padd-0" style="background-image: url('<? echo $theme_url?>/images/indexbckg.jpg');">
			<div class="col-sm-6 padd-0" style="">
				<div style="width: 100%;background-color: #1d3a40;opacity: 0.8;">
					<div class="sec-lr" style="padding:60px;">
						<h1 class="white-text text-center" style="margin-top: 10px;">Customer Services</h1>
						<hr/>
						<ul>
			...
			<div class="col-sm-6 padd-0" style="">
				<div style="width: 100%;background-color: #1d3a40;opacity: 0.8;">
					<div class="sec-lr" style="padding:60px;">
						<h1 class="white-text text-center" style="margin-top: 10px;">Trade Services</h1>
						<hr/>
						<ul>
							<div class="col-lg-6 col-sm-6">
								<li>
