        ...
        <div class="slide active">
			...
			<div class="slide-text2 typewriter">
				<div class="">
					...
					<h2 style="font-weight: normal;font-size: 36px;margin-top: 5px;color: #ccc;">an intelligent assistant for all your sheet metal needs</h2>
					<!-- <h2>
						<span class="item-1">
...
<div class=" sec-marketplace padd_30" style="margin-top: 0;padding: 20px 0;">
	...
	<center class="pad-0-0-10" style="margin-bottom: 18px;">
		<h1 style="margin-top: 0px;">Explore the Machine Market</h1>
				  ...
				  <div class="col-sm-6 col-xs-12">
					  ...
					  <div>
						<img src="<?php echo $theme_url?>/css/marketplace/training.png">
						   ...
						   <h3>Remote Application Support</h3>
				 ...
				 <div class="col-sm-6 col-xs-12">
					<a target="_blank" href="">
					  <div>
			           ...
			           <h3>Remote Monitoring & Analysis</h3>
...
.sw-dms-panel-container-bg__sell.macademy_sw-dms-panel-container-bg__sell {
    background-image: url('<?php echo $theme_url?>/images/factory-sell-new1-dark.png');
    height: 100%;
    width: 100%;
    background-size: cover;
    position: absolute;
...
.sw-sell-panel__bg.macademy_sw-sell-panel__bg {
    background-image: url('<?php echo $theme_url?>/images/factory-sell-new.jpg');
    -webkit-transition: opacity 0.9s ease-in-out;
    transition: opacity 0.9s ease-in-out;
}
</style>
<!-- <div>
	<center>
		<h1 style="margin: 10px 0;text-transform: inherit;">eFactory For Everyone</h1>
		<ul class="feature" style="margin-bottom: 20px;"><li>Learn To Build Products. Start Manufacturing. Build Your Business.</li></ul>
	</center>
</div> -->
<!-- <div class="sw-dms-section sw-grid-flex sw--width-full sw-grid-flex--wrap--mob sw-grid-flex--wrap--tab sw-dms-flex--nowrap--mob-landscape text-white">
	<div data-sw-dms-panel-container class="sw-dms-panel-container sw--text-white sw-grid-flex sw-grid-flex__cell-3-4 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-3-4--mob-landscape sw-grid-flex--wrap--mob sw-grid-flex--wrap--tab sw-dms-flex--nowrap--mob-landscape sw--position-relative" style="width: 100%;">
		<div data-sw-dms-panel-container-bg="design" class="sw-dms-panel-container-bg sw-dms-panel-container-bg__design"></div>
		<div data-sw-dms-panel-container-bg="make" class="sw-dms-panel-container-bg sw-dms-panel-container-bg__make"></div>
		<div data-sw-dms-panel-container-bg="sell" class="sw-dms-panel-container-bg sw-dms-panel-container-bg__sell"></div>
		<div data-sw-dms-panel="design" class="sw-dms-panel sw-dms-panel--tab-xl sw-dms-panel--mob-tab sw-dms-panel--mob-xs sw-design-panel sw-design-panel--mob-tab sw-grid-flex__cell-1-3 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-1-3--mob-landscape sw--position-relative factory_design" id="">
			<div class="sw-design-panel__bg sw-bg-panel sw-bg-panel--mob-tab"></div>
			<div class="sw-dms-panel__inner-div sw-dms-panel__inner-div--tab sw-dms-panel__inner-div--mob sw--position-absolute sw--padding-hor-7">
				...
				<a data-creator-choice-button="/img/rrstatic/design.img" class="sw--uppercase sw--hide-mobile sw--hide-tablet sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-bottom-5 btn btn_orange" href="">START A PROJECT</a><div class="clearfix"></div>
				...
				<a data-creator-choice-button="/img/rrstatic/design.img" class="sw--uppercase sw--hide-desktop sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-top-5 btn btn_orange" href="">START A PROJECT</a>
			</div>
		</div>
		<div data-sw-dms-panel="make" class="sw-dms-panel sw-dms-panel--tab-xl sw-dms-panel--mob-tab sw-dms-panel--mob-xs sw-make-panel sw-make-panel--mob-tab sw-grid-flex__cell-1-3 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-1-3--mob-landscape sw--position-relative factory_make" id="">
			...
			<div class="sw-make-panel__bg sw-bg-panel sw-bg-panel--mob-tab"></div>
			<div class="sw-dms-panel__inner-div sw-dms-panel__inner-div--tab sw-dms-panel__inner-div--mob sw--position-absolute sw--padding-hor-7">
		...
		<div data-sw-dms-panel="sell" class="sw-dms-panel sw-dms-panel--tab-xl sw-dms-panel--mob-tab sw-dms-panel--mob-xs sw-sell-panel sw-sell-panel--mob-tab sw-grid-flex__cell-1-3 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-1-3--mob-landscape sw--position-relative factory_sell" id="">
			<div class="sw-sell-panel__bg sw-bg-panel sw-bg-panel--mob-tab"></div>
			<div class="sw-dms-panel__inner-div sw-dms-panel__inner-div--tab sw-dms-panel__inner-div--mob sw--position-absolute sw--padding-hor-7">
				<h2 class="sw--margin-bottom-1 sw-dms-panel-header sw-dms-panel-header--big sw-dms__text--responsive sw-dms__text--responsive-small sw-dms-panel-header--mob sw-dms-panel-headerâ-tab sw--font-family-sharp-grotesque" style="color: #fff;">Sell</h2>
				...
				<a data-creator-choice-button="/img/rrstatic/sell.img" class="sw--uppercase sw--hide-mobile sw--hide-tablet sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-bottom-5 btn btn_orange" href="">START A PROJECT</a><div class="clearfix"></div>
				...
				<a data-creator-choice-button="/img/rrstatic/sell.img" class="sw--uppercase sw--hide-desktop sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-top-5 btn btn_orange" href="">START A PROJECT</a>
			</div>
		</div>
	</div>
</div> -->
	...
	<div data-sw-dms-panel-container class="sw-dms-panel-container sw--text-white sw-grid-flex sw-grid-flex__cell-3-4 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-3-4--mob-landscape sw-grid-flex--wrap--mob sw-grid-flex--wrap--tab sw-dms-flex--nowrap--mob-landscape sw--position-relative" style="width: 100%;">
		...
		<div data-sw-dms-panel="design" class="sw-dms-panel sw-dms-panel--tab-xl sw-dms-panel--mob-tab sw-dms-panel--mob-xs sw-design-panel sw-design-panel--mob-tab sw-grid-flex__cell-1-3 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-1-3--mob-landscape sw--position-relative factory_design" id="">
			...
			<div class="sw-dms-panel__inner-div sw-dms-panel__inner-div--tab sw-dms-panel__inner-div--mob sw--position-absolute sw--padding-hor-7">
				<h2 class="sw--margin-bottom-1 sw-dms-panel-header sw-dms__text--responsive sw-dms__text--responsive-small sw-dms-panel-header--big sw-dms-panel-header--mob sw-dms-panel-headerâ-tab sw--font-family-sharp-grotesque" style="color: #fff;">Design</h2>
				<p class="sw--font-size-18 sw-dms-panel-sub-header sw-dms-panel-sub-headerâ-tab sw-dms-panel-sub-header--mob sw--margin-bottom-7" style="color: #fff;">Design your product<br> with us.</p>
				<a data-creator-choice-button="/img/rrstatic/design.img" class="sw--uppercase sw--hide-mobile sw--hide-tablet sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-bottom-5 btn btn_orange" href="javascript:void(0);">START A PROJECT</a><div class="clearfix"></div>
				<p class="sw--margin-top-1 sw-dms-panel__inner-div__main-text sw-dms-panel__inner-div__main-text--tab sw-dms-panel__inner-div__main-text--mob-tab" style="color: #fff;">
					Work with a skilled product designer to turn your ideas into real products. We can start from scratch or evolve a product for on-going 3D-printed manufacturing.
				</p>
...
<style type="text/css">
	...
	.package-heading{font-weight:700;font-size:26px;margin-bottom:10px;color: #fff;}
	.package-heading1{font-weight:700;font-size:26px;margin-bottom:10px;color: #fff;}
	.packages-slider{display:flex;align-items:center}
	.package-wrapper{transition:.5s flex ease-in-out;margin:0 10px;height:25vw;max-height:450px;background:#f9f9f9;position:relative;overflow:hidden;/*box-shadow:0 20px 27px -14px rgba(0,0,0,.35)*/}
	.package-wrapper:first-child{margin-left:0}
	.package-wrapper:last-child{margin-right:0}
	.package-wrapper.swapactive{/*background-color:#f9f9f9;*//*background-image: url('<?php echo $theme_url?>/images/build-min-dark.png');*/}
	...
	.package-initial p,.package-expanded p{color:#fff;}
	.package-initial img{max-height:80px;margin-bottom:20px}
	.package-expanded h3{font-weight:700;font-size:18px;color: #fff;}
	.package-expanded{padding:20px 0;display:none;opacity:0;/*background:#f9f9f9;*/background-image: url('<?php echo $theme_url?>/images/build-min-dark.png');transition:.3s opacity ease-in-out;position:absolute;top:0;left:0;right:0;bottom:0}
...
<div class="" style="padding: 20px 0;">
	<center> 
		 <h1 class="" style="margin-top: 0;">Information Services</h1>
		<!--<p class="white-text" style="padding: 20px 0;color: #0e0e0f;padding-top: 0;">TERANEX offers a range of intelligence reports to help customers make purchase and sales decisions. Our revenue impact consulting</p> -->
		<!-- <h1 style="margin: 10px 0;">Value Added Services</h1> -->
	...
	<div class="packages-slider">
		<div class="package-wrapper" style="background-image: url('<?php echo $theme_url?>/images/info1-market-50.png');background-repeat: no-repeat;background-position: 0% 0%;background-size: 100% 100%;"> 
			<div class="package-initial">
				<img src="<?php echo $theme_url?>/images/whiteicon/technical-service.png"/>
				<div class="package-heading">Market Intelligence</div>
				<p>Grow your skills and advance your career</p> 
				<!-- <span class="pulse"></span> -->
				<a href="" class="btn btn_orange clickmore" id="">More</a>
			</div> 
			<div class="package-expanded" style="background-image: url('<?php echo $theme_url?>/images/info-market-min1-min.png');background-position: 0% 0%;background-size: 100% 100%;"> 
				...
				<div class="package-expanded--content"> 
					<div>
						...
						<div>
							<img src="<?php echo $theme_url?>/images/whiteicon/search.png"/> 
							<h3>Research</h3> 
						</div> 
					...
					<div> 
						...
						<div>
							<img src="<?php echo $theme_url?>/images/whiteicon/bar-chart.png"/> 
							<h3>Monitoring</h3> 
						</div> 
					...
					<div> 
						...
						<div>
							<img src="<?php echo $theme_url?>/images/whiteicon/calendar.png"/> 
							<h3>Events</h3> 
						</div> 
					...
					<div> 
						<a target="_blank" href="<?php echo site_url();?>mediacenter/category/media/">
						<div>
							<img src="<?php echo $theme_url?>/images/whiteicon/newspaper.png"/> 
							<h3>Industry News</h3> 
						</div> 
						<p>Measure your skill level with confidence in as little as 20 questions and five minutes.</p> 
						</a>
				...
				<!-- <div class="package-expanded--cta"> 
					<div class="psbutton--center" data-emptytext="Button">
						<a class="button button--gradient button--small" data-aa-title="start-a-pilot" href="https://billing.pluralsight.com/individual/checkout/account-details?sku=IND-M-PLUS-FT&amp;growid=PT">Start a FREE 10-day trial</a>
					</div> 
					<a class="link--gradient" href="https://www.pluralsight.com/learn?growid=PLM">Learn more</a>
				</div>  -->
			</div> 
		</div> 
		<div class="package-wrapper" style="background-image: url('<?php echo $theme_url?>/images/info1-customer-50.png');background-position: 0% 0%;background-size: 100% 100%;"> 
			<div class="package-initial">
				<img src="<?php echo $theme_url?>/images/whiteicon/24-hours.png"/> 
				<div class="package-heading">Customer Services</div> 
				<p>Prepare your team and maximize your efforts</p> 
				<!-- <span class="pulse"></span> -->
				<a href="" class="btn btn_orange clickmore" id="">More</a>
			</div> 
			<div class="package-expanded" style="background-image: url('<?php echo $theme_url?>/images/info-customer-min1-min.png');background-position: 0% 0%;background-size: 100% 100%;"> 
				<div class="package-heading">Customer Services</div> <br/>
				<div class="package-expanded--content"> 
					<div> 
						<a target="_blank" href="<?php echo site_url()."footer/submitAdispute";?>">
						<div>
							<img src="<?php echo $theme_url?>/images/whiteicon/auction.png"/> 
					...
					<div> 
						<a target="_blank" href="<?php echo site_url()."footer/ReportAbuse";?>">
						<div>
							<img src="<?php echo $theme_url?>/images/whiteicon/analysis.png"/> 
					...
					<div>
						<a target="_blank" href="javascript:void(0);"> 
						<div>
							<img src="<?php echo $theme_url?>/images/whiteicon/headset.png"/> 
							<h3>Pay Later</h3> 
						</div> 
					...
					<div> 
						...
						<div>
							<img src="<?php echo $theme_url?>/images/whiteicon/rating.png"/> 
				...
				<!-- <div class="package-expanded--cta"> 
					<div class="psbutton--center" data-emptytext="Button">
						<a class="button button--gradient button--small" data-aa-title="start-a-pilot" href="https://billing.pluralsight.com/checkout?sku=PROFESSIONAL-SG-PILOT&amp;growid=TT">Start a team trial</a>
					</div> 
					<a class="link--gradient" href="https://www.pluralsight.com/small-business?growid=TLM">Learn more</a>
				</div>  -->
			</div> 
		</div> 
		<div class="package-wrapper" style="background-image: url('<?php echo $theme_url?>/images/info1-trade-50.png');background-position: 0% 0%;background-size: 100% 100%;"> 
			<div class="package-initial">
				<img src="<?php echo $theme_url?>/images/whiteicon/sell.png"/> 
				<div class="package-heading">Trade Services</div> 
				<p>Measure progress toward business objectives</p> 
				<!-- <span class="pulse"></span> -->
				<a href="" class="btn btn_orange clickmore" id="">More</a>
			</div> 
			<div class="package-expanded" style="background-image: url('<?php echo $theme_url?>/images/info-trade-min1-min.png');background-position: 0% 0%;background-size: 100% 100%;"> 
				<div class="package-heading">Trade Services</div> <br/>
				<div class="package-expanded--content"> 
					<div> 
						<a target="_blank" href="<?php echo site_url()."footer/tradeAssurance";?>">
						<div>
							<img src="<?php echo $theme_url?>/images/whiteicon/money.png"/> 
					...
					<div> 
						...
						<div>
							<img src="<?php echo $theme_url?>/images/whiteicon/id-card.png"/> 
					...
					<div> 
						...
						<div>
							<img src="<?php echo $theme_url?>/images/whiteicon/inspection.png"/> 
					...
					<div> 
						...
						<div>
							<img src="<?php echo $theme_url?>/images/whiteicon/payment-security.png"/> 
				...
				<!-- <div class="package-expanded--cta"> 
					<div class="psbutton--center" data-emptytext="Button">
						<a class="button button--gradient button--small" data-aa-title="start-a-pilot" href="#ps_pilot_modal" target="_self">Start a pilot</a>
					</div> 
					<a class="link--gradient" href="https://www.pluralsight.com/business?growid=ELM">Learn more</a>
				</div>  -->
			</div> 
		</div> 
	</div>
...
<!-- <div>
	<center>
		<h1>Manufacturing Technology Learning Platform</h1>
	</center>
</div>
<div class="sw-dms-section sw-grid-flex sw--width-full sw-grid-flex--wrap--mob sw-grid-flex--wrap--tab sw-dms-flex--nowrap--mob-landscape text-white">
	<div data-sw-dms-panel-container class="sw-dms-panel-container sw--text-white sw-grid-flex sw-grid-flex__cell-3-4 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-3-4--mob-landscape sw-grid-flex--wrap--mob sw-grid-flex--wrap--tab sw-dms-flex--nowrap--mob-landscape sw--position-relative" style="width: 100%;">
		...
		<div data-sw-dms-panel="design" class="sw-dms-panel sw-dms-panel--tab-xl sw-dms-panel--mob-tab sw-dms-panel--mob-xs sw-design-panel sw-design-panel--mob-tab sw-grid-flex__cell-1-3 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-1-3--mob-landscape sw--position-relative factory_design" id="">
			<div class="sw-design-panel__bg macademy_sw-design-panel__bg sw-bg-panel sw-bg-panel--mob-tab"></div>
			<div class="sw-dms-panel__inner-div sw-dms-panel__inner-div--tab sw-dms-panel__inner-div--mob sw--position-absolute sw--padding-hor-7">
				<h2 class="sw--margin-bottom-1 sw-dms-panel-header sw-dms__text--responsive sw-dms__text--responsive-small sw-dms-panel-header--big sw-dms-panel-header--mob sw-dms-panel-headerâ-tab sw--font-family-sharp-grotesque" style="color: #fff;">Learn</h2>
				<p class="sw--font-size-18 sw-dms-panel-sub-header sw-dms-panel-sub-headerâ-tab sw-dms-panel-sub-header--mob sw--margin-bottom-7" style="color: #fff;">Design your product<br> with us.</p>
				<a data-creator-choice-button="/img/rrstatic/design.img" class="sw--uppercase sw--hide-mobile sw--hide-tablet sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-bottom-5 btn btn_orange" href="<?php echo site_url()."remotetraining/online_courses";?>">START A PROJECT</a><div class="clearfix"></div>
				<p class="sw--margin-top-1 sw-dms-panel__inner-div__main-text sw-dms-panel__inner-div__main-text--tab sw-dms-panel__inner-div__main-text--mob-tab" style="color: #fff;">
					Work with a skilled product designer to turn your ideas into real products. We can start from scratch or evolve a product for on-going 3D-printed manufacturing.
				</p>
				<a data-creator-choice-button="/img/rrstatic/design.img" class="sw--uppercase sw--hide-desktop sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-top-5 btn btn_orange" href="<?php echo site_url()."remotetraining/online_courses";?>">START A PROJECT</a>
			</div>
		</div>
		<div data-sw-dms-panel="make" class="sw-dms-panel sw-dms-panel--tab-xl sw-dms-panel--mob-tab sw-dms-panel--mob-xs sw-make-panel sw-make-panel--mob-tab sw-grid-flex__cell-1-3 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-1-3--mob-landscape sw--position-relative factory_make" id="">
			<div class="sw-make-panel__left-border sw-make-panel-border sw--is-hidden"></div>
			...
			<div class="sw-make-panel__bg macademy_sw-make-panel__bg sw-bg-panel sw-bg-panel--mob-tab"></div>
			<div class="sw-dms-panel__inner-div sw-dms-panel__inner-div--tab sw-dms-panel__inner-div--mob sw--position-absolute sw--padding-hor-7">
				<h2 class="sw--margin-bottom-1 sw-dms-panel-header sw-dms-panel-header--big sw-dms__text--responsive sw-dms__text--responsive-small sw-dms-panel-header--mob sw-dms-panel-headerâ-tab sw--font-family-sharp-grotesque" style="color: #fff;">Build</h2>
				<p class="sw--font-size-18 sw-dms-panel-sub-header sw-dms-panel-sub-headerâ-tab sw-dms-panel-sub-header--mob sw--margin-bottom-7" style="color: #fff;">Industrial 3D printing,<br> scaled for you.</p>
				<a data-creator-choice-button="/img/rrstatic/make.img" class="sw--uppercase sw--hide-mobile sw--hide-tablet sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-bottom-5 btn btn_orange" href="" target="_blank">START A PROJECT</a><div class="clearfix"></div>
				<p class="sw--margin-top-1 sw-dms-panel__inner-div__main-text sw-dms-panel__inner-div__main-text--tab sw-dms-panel__inner-div__main-text--mob-tab" style="color: #fff;">We manufacture high-quality, affordable products in 40 of the best materials and finishes, from plastics to metals. Upload for an instant quote or contact us to co-develop a solution for unique products.</p>				
				<a data-creator-choice-button="/img/rrstatic/make.img" class="sw--uppercase sw--hide-desktop sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-top-5 btn btn_orange" href="" target="_blank">START A PROJECT</a>
			</div>
		</div>
		<div data-sw-dms-panel="sell" class="sw-dms-panel sw-dms-panel--tab-xl sw-dms-panel--mob-tab sw-dms-panel--mob-xs sw-sell-panel sw-sell-panel--mob-tab sw-grid-flex__cell-1-3 sw-grid-flex__cell-1-1--mob sw-grid-flex__cell-1-1--tab sw-dms-flex__cell-1-3--mob-landscape sw--position-relative factory_sell" id="">
			<div class="sw-sell-panel__bg macademy_sw-sell-panel__bg sw-bg-panel sw-bg-panel--mob-tab"></div>
			<div class="sw-dms-panel__inner-div sw-dms-panel__inner-div--tab sw-dms-panel__inner-div--mob sw--position-absolute sw--padding-hor-7">
				<h2 class="sw--margin-bottom-1 sw-dms-panel-header sw-dms-panel-header--big sw-dms__text--responsive sw-dms__text--responsive-small sw-dms-panel-header--mob sw-dms-panel-headerâ-tab sw--font-family-sharp-grotesque" style="color: #fff;">Showcase</h2>
				<p class="sw--font-size-18 sw-dms-panel-sub-header sw-dms-panel-sub-headerâ-tab sw-dms-panel-sub-header--mob sw--margin-bottom-7" style="color: #fff;">Do more business,<br> more easily.</p>
				<a data-creator-choice-button="/img/rrstatic/sell.img" class="sw--uppercase sw--hide-mobile sw--hide-tablet sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-bottom-5 btn btn_orange" href="">START A PROJECT</a><div class="clearfix"></div>
				<p class="sw--margin-top-1 sw-dms-panel__inner-div__main-text sw-dms-panel__inner-div__main-text--tab sw-dms-panel__inner-div__main-text--mob-tab" style="color: #fff;">Outsource your fulfillment with a simple connection to our platform. Services include: ordering, manufacturing, assembly, custom packaging, and shipping.</p>
				<a data-creator-choice-button="/img/rrstatic/sell.img" class="sw--uppercase sw--hide-desktop sw-dms-button sw-dms-button--red sw-dms-button--big sw--margin-top-5 btn btn_orange" href="">START A PROJECT</a>
