    ...
    <div class="slider" slide-interval="3000">
        <div class="slide active">
			...
			<div class="slide-text2 typewriter">
				<div class="">
					<h1 class="typewriter1">TERANEX, an intelligent assistant for all your sheet metal needs</h1><br/>
					<!-- <h2>
						<span class="item-1">
			...
			<div class="ico-tiles">
				...
				<div class="row">
				  ...
				  <div class="col-sm-6 col-xs-12">
					...
					<a target="_blank" href="<?php echo site_url();?>snapshot">
					  <div>
						<img src="<?php echo $theme_url?>/css/marketplace/graph.png">
					  </div>
			...
			<div class="col-sm-12" style="padding-top: 15px;">
				...
				<div>
					<ul class="tab-widget icon-tab tab-pd">
						<li>
							<a target="_blank" href="http://teranex.io/mediacenter/" data-tb="#service-tab-1" class="flex-cc">
							<i class="fa fa-search" aria-hidden="true"></i></a>
							<h3 class="fs16 bold-2 mr-t-10">In Focus</h3>
						</li>
