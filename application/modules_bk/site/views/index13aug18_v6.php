			...
			<div class="ico-tiles">
				<div class="row">
				   <div class="col-sm-6 col-xs-12">
					<a target="_blank" href="<?php echo site_url();?>additivemanufacturing/additive_manufacturing">
					  <div>
						<img src="<?php echo $theme_url?>/css/marketplace/3d-printing.png">
					  </div>
				 ...
				 <div class="col-sm-6 col-xs-12">
					<a target="_blank" href="<?php echo site_url();?>laserprocessing/laser_processing">
					  <div>
						<img src="<?php echo $theme_url?>/css/marketplace/laser2.png">
					  </div>
				...
				<div class="row">
				  <div class="col-sm-6 col-xs-12">
					<a target="_blank" href="<?php echo site_url();?>rapidprototyping/rapid_prototyping">
					  <div>
						<img src="<?php echo $theme_url?>/css/marketplace/prototype.png">
					  </div>
				  ...
				  <div class="col-sm-6 col-xs-12">
			        <a target="_blank" href="javascript:void(0)">
					  <div>
						<img src="<?php echo $theme_url?>/css/marketplace/capacity-swap.png">
					  </div>
			           <h3>Capacity Swap</h3>
			...
			<div class="col-sm-12" style="padding: 30px 0;">
				...
				<div>
					<ul class="tab-widget icon-tab tab-pd ">
						...
						<li class="">
							<a target="_blank" href="<?php echo site_url();?>analytics/" data-tb="#service-tab-3" class="flex-cc">
						...
						<li>
							<a target="_blank" href="http://teranex.io/mediacenter/category/media/" data-tb="#service-tab-4" class="flex-cc">
							<i class="fa fa-newspaper-o" aria-hidden="true"></i></a>
							<h3 class="fs16 bold-2 mr-t-10">Media</h3>
						</li>
						<!-- <li>
							<a target="_blank" href="http://teranex.io/mediacenter/category/customer-blog/" data-tb="#service-tab-3" class="flex-cc">
							<i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
							<h3 class="fs16 bold-2 mr-t-10">Blogs</h3>
						</li> -->
						<li>
							<a target="_blank" href="<?php echo site_url();?>events" data-tb="#service-tab-3" class="flex-cc">
							<i class="fa fa-calendar" aria-hidden="true"></i></a>
							<h3 class="fs16 bold-2 mr-t-10">Events</h3>
						</li>
						<li>
							<a target="_blank" href="#" data-tb="#service-tab-2" class="flex-cc">
							<i class="fa fa-file-video-o" aria-hidden="true"></i></a>
							<h3 class="fs16 bold-2 mr-t-10">Webinars</h3>
						</li>
						<!-- <li>
							<a target="_blank" href="<?php echo site_url();?>events" data-tb="#service-tab-2" class="flex-cc">
							<i class="fa fa-calendar" aria-hidden="true"></i></a>
							<h3 class="fs16 bold-2 mr-t-10">Events</h3>
						</li> -->
					</ul>
...
<!-- <section class="other-section other-section-10 elearning dark" style="background: #f9f9f9; padding: 10px 0;">
...
<div class=" sec-marketplace padd_30" style="margin-top: 0;padding-top: 20px;">
	...
	<center class="pad-0-0-10" style="margin-bottom: 18px;">
		<!-- <h1 style="margin-top: 0px;">Explore the Marketplace</h1> -->
		<!-- <ul class="feature"><li>Live Sales Consultation</li><li>|</li><li>Live Machine Demo</li><li>|</li><li>Time Study</li><li>|</li><li>Software</li><li>|</li><li>Finance</li><li>|</li><li>Unified Communication</li></ul> -->
	</center>
	<div class="col-sm-12" style="position: relative;" >
		<div class="col-sm-4 col-xs-12" >
			<center>
...
<section class="other-section other-section-10 dark">
	<div class=" padd-0 paralax-section1 " style="background-image: url('<? echo $theme_url?>/images/Depositphotos_18937211_l-2015.jpg');height: 100%;width: 100%;background-size: cover;">
		<div style="width: 100%;background-color: #000000ad">
			<div class="col-sm-12" style="padding: 30px 0;">
				<center>
					<h1 class="white-text">Inside TERANEX Manufacturing Academy</h1>
					<p class="white-text" style="padding: 20px 0;">TERANEX offers a range of intelligence reports to help customers make purchase and sales decisions. Our revenue impact consulting <br/> undertakes proactive collaboration with clients to identify new opportunities, new customers and sources of incremental revenues.</p>
				</center>
				<div>
					<ul class="tab-widget icon-tab tab-pd">
						...
						<li>
							<a target="_blank" href="javascript:void(0)" data-tb="#service-tab-2" class="flex-cc">
							<i class="fa fa-university" aria-hidden="true"></i></a>
							<h3 class="fs16 bold-2 mr-t-10">Virtual Classroom</h3>
						</li>
						<li><i class="fa fa-plus fa-lg" aria-hidden="true"></i></li>
						<li>
							<a target="_blank" href="javascript:void(0)" data-tb="#service-tab-3" class="flex-cc">
							<i class="fa fa-tasks" aria-hidden="true"></i></a>
							<h3 class="fs16 bold-2 mr-t-10">Unified Contents</h3>
						</li>
						<li><i class="fa fa-plus fa-lg" aria-hidden="true"></i></li>
						<li>
							<a target="_blank" href="javascript:void(0)" data-tb="#service-tab-4" class="flex-cc">
						...
						<li><i class="fa fa-plus fa-lg" aria-hidden="true"></i></li>
						<li>
							<a target="_blank" href="javascript:void(0)" data-tb="#service-tab-6" class="flex-cc">
