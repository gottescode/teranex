...
{background:#f9f9f9;padding-bottom: 45px;}.testimonial .item {
    background: #e8e8e8;
}
...
.carousel-inner {
  ...
  <div class="counter_mainrow" style="">
  	<center>
		<h1 style="text-transform: inherit;">Our Presence</h1>
	</center>
...
<section class="testimonial" style="background: #e8e8e8;
    padding-bottom: 30px;
    margin-top: -38px;">
	<div class=" padd-0">
		<div class="">
