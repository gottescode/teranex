...
<div class="section container-fluid padd-0">
         <div class="slider" slide-interval="30000">
            ...
            <div class="slide">
                <div class="slide-img" img-src="<?php echo $theme_url?>/images/used-machines.jpg">
				</div>
...
<section style="">
<div class="container sec-marketplace">
	<center class="pad-0-0-10" style="margin-bottom: 20px;">
		<h1>Explore the Marketplace</h1>
		<ul class="feature"><li>Live Video Consultation</li><li>|</li><li>Live Machine Demo</li><li>|</li><li>Live Machine Inspection</li><li>|</li><li>Time Study</li><li>|</li><li>Software</li><li>|</li><li>Finance</li></ul>
	</center>
	<div class="col-sm-12" style="position: relative;" >
		...
		<div class="img1st">
			<img src="<?php echo $theme_url?>/images/return-arrow43.png"/>
		</div>
		<div class="col-sm-4 col-xs-12">
			<div class="ico-tiles">
				<div class="row">
...
<section>
	<div class="container padd-0">
		<h1 class="text-center">Trusted by customers like</h1>
		<div class="col-sm-12 clientslogo">
			<div class="clients-wrapper"></div>
				<div class="Cclients">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/Bayer.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/Epcos.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/NASA.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/Hella.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/unnamed.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/jenoptik.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/environment.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/mitsubishi.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/index.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/LanXess.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/analog.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/gsma.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/Vorlage.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/Underwriters.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/ZTE.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/Infineon.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/voith.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/basf.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/henkal.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/samsung.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/osram.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/Endress.gif">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/Deutsche.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/banner.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/FMC.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/Jabil.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/siemens.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/SEI.png">
					<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/Bain_&_Company.png">
					<!--<img class="img-responsive" src="<?php echo $theme_url?>/images/clients/brugg.png">-->
				</div>
