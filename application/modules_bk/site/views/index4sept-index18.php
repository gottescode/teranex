	...
	<div class="packages-slider">
				...
				<div class="package-expanded--content"> 
					<div>
						...
						<div>
						 ...
						 <p>We provide access to a large user community for you to connect with prior.</p> 
						</a>
					</div> 
					<div> 
						<a target="_blank" href="javascript:void(0)">
						...
						<p>Benefit from a virtual warehouse of spare parts, trade excess capacities & share & discuss.</p> 
						</a>
					</div> 
					<div> 
						<a target="_blank" href="javascript:void(0)">
		...
		<div class="package-wrapper"> 
			<div class="package-initial">
				...
				<div class="package-heading">Machine</div> 
				<p>Prepare your team and maximize your efforts</p> 
				<a href="" class="btn btn_orange clickmore" id="">More</a>
			</div> 
			<div class="package-expanded"> 
				<div class="package-heading">Machine</div> <br/>
				<div class="package-expanded--content"> 
					<div> 
						<a target="_blank" href="<?php echo site_url();?>machine">
						<div>
					...
					<div> 
						...
						<p>Bringing buyers with similar needs together to work out cost effective.</p>
						</a>/
					</div> 
		...
		<div class="package-wrapper"> 
			<div class="package-initial">
				<img src="<?php echo $theme_url?>/images/icons/sell.png"/> 
				<div class="package-heading">Services</div> 
				<p>Measure progress toward business objectives</p> 
				<a href="" class="btn btn_orange clickmore" id="">More</a>
			</div> 
			<div class="package-expanded"> 
				<div class="package-heading">Services</div> <br/>
				<div class="package-expanded--content"> 
					<div> 
						<a target="_blank" href="<?php echo site_url();?>consultant">
						<div>
