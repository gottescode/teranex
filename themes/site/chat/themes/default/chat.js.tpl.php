...
<script type="text/javascript" src="<?php echo theme_url(); ?>/chat/data/public/js/compat.js"></script>
<script type="text/javascript" src="<?php echo theme_url(); ?>/chat/data/public/js/md5.js"></script>
<script type="text/javascript" src="<?php echo theme_url(); ?>/chat/data/public/js/cookie.js"></script>
<script type="text/javascript" src="<?php echo theme_url(); ?>/chat/data/public/js/image_preloader.js"></script>
<script type="text/javascript" src="<?php echo theme_url(); ?>/chat/data/public/js/myprototype.js"></script>
<script type="text/javascript" src="<?php echo theme_url(); ?>/chat/data/public/js/prototype.js"></script>
<script type="text/javascript" src="<?php echo theme_url(); ?>/chat/data/public/js/regex.js"></script>
<script type="text/javascript" src="<?php echo theme_url(); ?>/chat/data/public/js/utf8.js"></script>
<script type="text/javascript" src="<?php echo theme_url(); ?>/chat/data/public/js/sprintf2.js"></script>
<script type="text/javascript" src="<?php echo theme_url(); ?>/chat/data/public/js/activity.js"></script>
<script type="text/javascript" src="<?php echo theme_url(); ?>/chat/data/public/js/mousepos.js"></script>
<script type="text/javascript" src="<?php echo theme_url(); ?>/chat/data/public/js/createstylerule.js"></script>
<script type="text/javascript" src="<?php echo theme_url(); ?>/chat/data/public/js/pfcclient.js"></script>
<script type="text/javascript" src="<?php echo theme_url(); ?>/chat/data/public/js/pfcgui.js"></script>
<script type="text/javascript" src="<?php echo theme_url(); ?>/chat/data/public/js/pfcresource.js"></script>
<script type="text/javascript" src="<?php echo theme_url(); ?>/chat/data/public/js/pfcprompt.js"></script>
